Object.assign(globalData, {
	anguilla: {
        ...
        <p>Gender identity laws are non-existent in 2026. There is no administrative or legal process for transgender individuals to change their legal name or gender marker on official documents. 
        Voices from the Ground: <a href="https://database.ilga.org/anguilla-lgbti" target="_blank">ILGA World Database</a> confirms the absence of hate crime legislation or protective mandates.</p>
        ...
        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            ...
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Caribbean Territories Order 2000</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The primary decree that decriminalized private same-sex acts between consenting adults across British Caribbean territories.</p>
                <a href="https://www.humandignitytrust.org/country-profile/anguilla/" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
            </div>
        </div>
    `,
        ...
        <p>Police protection is technically available, but there are no specific SOGI-trained task forces. Visibility of LGBTQ+ individuals in state offices remains virtually non-existent in 2026. 
        Voices from the Ground: <a href="https://www.equaldex.com/region/anguilla" target="_blank">Equaldex Community Reports</a> suggest that local spaces are primarily 'G-mapped' and lack visibility for feminine-presenting or non-binary individuals.</p>
        ...
        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            ...
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                ...
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Based on Spartacus Gay Travel Index 2026, Anguilla ranks lower due to lack of local rights, despite high safety for tourists.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Absence of 'Incitement to Hatred' laws protecting LGBTQ+ citizens as of 2026.</p>
            </div>
        </div>
    `,
        ...
        <p>While the law is restrictive, the 2026 social reality in high-end beach resorts is one of quiet acceptance as long as one is a tourist. There are no public LGBTQ+ bars; community gathering occurs through private networks or 'LGBTCouchsurfers' meetups. There are no significant Pride events scheduled for 2026.</p>
        ...
        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            ...
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                ...
                <p style="color: #fff; font-size: 0.85rem;">Customs officers are generally professional, but travelers with non-binary gender markers may encounter processing delays. PDA is discouraged in the capital, The Valley.</p>
            </div>
        </div>
    `,
        ...
        <p>Medical institutions do not have mandated inclusivity training. 
        Voices from the Ground: <a href="https://alturi.org/" target="_blank">Alturi</a> recommends regional hubs like Puerto Rico for specialized LGBTQ+ medical needs. Emergency services can be reached via 911 but lack SOGI protocols.</p>
        ...
        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            ...
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Princess Alexandra Hospital</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">Stoney Ground, Anguilla</p>
                <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +1 264-497-2551</p>
            </div>
        </div>
    `,
	...
	antigua_and_barbuda: {
        ...
        <p>Legal gender recognition remains inaccessible. There is no legislative process for changing gender markers on passports or national IDs. 
        Voices from the Ground: <a href="https://www.humandignitytrust.org/country-profile/antigua-and-barbuda/" target="_blank">Human Dignity Trust</a> notes that while decriminalization was a victory, it has not yet translated into positive civil rights.</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 ECSC Ruling 2022 (Ord vs. AG)</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The Supreme Court decision that declared the criminalization of same-sex acts unconstitutional and void.</p>
                <a href="https://database.ilga.org/antigua-and-barbuda-lgbti" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
            </div>
        </div>
    `,
        ...
        <p>Police proactivity is neutral. While they are no longer tasked with enforcing sodomy laws, there is no evidence of specific protection for LGBTQ+ events. 
        Voices from the Ground: <a href="https://www.equaldex.com/region/antigua-and-barbuda" target="_blank">Equaldex Reports</a> summarize activist sentiment as feeling "legally safe but socially vulnerable."</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #94</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Improvement in Spartacus 2026 due to decriminalization, though social points remain low.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Constitutional recognition of 'privacy' now includes same-sex intimacy.</p>
            </div>
        </div>
    `,
        ...
        <p>There is no public Pride march in 2026, but the 'Antigua Island Girls' and other local groups often host private, inclusive beach gatherings. Travelers should avoid religious gatherings which remain vocally anti-LGBTQ+. 
        Voices from the Ground: <a href="https://www.iglta.org/" target="_blank">IGLTA Guide</a> suggests booking through "Gay-Friendly" verified accommodations.</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">Antigua is safe for LGBT travelers who use discretion. High-end dining in Dickenson Bay is the safest bet for visibility.</p>
            </div>
        </div>
    `,
        ...
        <p>Emergency medical staff are generally professional but lack specific training for non-binary patients. 
        Voices from the Ground: <a href="https://alturi.org/" target="_blank">Alturi</a> points toward 'Meeting Place Antigua' for health peer-support. Contact emergency services at 999 or 911.</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Mount St. John's Medical Centre</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">Michael's Mount, St. John's, Antigua</p>
                <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +1 268-484-2700</p>
            </div>
        </div>
    `,
	...
	argentina: {
        ...
        <p>Recent 2026 legislative sessions have focused on expanding the Trans Labor Quota (Cupo Laboral Travesti-Trans), ensuring that 1% of public sector jobs are reserved for the trans community. 
        Voices from the Ground: <a href="https://database.ilga.org/argentina-lgbti" target="_blank">ILGA World</a> cites Argentina as a "gold standard" for Latin American legal frameworks.</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Gender Identity Law 26.743</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Groundbreaking law allowing for self-perceived gender identity recognition on all legal documents.</p>
                <a href="https://www.equaldex.com/region/argentina" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
            </div>
        </div>
    `,
        ...
        <p>Police protection is proactive, and hate crimes are specifically addressed under criminal law. Intersectionality is a core focus, with 'Safe Havens' in Buenos Aires, such as Palermo and San Telmo, being highly inclusive of QPOC and feminine-presenting individuals. 
        Voices from the Ground: <a href="https://www.gaytimes.co.uk/travel/buenos-aires-lgbtq-travel-guide/" target="_blank">Gay Times</a> highlights the city's radical inclusivity.</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #12</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Consistently top-ranked in the Spartacus 2026 index due to robust legal and social protections.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Full coverage of gender-affirming surgery under both public and private healthcare plans.</p>
            </div>
        </div>
    `,
        ...
        <p>Buenos Aires Pride (Marcha del Orgullo) is scheduled for November 2026, following a 2025 event that saw over 1 million participants with high state-provided security. 
        Voices from the Ground: <a href="https://nomadicboys.com/gay-buenos-aires-guide/" target="_blank">Nomadic Boys</a> recommend 'Feliza' as a premier 'LGBT Third Space' for art and community.</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">Argentina is a "zero-restriction" zone for LGBT visibility. Trans travelers are legally protected against discrimination in all accommodations.</p>
            </div>
        </div>
    `,
        ...
        <p>Emergency institutions have established inclusivity protocols. 
        Voices from the Ground: <a href="https://alturi.org/" target="_blank">Alturi</a> suggests the 'Casa Trans' in Buenos Aires for community-led health referrals. Emergency services can be reached at 911.</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Casa Trans (Community Health)</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">Av. Jujuy 1341, Buenos Aires, Argentina</p>
                <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +54 11 4942-0125</p>
            </div>
        </div>
    `,
	...
	aruba: {
        ...
        <p>Gender identity laws have seen progress through Dutch court mandates, allowing for the change of gender markers on legal documents with minimal administrative burden. 
        Voices from the Ground: <a href="https://www.equaldex.com/region/aruba" target="_blank">Equaldex Aruba</a> reports that the transition has been largely peaceful and legally robust.</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Hoge Raad Ruling 2024</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The definitive ruling by the Netherlands Supreme Court mandating marriage equality across the Kingdom's Caribbean territories.</p>
                <a href="https://database.ilga.org/aruba-lgbti" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
            </div>
        </div>
    `,
        ...
        <p>Intersectionality is well-represented, as Aruba is a melting pot of cultures. 'Safe Havens' are essentially island-wide, though Oranjestad and the high-rise hotel area in Palm Beach are the most diverse. 
        Voices from the Ground: <a href="https://www.aruba.com/us/plan-your-visit/lgbt-travel-to-aruba" target="_blank">Aruba Tourism Authority</a> explicitly markets to the LGBTQ+ community.</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #38</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Significant climb in Spartacus 2026 following marriage equality implementation.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Equal access to government-provided spousal benefits for same-sex couples.</p>
            </div>
        </div>
    `,
        ...
        <p>Aruba Pride 2026 is scheduled for October, following a 2025 event that saw heavy government sponsorship and high security. 
        Voices from the Ground: <a href="https://nomadicboys.com/gay-aruba-guide/" target="_blank">Nomadic Boys</a> describe Aruba as the "Gay Oasis" of the Caribbean.</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">Customs staff are professional and used to diverse travelers. Gender-neutral restrooms are increasingly common in new 2026 construction.</p>
            </div>
        </div>
    `,
        ...
        <p>Emergency medical institutions are fully inclusive. 
        Voices from the Ground: <a href="https://alturi.org/" target="_blank">Alturi</a> recommends the Dr. Horacio E. Oduber Hospital for any urgent medical needs. Emergency services: 911.</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Dr. Horacio E. Oduber Hospital</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">Sasaki Weg, Oranjestad, Aruba</p>
                <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +297 527 4000</p>
            </div>
        </div>
    `,
	...
	bahamas: {
        ...
        <p>Gender identity recognition is not legally available. Transgender individuals cannot change their name or gender on official documents through an administrative process. 
        Voices from the Ground: <a href="https://www.humandignitytrust.org/country-profile/bahamas/" target="_blank">Human Dignity Trust</a> notes that while not criminalized, the community lacks any positive legal standing.</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Sexual Offences Act 1991</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The act that decriminalized private consensual same-sex acts for adults aged 18 and older.</p>
                <a href="https://database.ilga.org/bahamas-lgbti" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
            </div>
        </div>
    `,
        ...
        <p>Intersectionality is a struggle, with local spaces being heavily G-mapped and exclusionary toward QPOC trans women. 
        Voices from the Ground: <a href="https://www.equaldex.com/region/bahamas" target="_blank">Equaldex Bahamas</a> reports indicate that safety is generally high for tourists but precarious for locals.</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #88</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Stable but low ranking in Spartacus 2026 due to lack of legal progression.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Constitutional 'Article 26' does not include sexual orientation as a protected ground.</p>
            </div>
        </div>
    `,
        ...
        <p>There is no public Pride event in 2026. A small 'Pride Bahamas' group exists but has primarily moved to digital advocacy following security concerns in previous years. 
        Voices from the Ground: <a href="https://www.iglta.org/" target="_blank">IGLTA</a> recommends staying within well-known resort boundaries for maximum safety.</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">Bahamas is generally safe for tourists who use discretion. Harassment of LGBT people is social rather than state-sponsored.</p>
            </div>
        </div>
    `,
        ...
        <p>Emergency medical protocols lack LGBTQ+ inclusivity. 
        Voices from the Ground: <a href="https://alturi.org/" target="_blank">Alturi</a> suggests 'Bahamas United' as a safe point for health referrals. Emergency: 911 or 919.</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Princess Margaret Hospital</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">Shirley Street, Nassau, Bahamas</p>
                <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +1 242-322-2861</p>
            </div>
        </div>
    `,
	...
	barbados: {
        ...
        <p>Gender identity laws do not exist in Barbados. There is no administrative process for transgender individuals to change their name or gender marker on birth certificates or national IDs. Activists continue to lobby for a Gender Recognition Act similar to those in other Commonwealth nations, but as of 2026, no such law has been tabled.</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 High Court Ruling (Dec 2022)</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The landmark judicial decision that rendered Sections 9 and 12 of the Sexual Offences Act unconstitutional.</p>
                <a href="https://database.ilga.org/barbados-lgbti" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
            </div>
        </div>
    `,
        ...
        <p>Police protection for LGBTQ+ citizens is available, but specific SOGI training is not yet state-mandated. Visibility is higher in the capital, Bridgetown, but residents often report a "double life" to maintain social standing. Voices from the Ground: <a href="https://www.equaldex.com/region/barbados" target="_blank">Equaldex</a> summaries suggest that local spaces are inclusive of QPOC but remain largely G-mapped (cis-gay male focused).</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #82</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Performance in Spartacus Gay Travel Index 2026 shows improvement due to the lack of criminalization, but points are lost for lack of anti-discrimination laws.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">"De Jure" safety from arrest for consensual acts, but high social pressure for discretion.</p>
            </div>
        </div>
    `,
        ...
        <p>Barbados Pride is expected to take place in July 2026. The 2025 security posture was "High Alert but Peaceful," with police providing a perimeter to prevent interference from religious protesters. LGBT Third Spaces include the community-led "Love Circle" gatherings and specific inclusive art galleries in Holetown. Voices from the Ground: <a href="https://www.iglta.org/" target="_blank">IGLTA</a> recommends staying in verified inclusive accommodations.</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">Customs officers are professional. Entry is smooth regardless of orientation. Safe zones: The Gap and Holetown.</p>
            </div>
        </div>
    `,
        ...
        <p>Emergency protocols are generally professional, though non-binary travelers may experience misgendering in hospital admissions. Voices from the Ground: <a href="https://alturi.org/" target="_blank">Alturi</a> highlights "EQUALS Barbados" as a key contact for health referrals. Emergency: 511.</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Ladymeade Reference Unit</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">Jemmotts Lane, Bridgetown, Barbados</p>
                <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +1 246-436-5445</p>
            </div>
        </div>
    `,
	...
	belize: {
        ...
        <p>Legal gender recognition is unavailable. There are no provisions for changing gender markers on official identification, and the process for legal name changes remains a complex administrative hurdle for trans citizens.</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Section 53 Ruling (2016)</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The Supreme Court decision that struck down the criminalization of same-sex intimacy as unconstitutional.</p>
                <a href="https://database.ilga.org/belize-lgbti" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
            </div>
        </div>
    `,
        ...
        <p>Police protection is responsive to physical threats, but there is no specific bias-crime reporting mechanism. Voices from the Ground: <a href="https://www.equaldex.com/region/belize" target="_blank">Equaldex</a> reports that intersectional inclusion for QPOC and Garifuna LGBT individuals is a focus of local NGOs like UNIBAM.</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #79</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Ranked in the top half of Central American nations in the Spartacus Index 2026, largely due to its decriminalized status.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">High tourism safety but lack of hate-speech protections for the local community.</p>
            </div>
        </div>
    `,
        ...
        <p>There is no official large-scale Pride march in 2026, but "Pride Week" events including small film screenings and inclusive workshops take place in August. The 2025 security posture for these private events was "Low Risk." Voices from the Ground: <a href="https://nomadicboys.com/gay-belize-guide/" target="_blank">Nomadic Boys</a> emphasize the laid-back atmosphere of the Cayes.</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">Entry is smooth. Discretion is recommended on the mainland to avoid social friction. The Cayes are essentially open-visibility zones.</p>
            </div>
        </div>
    `,
        ...
        <p>Emergency medical care is reliable for tourists in hubs. Voices from the Ground: <a href="https://alturi.org/" target="_blank">Alturi</a> suggests UNIBAM as the primary contact for any community-based healthcare issues. Emergency: 911.</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">UNIBAM Wellness Center</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">Belize City (Contact for specific site), Belize</p>
                <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +501 223-4241</p>
            </div>
        </div>
    `,
	...
	bermuda: {
        ...
        <p>Gender identity laws are underdeveloped. While legal name changes are possible, the administrative process for changing gender markers on official Bermuda government documents is not explicitly codified in the 2025/2026 legislative sessions.</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Domestic Partnership Act 2018</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The legislative framework providing legal recognition for same-sex unions as domestic partnerships.</p>
                <a href="https://database.ilga.org/bermuda-lgbti" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
            </div>
        </div>
    `,
        ...
        <p>Police protection is proactive and reliable. There are no reported incidents of state-sponsored harassment in 2026. Voices from the Ground: <a href="https://www.equaldex.com/region/bermuda" target="_blank">Equaldex</a> indicates that Safe Havens are inclusive of all sub-sectors of the rainbow, though they are primarily G-mapped in public visibility.</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #54</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Bermuda maintains a mid-tier ranking in the Spartacus Index 2026, penalized for the marriage retraction but buoyed by physical safety.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">High tourism safety and strong protection within the international corporate sector.</p>
            </div>
        </div>
    `,
        ...
        <p>Bermuda Pride 2026 is scheduled for late August. The 2025 security posture was "Excellent," with significant police presence and government-endorsed safety protocols. LGBT Third Spaces include several inclusive bookstores and cafes in Hamilton. Voices from the Ground: <a href="https://www.iglta.org/" target="_blank">IGLTA</a> notes Bermuda as a premier luxury destination for LGBT couples.</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">Very smooth entry. Visibility is welcome. Safe Zones: Hamilton and any major resort beach.</p>
            </div>
        </div>
    `,
        ...
        <p>Emergency care is reliable and efficient. Voices from the Ground: <a href="https://alturi.org/" target="_blank">Alturi</a> points to OUTBermuda as the primary resource for health and wellness support. Emergency: 911.</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">King Edward VII Memorial Hospital</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">7 Point Finger Rd, Paget DV 04, Bermuda</p>
                <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +1 441-236-2345</p>
            </div>
        </div>
    `,
	...
	bolivia: {
        ...
        <p>Gender identity recognition is protected under the Gender Identity Law (Ley No. 807). Transgender individuals can legally change their name and gender marker, though a 2017 ruling restricted certain associated rights (like marriage in the new gender), which remains a point of legal battle in 2026.</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Ley de Identidad de Género (2016)</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The national law allowing transgender people to correct their identity data on legal documents.</p>
                <a href="https://database.ilga.org/bolivia-lgbti" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
            </div>
        </div>
    `,
        ...
        <p>Police protection is technically mandated but local activists often report indifference. Voices from the Ground: <a href="https://www.equaldex.com/region/bolivia" target="_blank">Equaldex</a> reports indicate that safety for QPOC (LGBT People of Color/Indigenous) is a primary concern, as they face double-discrimination.</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #91</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Ranking in the Spartacus Index 2026 reflects the mismatch between strong constitution and poor social implementation.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Constitutional protection exists but enforcement in rural areas is virtually zero.</p>
            </div>
        </div>
    `,
        ...
        <p>The "Marcha del Orgullo" (Pride) takes place in June 2026. The 2025 security posture was "Challenged," with local groups requiring private security to ward off counter-protesters. Voices from the Ground: <a href="https://nomadicboys.com/gay-la-paz-bolivia/" target="_blank">Nomadic Boys</a> emphasize that discretion is the safest policy for tourists.</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">Entry is smooth. High visibility is not recommended in public transit or rural markets. Sopocachi is your safe zone.</p>
            </div>
        </div>
    `,
        ...
        <p>Emergency medical care is available but sensitivity to LGBTQ+ issues is low. Voices from the Ground: <a href="https://alturi.org/" target="_blank">Alturi</a> recommends ADESPROC Libertad for all health-related LGBT support. Emergency: 911.</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">ADESPROC Libertad</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">Calle Aspiazu No. 595, La Paz, Bolivia</p>
                <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +591 2 2415124</p>
            </div>
        </div>
    `,
...
<div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;"> 
<strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">🏛️ EQ Bonaire</strong> 
<p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The primary advocate for LGBTQ+ rights across the BES islands, focusing on visibility and education.</p> 
...
* **Amber Zones:** None; the islands are uniformly safe.</p>
<p><strong>The Venue Spectrum:</strong> 
* **Upscale/Protected:** Harbour Village Beach Club (Bonaire) 
* **The Local Way:** Tropics Café (Saba - very LGBT-friendly hub)</p>
<div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;"> 
...
<div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;"> 
<strong style="display: block; font-size: 1.1rem; margin-bottom: 5px; color: #ffffff;">Fundashon Mariadal</strong> 
...
<p>The "Dutch Tropical" posture in the BES islands offers a unique blend of Caribbean relaxation and European legal certainty. The 2026 verdict is "Caribbean Sanctuary."</p> `,
	...
	brazil: {
        ...
        <p>Gender identity recognition is world-class. Transgender individuals can change their name and gender marker on all documents without surgery or medical diagnosis, following the 2018 STF ruling. Voices from the Ground: <a href="https://database.ilga.org/brazil-lgbti" target="_blank">ILGA World</a> highlights Brazil's judicial system as the primary guardian of LGBT rights.</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 STF ADO 26 Ruling (2019)</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The landmark decision criminalizing LGBTQ+ phobia under the Racism Law (Lei 7.716/89).</p>
                <a href="https://database.ilga.org/brazil-lgbti" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
            </div>
        </div>
    `,
        ...
        <p>Police protection is proactive in "Safe Havens" but inconsistent in low-income favelas. Voices from the Ground: <a href="https://www.equaldex.com/region/brazil" target="_blank">Equaldex</a> summaries emphasize that intersectionality is critical, as Black trans women face the highest risks in 2026.</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #34</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Brazil's rank in Spartacus 2026 is high due to legal rights, but lowered by safety concerns for trans residents.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">State-funded legal support specifically for LGBTQ+ victims of discrimination.</p>
            </div>
        </div>
    `,
        ...
        <p>São Paulo Pride 2026 is expected to be the world's largest, scheduled for June. The 2025 security posture was "Robust," with thousands of police ensuring the parade remained a safe, festive space. Voices from the Ground: <a href="https://www.iglta.org/" target="_blank">IGLTA</a> ranks São Paulo as one of the top global LGBT destinations.</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">Very smooth entry. Total visibility is welcome in cities. Caution is advised in rural outskirts and some city centers at night.</p>
            </div>
        </div>
    `,
        ...
        <p>Emergency care is reliable. Voices from the Ground: <a href="https://alturi.org/" target="_blank">Alturi</a> suggests the "Centro de Referência e Treinamento em DST/AIDS" in São Paulo as a top facility. Emergency: 192.</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">CRT DST/AIDS</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">Rua Santa Cruz, 81, São Paulo, Brazil</p>
                <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +55 11 5087-9911</p>
            </div>
        </div>
    `,
	...
	british_virgin_islands: {
        ...
        <p>There are no legal mechanisms for gender identity recognition in the BVI. Transgender individuals cannot change their legal name or gender marker on birth certificates or national identification documents. Activists in 2025 reported that this remains a primary barrier for the trans community in accessing basic government services.</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Caribbean Territories Order 2000</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The landmark order from the United Kingdom that decriminalized consensual same-sex acts across the BVI.</p>
                <a href="https://database.ilga.org/british-virgin-islands-lgbti" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
            </div>
        </div>
    `,
        ...
        <p>Police protection is responsive to physical threats but lacks specific SOGI-focused training or liaison officers. High-level visibility in government is non-existent in 2026. Voices from the Ground: <a href="https://www.equaldex.com/region/british-virgin-islands" target="_blank">Equaldex</a> indicates that the social environment is primarily "G-mapped," with very few resources or visibility for feminine-presenting or trans individuals.</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #88</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Ranking from the Spartacus Gay Travel Index 2026 reflects the territory's lack of progressive legislation despite the decriminalized status.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Lack of explicit SOGI anti-discrimination laws in the 2025/2026 legal framework.</p>
            </div>
        </div>
    `,
        ...
        <p>Practical advice: Treat De Jure (legal) status as the baseline but understand De Facto (social) reality is conservative. Travelers should stick to international hotels for high visibility. Voices from the Ground: <a href="https://www.iglta.org/" target="_blank">IGLTA</a> notes that the BVI is a safe destination as long as tourists respect local social norms regarding discretion.</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">Customs is professional. Discretion in public areas like Road Town is advised to avoid social friction.</p>
            </div>
        </div>
    `,
        ...
        <p>Emergency protocols are standard. Institutions do not have mandatory SOGI inclusivity training. Voices from the Ground: <a href="https://alturi.org/" target="_blank">Alturi</a> suggests contacting regional advocacy groups for the most current medical referrals. Emergency: 999 or 911.</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Peebles Hospital</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">Road Town, Tortola, British Virgin Islands</p>
                <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +1 284-494-3497</p>
            </div>
        </div>
    `,
	...
	canada: {
        ...
        <p>Gender identity laws are highly progressive; "X" gender markers are available on passports and federal IDs. Most provinces allow for the correction of gender markers through a simple administrative process that does not require surgery. In early 2026, new federal guidelines were issued to ensure the safety of trans youth in educational settings.</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Bill C-4 (Anti-Conversion Therapy)</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The federal law that criminalizes conversion therapy practices across all Canadian provinces.</p>
                <a href="https://database.ilga.org/canada-lgbti" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
            </div>
        </div>
    `,
        ...
        <p>Police protection is highly proactive, with dedicated LGBTQ+ liaison officers in every major city. Visibility is at the highest levels of government, including several openly LGBT cabinet ministers. Voices from the Ground: <a href="https://www.thetrevorproject.org/" target="_blank">The Trevor Project</a> notes Canada as a "Safe Haven" for youth and vulnerable sub-sectors of the rainbow.</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #2</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Ranked consistently at the top of the Spartacus Gay Travel Index 2026 for its legal rights and low crime rates against the community.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">State-mandated LGBTQ+ safety certifications for major businesses and public transport.</p>
            </div>
        </div>
    `,
        ...
        <p>Practical advice: Use the 2026 IGLTA-vetted guides to find "Rainbow Registered" businesses. De Jure and De Facto safety are perfectly aligned. Voices from the Ground: <a href="https://www.iglta.org/" target="_blank">IGLTA</a> ranks Canada as the gold standard for inclusive tourism.</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">Seamless entry for all gender identities. Total visibility in all major cities. Safe zones: The Village (Toronto) and Davie Village (Vancouver).</p>
            </div>
        </div>
    `,
        ...
        <p>Emergency protocols are inclusive; medical staff are trained in SOGI competency. Voices from the Ground: <a href="https://alturi.org/" target="_blank">Alturi</a> identifies "Sherbourne Health" in Toronto as a primary medical contact. Emergency: 911.</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Sherbourne Health</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">333 Sherbourne St, Toronto, ON, Canada</p>
                <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +1 416-324-4100</p>
            </div>
        </div>
    `,
	...
	cayman_islands: {
        ...
        <p>Legal gender recognition is practically non-existent in the Cayman Islands. There are no formal administrative processes for changing gender markers on birth certificates. Transgender individuals must navigate a case-by-case judicial approach for any name changes on official documentation as of 2026.</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Civil Partnership Act 2020</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The act providing same-sex couples with legal recognition and rights equivalent to marriage.</p>
                <a href="https://database.ilga.org/cayman-islands-lgbti" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
            </div>
        </div>
    `,
        ...
        <p>Police protection is highly efficient and professional, though there is no specific LGBTQ+ unit. Visibility in the highest levels of government is non-existent in 2026. Voices from the Ground: <a href="https://www.equaldex.com/region/cayman-islands" target="_blank">Equaldex</a> reports that the community feels safe but "unseen" in the broader social fabric.</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #72</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Ranking in the Spartacus Gay Travel Index 2026 is bolstered by the Civil Partnership Act but limited by the lack of full marriage and trans rights.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">High level of physical safety combined with a high degree of social discretion.</p>
            </div>
        </div>
    `,
        ...
        <p>Cayman Pride occurs in October 2026. The 2025 security posture was "Excellent," with police ensuring the peaceful nature of the parade despite small counter-protests. Practical advice: De Jure safety is high for tourists. Voices from the Ground: <a href="https://www.iglta.org/" target="_blank">IGLTA</a> notes that the islands are a premier luxury destination with high hospitality standards.</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">Entry is smooth. Discretion is recommended outside of Seven Mile Beach. Safe zone: Major luxury resorts.</p>
            </div>
        </div>
    `,
        ...
        <p>Emergency protocols are highly efficient. Inclusivity training for medical staff is not mandatory but common in private institutions. Voices from the Ground: <a href="https://alturi.org/" target="_blank">Alturi</a> suggests the "HSA Cayman" for general medical inquiries. Emergency: 911.</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Cayman Islands Health Services Authority</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">95 Hospital Rd, George Town, Cayman Islands</p>
                <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +1 345-949-8600</p>
            </div>
        </div>
    `,
	...
	chile: {
        ...
        <p>Gender identity is protected under the Gender Identity Law (2018), which allows individuals over 18 to change their name and gender marker on legal documents without surgery. In 2026, new administrative protocols were implemented to further protect the rights of non-binary individuals and trans youth.</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Ley de Matrimonio Igualitario (2022)</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The law that legalized same-sex marriage and established equal parental rights for all couples in Chile.</p>
                <a href="https://database.ilga.org/chile-lgbti" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
            </div>
        </div>
    `,
        ...
        <p>Police protection is generally proactive in urban centers, and the community has significant visibility in the highest levels of government, including several openly LGBT parliamentarians. Voices from the Ground: <a href="https://www.thetrevorproject.org/" target="_blank">The Trevor Project</a> notes Chile's increasing focus on mental health resources for LGBT youth.</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #24</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Chile's high ranking in the Spartacus Gay Travel Index 2026 reflects its legislative advances and the physical safety of its cities.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The presence of state-mandated anti-discrimination protocols in all public institutions.</p>
            </div>
        </div>
    `,
        ...
        <p>The "Marcha del Orgullo" occurs in June 2026. The 2025 security posture was "Peaceful and Protected," with a strong police presence to ensure the safety of participants. Voices from the Ground: <a href="https://www.iglta.org/" target="_blank">IGLTA</a> notes that Chile's inclusive tourism sector is growing rapidly.</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">Smooth entry. High visibility is common in urban centers. Safe zones: Bellavista and Lastarria in Santiago.</p>
            </div>
        </div>
    `,
        ...
        <p>Emergency protocols are inclusive; institutions are increasingly adopting SOGI competency training. Voices from the Ground: <a href="https://alturi.org/" target="_blank">Alturi</a> identifies "MOVILH" as a primary contact for health advocacy. Emergency: 131.</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">MOVILH Health Advocacy</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">Coquimbo 1410, Santiago, Chile</p>
                <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +56 2 2671 4855</p>
            </div>
        </div>
    `,
	...
	colombia: {
        ...
        <p>Gender identity recognition is highly advanced; non-binary individuals can access "X" gender markers on national IDs. Transgender individuals can change their name and gender marker through a simple administrative process without medical intervention. In 2026, new protocols were established to ensure trans-inclusive services in rural municipalities.</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Sentencia C-286/22 (Non-Binary Rights)</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The Constitutional Court ruling that mandated the inclusion of a non-binary gender marker on all national identification documents.</p>
                <a href="https://database.ilga.org/colombia-lgbti" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
            </div>
        </div>
    `,
        ...
        <p>Police protection is generally proactive in major cities, with specialized units for community safety. Visibility is high in government, including openly LGBT mayors and parliamentarians. Voices from the Ground: <a href="https://www.thetrevorproject.org/" target="_blank">The Trevor Project</a> notes Colombia's increasing focus on mental health resources for LGBTQ+ youth.</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #38</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Colombia's ranking in the Spartacus Gay Travel Index 2026 reflects its progressive laws but is tempered by safety issues in specific urban outskirts and rural zones.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The presence of specialized "Equality Houses" (Casas de Igualdad) in Bogotá offering dedicated services for the community.</p>
            </div>
        </div>
    `,
        ...
        <p>Practical advice: Use IGLTA-vetted guides to find inclusive "Rainbow" businesses. Discretion is advised in rural areas where social conservative values are more prevalent. Voices from the Ground: <a href="https://www.iglta.org/" target="_blank">IGLTA</a> ranks Colombia as one of the top emerging destinations for inclusive travel.</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">Seamless entry for all gender identities. High visibility is welcome in urban safe zones like Chapinero. Standard caution advised in rural areas.</p>
            </div>
        </div>
    `,
        ...
        <p>Emergency protocols are inclusive; medical staff in major cities are increasingly trained in SOGI competency. Voices from the Ground: <a href="https://alturi.org/" target="_blank">Alturi</a> identifies "Colombia Diversa" as a primary health advocacy contact. Emergency: 123.</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Colombia Diversa</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">Calle 30A # 6-22, Oficina 1102, Bogotá, Colombia</p>
                <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +57 1 310 3266</p>
            </div>
        </div>
    `,
	...
	costa_rica: {
        ...
        <p>Gender identity laws allow for the administrative change of name and gender marker on the "Cédula de Identidad" without the requirement of surgical intervention or psychiatric diagnosis. In 2025, the government expanded these protections to ensure trans youth have access to name-change protocols in educational settings with parental consent. Voices from the Ground: <a href="https://database.ilga.org/costa-rica-lgbti" target="_blank">ILGA World Database</a> confirms the 2026 status of these identity protections as among the strongest in the LATAM region.</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Opinion Consultiva OC-24/17</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The IACHR ruling that paved the way for marriage equality and gender identity recognition across the country.</p>
                <a href="https://database.ilga.org/costa-rica-lgbti" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
            </div>
        </div>
    `,
        ...
        <p>Police protection is professional, and the Ministry of Public Security has implemented specific training for interacting with the LGBTQ+ community as of 2025. Visibility in government is notable, with several openly LGBT individuals serving in diplomatic and legislative roles. Voices from the Ground: <a href="https://www.humandignitytrust.org/country-profile/costa-rica/" target="_blank">Human Dignity Trust</a> notes that physical safety is among the highest in the region.</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #32</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Ranking from Spartacus Gay Travel Index 2026, reflecting high legal scores but lower scores for rural religious influence.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The "Sello de Igualdad" (Equality Seal) program for inclusive businesses sanctioned by the state.</p>
            </div>
        </div>
    `,
        ...
        <p>The "Marcha de la Diversidad" in San José (June 2026) is the largest in Central America. The 2025 security posture was "Low Risk," with significant police escort and no major incidents. Practical advice: In 2026, many eco-lodges in the Guanacaste region have become IGLTA-certified. Voices from the Ground: <a href="https://www.iglta.org/destinations/costa-rica/" target="_blank">IGLTA</a> recommends Manuel Antonio as the primary "Safe Haven" for LGBT tourism.</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 20px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">Customs is LGBTQ-friendly. Public visibility is high in San José. Use "Barrio Escalante" as your social hub.</p>
            </div>
        </div>
    `,
        ...
        <p>Emergency protocols are inclusive. Institutions like Clínica Bíblica have implemented 2025 sensitivity guidelines for trans patients. Voices from the Ground: <a href="https://alturi.org/" target="_blank">Alturi</a> suggests contacting "Acceder" for legal-medical advocacy if issues arise. Emergency: 911.</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Hospital CIMA San José</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">Próspero Fernández Highway, Escazú, San José</p>
                <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +506 2208-1000</p>
            </div>
        </div>
    `,
	...
	cuba: {
        ...
        <p>Legal gender recognition has existed since 2008 for those undergoing gender-affirming surgery, but the 2022 laws significantly eased the administrative pathway for name and marker changes. In 2025, the state-run CENESEX pushed for broader access to these changes without surgical requirements, though full administrative autonomy is still being refined in 2026. Voices from the Ground: <a href="https://database.ilga.org/cuba-lgbti" target="_blank">ILGA World</a> cites Cuba as a unique model of state-led LGBTQ+ advocacy.</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Código de las Familias 2022</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The comprehensive legal framework that legalized marriage equality and multi-generational family protections.</p>
                <a href="https://database.ilga.org/cuba-lgbti" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
            </div>
        </div>
    `,
        ...
        <p>Police protection is generally efficient for tourists, though harassment of independent local activists was reported in 2025. Visibility is present in state institutions, primarily through the leadership of CENESEX. Voices from the Ground: <a href="https://www.humandignitytrust.org/country-profile/cuba/" target="_blank">Human Dignity Trust</a> notes the stark contrast between state-led progress and the restriction of independent civil society.</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #58</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Ranking from Spartacus Index 2026; high marks for family law are offset by political restrictions and low traveler-specific posture.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">State-sanctioned "Congas contra la Homofobia" provide periodic but controlled visibility.</p>
            </div>
        </div>
    `,
        ...
        <p>The "Jornada Cubana contra la Homofobia" occurs in May 2026. The 2025 security posture was "Controlled," with state security managing the parade route strictly. Practical advice: Stick to state-vetted or IGLTA-member Casas Particulares. Voices from the Ground: <a href="https://www.iglta.org/" target="_blank">IGLTA</a> notes that Cuba’s luxury tourism sector is highly inclusive of same-sex couples.</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">Professional customs. Public PDA is accepted in Vedado. Avoid political advocacy to maintain personal safety.</p>
            </div>
        </div>
    `,
        ...
        <p>Emergency protocols are adequate in Havana but limited in rural provinces. Sensitivity training is mandatory for health workers at CENESEX-affiliated clinics. Voices from the Ground: <a href="https://alturi.org/" target="_blank">Alturi</a> suggests bringing all essential HIV/HRT supplies as "Data Not Found" for local pharmacy reliability in 2026. Emergency: 104.</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">CENESEX (Centro Nacional de Educación Sexual)</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">Calle 10 No. 460 e/ 19 y 21, Vedado, Havana</p>
                <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +53 7 8301015</p>
            </div>
        </div>
    `,
	...
	curacao: {
        ...
        <p>Gender identity laws are governed by Kingdom-level precedents, though administrative local processes in Willemstad have been described by 2025 local advocates as "improving but slow." There is no longer a requirement for surgery to change gender markers on identity documents. Voices from the Ground: <a href="https://database.ilga.org/curacao-lgbti" target="_blank">ILGA World</a> confirms the transition to full marriage equality in the 2025–2026 period.</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Dutch Supreme Court Ruling 2024</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The final judicial decision that struck down the ban on same-sex marriage in Curaçao and Aruba.</p>
                <a href="https://www.equaldex.com/region/curacao" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
            </div>
        </div>
    `,
        ...
        <p>Police protection is high, following Dutch-aligned protocols for hate speech and discrimination. Visibility in local government has increased since the 2024 ruling. Voices from the Ground: <a href="https://www.humandignitytrust.org/country-profile/curacao/" target="_blank">Human Dignity Trust</a> notes that Curaçao is now the safest destination for LGBTQ+ people in the ABC islands.</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #34</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Ranking from Spartacus Index 2026, reflecting the massive jump following the 2024 marriage ruling.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Full parity with Netherlands-Kingdom law regarding human rights protections.</p>
            </div>
        </div>
    `,
        ...
        <p>Curaçao Pride in September 2026 is a major regional event. The 2025 security posture was "Very Safe," characterized by vibrant public parades through Punda and Otrobanda without incident. Voices from the Ground: <a href="https://www.iglta.org/" target="_blank">IGLTA</a> highlights the island's proactive marketing to the LGBTQ+ community as a major success factor.</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">Welcoming customs. High visibility in Pietermaai. Total acceptance in major beach clubs.</p>
            </div>
        </div>
    `,
        ...
        <p>Emergency protocols are inclusive. CMC Willemstad has established a SOGI liaison for international patients as of late 2025. Voices from the Ground: <a href="https://alturi.org/" target="_blank">Alturi</a> suggests the island is a safe hub for medical needs in the Southern Caribbean. Emergency: 911.</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Curaçao Medical Center (CMC)</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">J.H.J. Hamelbergweg, Willemstad, Curaçao</p>
                <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +599 9 745-0000</p>
            </div>
        </div>
    `,
	...
	dominica: {
        ...
        <p>Gender identity laws do not exist in Dominica. There is no legal mechanism for transgender individuals to change their name or gender marker on official documents in 2026. Local advocates report that this remains a primary barrier for the visibility of the trans community. Voices from the Ground: <a href="https://database.ilga.org/dominica-lgbti" target="_blank">ILGA World</a> confirms the post-decriminalization legal landscape is focused on basic recognition.</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 High Court Ruling (April 2024)</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The landmark judicial decision that decriminalized same-sex acts by declaring sections 14 and 16 of the Sexual Offences Act unconstitutional.</p>
                <a href="https://www.humandignitytrust.org/country-profile/dominica/" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
            </div>
        </div>
    `,
        ...
        <p>Police protection has theoretically improved following the 2024 ruling, though specific SOGI training is still not a standard protocol as of 2026. There is no visible LGBTQ+ representation in the highest levels of government. Voices from the Ground: <a href="https://www.equaldex.com/region/dominica" target="_blank">Equaldex</a> reports that the community feels safer legally but remains socially invisible.</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #94</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Ranking from Spartacus Index 2026, reflecting the decriminalization progress but low marks for social acceptance.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Removal of "Buggery" laws in 2024; however, no anti-discrimination statutes yet exist.</p>
            </div>
        </div>
    `,
        ...
        <p>Significant events: There is no public Pride event in 2026. Local advocates from "MiRiDom" held a private TDoV march in 2025; the security posture was "Internal/Private" to avoid public friction. Practical advice: Treat the island as a nature destination rather than a nightlife hub. Voices from the Ground: <a href="https://www.iglta.org/" target="_blank">IGLTA</a> notes that the island’s luxury eco-lodges are the primary safe zones for LGBT visitors.</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">Professional customs entry. Discretion is required in Roseau. Stick to private eco-resorts for open visibility.</p>
            </div>
        </div>
    `,
        ...
        <p>Emergency protocols are standard. Inclusivity levels in medical institutions are "Data Not Found." Voices from the Ground: <a href="https://alturi.org/" target="_blank">Alturi</a> suggests contacting regional NGOs like ECADE for medical referrals. Emergency: 999.</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Princess Margaret Hospital</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">Goodwill Road, Roseau, Dominica</p>
                <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +1 767-448-2231</p>
            </div>
        </div>
    `,
	...
	dominican_republic: {
        ...
        <p>There is no legal mechanism for gender identity recognition. Transgender individuals cannot change their name or gender marker on the "Cédula." In early 2026, local activists from "TRANSSA" continue to push for an Identity Law, but the government maintains a conservative stance. Voices from the Ground: <a href="https://database.ilga.org/dominican-republic-lgbti" target="_blank">ILGA World</a> confirms that legal protections remain the lowest in the Caribbean for a nation of its size.</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Constitution of 2010 (Article 55)</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The article that explicitly defines marriage as between a man and a woman, precluding same-sex unions.</p>
                <a href="https://database.ilga.org/dominican-republic-lgbti" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
            </div>
        </div>
    `,
        ...
        <p>Police protection is inconsistent; reports from 2025 indicate that local police can sometimes be the perpetrators of harassment toward trans women. There is no visible LGBTQ+ representation in high-level government. Voices from the Ground: <a href="https://www.humandignitytrust.org/country-profile/dominican-republic/" target="_blank">Human Dignity Trust</a> notes the lack of hate crime legislation as a primary safety gap.</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #102</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Ranking from Spartacus Index 2026, reflecting high tourism safety but extremely low legal and social scores.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Absence of specific legal protections for trans citizens; high risk for public gender non-conformity.</p>
            </div>
        </div>
    `,
        ...
        <p>The Santo Domingo Pride (Caravana del Orgullo) occurs in July 2026. The 2025 security posture was "Moderate Risk," with some verbal counter-protests from religious groups but no major violence. Practical advice: Stick to IGLTA-vetted resorts in Punta Cana for the safest experience. Voices from the Ground: <a href="https://www.iglta.org/" target="_blank">IGLTA</a> highlights the luxury sector as the most inclusive "Safe Haven" for travelers.</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">Customs is professional but conservative. Public PDA is best kept to the Zona Colonial or private resorts in Punta Cana.</p>
            </div>
        </div>
    `,
        ...
        <p>Emergency protocols are standard. Inclusivity levels in medical institutions are low. Voices from the Ground: <a href="https://alturi.org/" target="_blank">Alturi</a> suggests contacting "Amigos Siempre Amigos" (ASA) for health referrals. Emergency: 911.</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">CEDIMAT</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">Calle Pepillo Salcedo, Santo Domingo, DR</p>
                <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +1 809-565-9989</p>
            </div>
        </div>
    `,
	...
	ecuador: {
        ...
        <p>Gender identity laws allow for the administrative change of gender markers on the "cédula" without surgical requirements. In 2025, the government streamlined the process for non-binary markers, though local NGOs like Silueta X report that the 2026 social climate still presents hurdles for trans individuals in the workforce. Voices from the Ground: <a href="https://database.ilga.org/ecuador-lgbti" target="_blank">ILGA World Database</a> confirms the right to identity recognition.</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Sentencia 11-18-CN/19</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The Constitutional Court ruling that legalized same-sex marriage nationwide.</p>
                <a href="https://database.ilga.org/ecuador-lgbti" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
            </div>
        </div>
    `,
        ...
        <p>Police protection is theoretically mandated, but local advocates describe the 2025 security posture as "unreliable," particularly for trans women of color. There is minimal visibility of LGBTQ+ individuals in the highest levels of the 2026 administration. Voices from the Ground: <a href="https://www.humandignitytrust.org/country-profile/ecuador/" target="_blank">Human Dignity Trust</a> highlights the gap between constitutional theory and police practice.</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #48</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Ranking from Spartacus Gay Travel Index 2026, reflecting high legal scores but mid-range safety metrics.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Constitutional protection against discrimination is a key legal safeguard.</p>
            </div>
        </div>
    `,
        ...
        <p>Quito Pride (June 2026) remains the largest event, while the "Festival de Cine LGBT El Lugar Sin Límites" (November 2026) offers a cultural safe space. The 2025 security posture for Pride was "Moderate," with visible but sometimes hands-off police presence. Voices from the Ground: <a href="https://www.iglta.org/" target="_blank">IGLTA</a> recommends staying in international hotel chains for guaranteed inclusivity.</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">Professional entry; public PDA is accepted in Quito/Cuenca but use discretion in the Oriente region.</p>
            </div>
        </div>
    `,
        ...
        <p>Emergency protocols are standard. Inclusivity levels are higher in private facilities like "Hospital Metropolitano." Voices from the Ground: <a href="https://alturi.org/" target="_blank">Alturi</a> suggests contacting local NGOs for vetted medical referrals. Emergency: 911.</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Fundación Equidad</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">Quito, Ecuador (Community Health Center)</p>
                <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +593 2-252-0313</p>
            </div>
        </div>
    `,
	...
	el_salvador: {
        ...
        <p>Gender identity recognition is virtually non-existent. Despite a 2022 Supreme Court ruling mandating a pathway for name changes, 2025 reports confirm that the legislative assembly has refused to implement a functional law. Voices from the Ground: <a href="https://database.ilga.org/el-salvador-lgbti" target="_blank">ILGA World Database</a> highlights that El Salvador remains a high-risk environment for trans people seeking legal recognition.</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Supreme Court Ruling 2022 (Gender Identity)</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">A judicial mandate for name changes that currently lacks legislative implementation.</p>
                <a href="https://www.humandignitytrust.org/country-profile/el-salvador/" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
            </div>
        </div>
    `,
        ...
        <p>Police protection is often viewed with suspicion; 2025 reports from "COMCAVIS TRANS" suggest that trans women frequently face arbitrary detention. There is zero LGBTQ+ visibility in the 2026 government. Voices from the Ground: <a href="https://www.humandignitytrust.org/country-profile/el-salvador/" target="_blank">Human Dignity Trust</a> records high levels of violence against LGBTQ+ persons with near-total impunity.</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #138</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Ranking from Spartacus Gay Travel Index 2026, placing it among the most dangerous in Central America.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">State-led removal of LGBTQ+ rights protections in labor and health sectors since 2024.</p>
            </div>
        </div>
    `,
        ...
        <p>Events: No public Pride event is scheduled for 2026 due to the 2025 security posture, which saw several activists detained. Practical advice: Book only through IGLTA-vetted international chains and avoid using dating apps. Voices from the Ground: <a href="https://www.iglta.org/" target="_blank">IGLTA</a> notes that inclusive tourism is currently suppressed by the national political climate.</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">Strict binary screening at customs. Total discretion is required; avoid any LGBTQ+ symbols or apparel.</p>
            </div>
        </div>
    `,
        ...
        <p>Emergency protocols do not account for LGBTQ+ needs. Medical institutional bias is high. Voices from the Ground: <a href="https://alturi.org/" target="_blank">Alturi</a> recommends travelers have comprehensive medevac insurance. Emergency: 911.</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Asociación Entre Amigos</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">San Salvador, El Salvador (NGO-led clinic)</p>
                <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +503 2222-0000 (Varies)</p>
            </div>
        </div>
    `,
	...
	falkland_islands: {
        ...
        <p>Gender identity laws follow UK precedents, allowing for legal change of name and gender marker. In 2025, administrative processes were updated to ensure ease of access for the small local population. Voices from the Ground: <a href="https://database.ilga.org/falkland-islands-lgbti" target="_blank">ILGA World Database</a> confirms full legal parity with the UK Mainland.</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Marriage Amendment Ordinance 2017</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The legislation that brought full marriage equality to the territory.</p>
                <a href="https://database.ilga.org/falkland-islands-lgbti" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
            </div>
        </div>
    `,
        ...
        <p>Police protection is professional and follows UK standards. Visibility in government is common on an informal basis. Voices from the Ground: <a href="https://www.equaldex.com/region/falkland-islands" target="_blank">Equaldex</a> reports zero instances of targeted hate crimes in the 2024-2026 period.</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #22</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Reflecting UK-territory standards for legal and physical safety in 2026.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Full integration with UK Human Rights Acts and protections.</p>
            </div>
        </div>
    `,
        ...
        <p>Events: There is no formal Pride parade due to the population size, but Pride month (June 2026) is often recognized in local social venues. The 2025 security posture for such gatherings was "Low Risk." Voices from the Ground: <a href="https://www.iglta.org/" target="_blank">IGLTA</a> notes the islands are an increasingly popular niche destination for LGBT eco-tourists.</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">Friendly customs. Open visibility is encouraged. No specific safety warnings for LGBT travelers.</p>
            </div>
        </div>
    `,
        ...
        <p>Emergency protocols are standard for UK territories. Inclusivity levels are high. Voices from the Ground: <a href="https://alturi.org/" target="_blank">Alturi</a> suggests the island is medically safe but remote. Emergency: 999.</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">King Edward VII Memorial Hospital</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">St Mary's Walk, Stanley, Falkland Islands</p>
                <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +500 28000</p>
            </div>
        </div>
    `,
	...
	french_guiana: {
        ...
        <p>Gender identity laws allow for legal change of name and gender marker based on social self-identification since 2017, without surgical requirements. The process is administrative and handled via the local civil courts. Voices from the Ground: <a href="https://database.ilga.org/french-guiana-lgbti" target="_blank">ILGA World Database</a> confirms full French legal status in 2026.</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Loi n° 2013-404</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The French national law opening marriage and adoption to same-sex couples.</p>
                <a href="https://database.ilga.org/french-guiana-lgbti" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
            </div>
        </div>
    `,
        ...
        <p>Police protection follows French National Police protocols, which include SOGI sensitivity training. There is visible representation in local administrative offices. Voices from the Ground: <a href="https://www.humandignitytrust.org/country-profile/french-guiana/" target="_blank">Human Dignity Trust</a> notes the lack of criminalization and the presence of EU-standard protections.</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #18</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Reflecting French national standards within a South American context for 2026.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Full application of the French Penal Code regarding hate speech and discrimination.</p>
            </div>
        </div>
    `,
        ...
        <p>Events: Local Pride activities occur in June 2026. The 2025 security posture was "Low Risk," with events being peaceful and community-focused. Voices from the Ground: <a href="https://www.iglta.org/" target="_blank">IGLTA</a> highlights French Guiana as a unique, safe portal for LGBT travel in the Amazon region.</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">EU-standard customs. Open visibility is normal in major towns. No specific restrictions on public behavior.</p>
            </div>
        </div>
    `,
        ...
        <p>Emergency protocols are EU-standard. Inclusivity levels in hospitals like "Centre Hospitalier Andrée Rosemon" are high. Voices from the Ground: <a href="https://alturi.org/" target="_blank">Alturi</a> suggests Cayenne is the medical hub for the region. Emergency: 15 (SAMU).</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Centre Hospitalier Andrée Rosemon</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">Avenue des Flamboyants, Cayenne, French Guiana</p>
                <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +594 594 39 50 50</p>
            </div>
        </div>
    `,
	...
	grenada: {
        ...
        <p>Gender identity recognition is not codified; there is no administrative process for changing gender markers on official identification. Transgender individuals navigate a legal vacuum where their identity is neither criminalized nor protected, often leading to administrative hurdles in public services. Voices from the Ground: <a href="https://database.ilga.org/grenada-lgbti" target="_blank">ILGA World Database</a>.</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Criminal Code Section 431</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The colonial-era statute regarding "unnatural connection," currently under scrutiny by regional human rights bodies.</p>
                <a href="https://www.humandignitytrust.org/country-profile/grenada/" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
            </div>
        </div>
    `,
        ...
        <p>Police protection is generally professional but lacks specific SOGI (Sexual Orientation and Gender Identity) training. Visibility in government is minimal, though local NGOs report more productive private dialogues with state officials in 2026. Voices from the Ground: <a href="https://www.outrightinternational.org/" target="_blank">Outright International</a>.</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #114</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Performance in Spartacus Gay Travel Index 2026, reflecting the presence of non-enforced criminal laws.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Social conservatism remains the primary risk factor rather than active legal prosecution.</p>
            </div>
        </div>
    `,
        ...
        <p>While there are no public Pride marches, small community gatherings occur around IDAHOTB (May 2026). The 2025 security posture for these private events was "Secure," but they remain unpublicized for safety. Voices from the Ground: <a href="https://www.iglta.org/" target="_blank">IGLTA</a> advises travelers to book through inclusive-certified providers.</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">Public PDA is a cultural taboo; discretion at customs is advised for trans travelers.</p>
            </div>
        </div>
    `,
        ...
        <p>Emergency protocols are standard for the region. Inclusivity levels are highest in private clinics in St. George’s. For specialized gender-affirming care, most locals and expatriates travel to larger regional hubs.</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">St. George's General Hospital</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">Grand Etang Road, St. George's</p>
                <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +1 (473) 440-2051</p>
            </div>
        </div>
    `,
	...
	guadeloupe: {
        ...
        <p>Gender identity laws allow for the legal change of name and gender marker through a court process that does not require medical intervention or surgery. In 2025, French administrative updates further streamlined these processes to reduce wait times for residents in overseas territories. Voices from the Ground: <a href="https://database.ilga.org/guadeloupe-lgbti" target="_blank">ILGA World Database</a>.</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 French Civil Code (Code civil)</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The unified legal code of France, ensuring marriage and adoption parity across all departments.</p>
                <a href="https://database.ilga.org/guadeloupe-lgbti" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
            </div>
        </div>
    `,
        ...
        <p>Police protection is proactive, following French national mandates for handling hate crimes. Visibility in government is present, with local officials often participating in equality-focused cultural events. Voices from the Ground: <a href="https://www.iglta.org/" target="_blank">IGLTA</a>.</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #14</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Ranking reflects French national standing in the Spartacus Gay Travel Index 2026.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Full protection under EU human rights law and French anti-discrimination statutes.</p>
            </div>
        </div>
    `,
        ...
        <p>Significant event: "Fierté Guadeloupe" (Pride) typically occurs in June 2026. The 2025 security posture was "Excellent," with local police ensuring a safe environment for marchers. Voices from the Ground: <a href="https://www.gaytimes.com/" target="_blank">Gay Times</a> describes the island as a "beacon of LGBT safety in the Antilles."</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">Standard French customs; visibility is high and LGBT symbols are common in urban areas.</p>
            </div>
        </div>
    `,
        ...
        <p>Emergency medical assistance is widely available. Inclusivity levels at the University Hospital of Guadeloupe are noted as high by regional observers. Voices from the Ground: <a href="https://alturi.org/" target="_blank">Alturi</a>.</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">CHU de la Guadeloupe</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">Route de Chauvel, Les Abymes</p>
                <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +590 590 89 10 10</p>
            </div>
        </div>
    `,
	...
	guatemala: {
        ...
        <p>Gender identity recognition is limited; while name changes are possible through a lengthy judicial process, there is no administrative right to change gender markers on passports or IDs. Trans activists describe the 2026 process as "systemically obstructive." Voices from the Ground: <a href="https://database.ilga.org/guatemala-lgbti" target="_blank">ILGA World Database</a>.</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Decree 18-2022 (Vetoed/Monitored)</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The controversial law that sought to criminalize "promoting" LGBTQ+ rights, currently under judicial stay but influential in social policy.</p>
                <a href="https://www.humandignitytrust.org/country-profile/guatemala/" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
            </div>
        </div>
    `,
        ...
        <p>Police protection is often considered unreliable by local NGOs, with reports of harassment occurring during 2025. There is no open visibility in the 2026 government. Voices from the Ground: <a href="https://www.outrightinternational.org/" target="_blank">Outright International</a> summarizes the activist sentiment as "resilient but under siege."</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #98</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Ranking from Spartacus Gay Travel Index 2026, reflecting social hostility despite legal decriminalization.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">High levels of religious influence in state policy as of 2026.</p>
            </div>
        </div>
    `,
        ...
        <p>Significant event: Guatemala City Pride (June 2026). The 2025 security posture was "Tense," with counter-protests reported. Travelers are advised to time visits carefully. Voices from the Ground: <a href="https://www.iglta.org/" target="_blank">IGLTA</a> recommends staying in international boutique hotels in Antigua for maximum safety.</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">Discretion at customs is mandatory for trans travelers. Public PDA is culturally risky.</p>
            </div>
        </div>
    `,
        ...
        <p>Emergency protocols do not include SOGI-sensitive training. Inclusivity levels are highest in private facilities in Guatemala City. Medical institutions in rural areas are often conservative and potentially hostile.</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Colectivo Amigos contra el SIDA (CAS)</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">14 Calle 3-51 Zona 1, Guatemala City</p>
                <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +502 2232 5431</p>
            </div>
        </div>
    `,
	...
	guyana: {
        ...
        <p>Gender identity recognition saw a small victory in late 2024 regarding cross-dressing laws, but there is still no administrative path for changing gender markers on legal documents. Transgender individuals live in a state of high legal vulnerability. Voices from the Ground: <a href="https://database.ilga.org/guyana-lgbti/" target="_blank">ILGA World Database</a>.</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Criminal Law (Offences) Act Sec. 352</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The primary statute criminalizing consensual same-sex acts between men.</p>
                <a href="https://www.humandignitytrust.org/country-profile/guyana/" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
            </div>
        </div>
    `,
        ...
        <p>Visibility in government is zero. The SASOD (Society Against Sexual Orientation Discrimination) remains the primary voice for the community, often operating under threat. Voices from the Ground: <a href="https://www.outrightinternational.org/" target="_blank">Outright International</a> summarizes the situation as a "human rights emergency."</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #162</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Ranking from Spartacus Gay Travel Index 2026, one of the lowest in the Western Hemisphere.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Ongoing criminalization remains the primary safety concern.</p>
            </div>
        </div>
    `,
        ...
        <p>Significant event: Small, unpublicized gatherings for IDAHOTB (May 2026). No public Pride events exist. The 2025 security posture for activists was "Very High Risk." Voices from the Ground: <a href="https://www.iglta.org/" target="_blank">IGLTA</a> advises against non-essential travel for highly visible LGBT individuals.</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">Criminalized acts; total discretion is required. Binary gender presentation is advised at customs.</p>
            </div>
        </div>
    `,
        ...
        <p>Emergency protocols do not account for LGBTQ+ needs. Medical institutions in Georgetown are the only viable option for foreigners, though discretion is still advised. Inclusivity levels are universally low.</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Georgetown Public Hospital</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">New Market St, Georgetown</p>
                <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +592 227 8210</p>
            </div>
        </div>
    `,
	...
	haiti: {
        ...
        <p>Gender identity recognition is non-existent. There is no legal framework for changing gender markers or names for transgender individuals, who are often targeted by both state and non-state actors due to their visibility. Voices from the Ground: <a href="https://database.ilga.org/haiti-lgbti" target="_blank">ILGA World Database</a>.</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Senate Decree on Same-Sex Marriage (2017)</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">A pending bill that reflects the high level of legislative hostility toward the LGBTQ+ community.</p>
                <a href="https://www.humandignitytrust.org/country-profile/haiti/" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
            </div>
        </div>
    `,
        ...
        <p>Visibility in government is zero. Local NGOs like Kouraj operate in a state of semi-clandestinity. Voices from the Ground: <a href="https://www.outrightinternational.org/" target="_blank">Outright International</a> summarizes the situation as "a collapse of safety for all, but a targeted erasure of the LGBT."</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #178</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Ranking from Spartacus Gay Travel Index 2026, one of the most dangerous globally due to state collapse and social hostility.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">High risk of targeted violence by non-state actors (gangs) with zero state protection.</p>
            </div>
        </div>
    `,
        ...
        <p>Significant event: None. Public Pride events or film festivals are impossible in the current climate. The 2025 security posture was "Catastrophic." Voices from the Ground: <a href="https://www.iglta.org/" target="_blank">IGLTA</a> advises a total boycott of travel for LGBTQ+ individuals for safety reasons.</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">Visibility is a direct threat to physical safety. Do not disclose LGBTQ+ status to any official or local.</p>
            </div>
        </div>
    `,
        ...
        <p>Emergency protocols are non-existent. Medical institutions in Port-au-Prince are dysfunctional. For LGBTQ+ foreigners, any medical emergency requires immediate extraction from the country.</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">SEROvie Haiti</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">Port-au-Prince, Haiti (Check local security for status)</p>
                <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: Status Unknown in 2026</p>
            </div>
        </div>
    `,
	...
	honduras: {
        ...
        <p>Gender identity laws allow for legal name changes, but the process for updating gender markers on official identity documents remains administratively opaque and often requires judicial intervention. In 2025, reports from ILGA World highlighted that trans individuals continue to face extreme legal precariousness due to the lack of a streamlined, self-determined gender recognition law. Voices from the Ground: <a href="https://database.ilga.org/honduras-lgbti" target="_blank">ILGA World Database</a>.</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Article 112 & 116 (Constitutional Reform)</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Constitutional amendments prohibiting same-sex marriage and recognizing only unions between a man and a woman.</p>
                <a href="https://www.humandignitytrust.org/country-profile/honduras/" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
            </div>
        </div>
    `,
        ...
        <p>Police protection is frequently described as inadequate or actively hostile. There is no significant LGBTQ+ visibility within the highest levels of the 2026 government. Local advocates summarize the sentiment as being in a state of "constant vigilance" (Voices from the Ground: <a href="https://www.outrightinternational.org/" target="_blank">Outright International</a>).</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #142</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Ranking in Spartacus Gay Travel Index 2026, reflecting high rates of violence and limited legal recourse.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Inter-American Court of Human Rights monitoring remains active due to historical state negligence.</p>
            </div>
        </div>
    `,
        ...
        <p>A significant event for 2026 is the Tegucigalpa Pride March, usually held in June. However, the 2025 security posture was "Tense," with activists requiring private security due to threats from fundamentalist groups. Voices from the Ground: <a href="https://www.iglta.org/" target="_blank">IGLTA</a> recommends only group travel with vetted inclusive operators.</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">Avoid LGBTQ+ symbols on luggage. Travelers with gender-non-conforming IDs should expect secondary questioning.</p>
            </div>
        </div>
    `,
        ...
        <p>Emergency protocols for LGBTQ+ individuals are not standardized. Foreigners are advised to use private medical facilities in Tegucigalpa or San Pedro Sula. Inclusivity levels are highest at NGO centers like Cozumel Trans.</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Cattrachas Health Referral Network</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">Tegucigalpa, MDC (Confidential Location)</p>
                <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +504 2221-3661</p>
            </div>
        </div>
    `,
	...
	jamaica: {
        ...
        <p>There is no legal framework for gender identity recognition or the ability to change gender markers on official documents. Transgender Jamaicans live in a state of legal invisibility, often facing barriers to employment and education. Voices from the Ground: <a href="https://database.ilga.org/jamaica-lgbti" target="_blank">ILGA World Database</a>.</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Offences Against the Person Act (1864)</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The colonial-era statute that criminalizes "the abominable crime of buggery" and gross indecency.</p>
                <a href="https://www.humandignitytrust.org/country-profile/jamaica/" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
            </div>
        </div>
    `,
        ...
        <p>Police proactivity is non-existent, with many in the community reporting harassment from authorities. There is no LGBTQ+ visibility in the government. Local activists note the social shift is "glacially slow" (Voices from the Ground: <a href="https://www.outrightinternational.org/" target="_blank">Outright International</a>).</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #158</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Ranking in Spartacus Gay Travel Index 2026, driven by active criminalization and high social stigma.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Public sentiment often equates LGBT identity with "moral decay," according to 2025 NGO reports.</p>
            </div>
        </div>
    `,
        ...
        <p>Significant event: Jamaica Pride (traditionally August), which usually involves private events rather than public marches. The 2025 security posture was "Extremely Cautious." Voices from the Ground: <a href="https://www.iglta.org/" target="_blank">IGLTA</a> advises travelers to stay within "inclusive-certified" resort boundaries.</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">Do not travel with LGBT literature or flags. Trans travelers should ensure all IDs match their current presentation.</p>
            </div>
        </div>
    `,
        ...
        <p>Emergency medical protocols are not inclusive. Foreigners should seek treatment at private facilities in Kingston or Montego Bay. Inclusivity levels are generally low across state institutions.</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Jamaica AIDS Support for Life (JASL)</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">14-16 West Avenue, Kingston</p>
                <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +1 876-925-0021</p>
            </div>
        </div>
    `,
	...
	martinique: {
        ...
        <p>Gender identity recognition is streamlined under French law; individuals can change their name and gender marker on legal documents without the requirement of medical intervention. 2025 updates to the French Civil Code further simplified these administrative processes. Voices from the Ground: <a href="https://database.ilga.org/martinique-lgbti" target="_blank">ILGA World Database</a>.</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Loi Taubira (Marriage for All)</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">French national law granting marriage and adoption rights to same-sex couples across all territories.</p>
                <a href="https://www.humandignitytrust.org/country-profile/martinique/" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
            </div>
        </div>
    `,
        ...
        <p>Police protection is proactive and mandated by French anti-discrimination statutes. Visibility in local government is present, with officials frequently supporting local equality NGOs. Voices from the Ground: <a href="https://www.iglta.org/" target="_blank">IGLTA</a>.</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #12</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Ranking in Spartacus Gay Travel Index 2026, shared with mainland France.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Full EU-standard safety protections and legal recourse for discrimination.</p>
            </div>
        </div>
    `,
        ...
        <p>Significant event: Martinique Pride (May/June 2026). The 2025 security posture was "Excellent," with full local municipality support and no major incidents reported. Voices from the Ground: <a href="https://www.nomadicboys.com/" target="_blank">Nomadic Boys</a> describes it as the "safest LGBT island in the Antilles."</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">Standard French customs; visibility is high and LGBT-friendly establishments are clearly marked.</p>
            </div>
        </div>
    `,
        ...
        <p>Emergency medical protocols are fully inclusive. Foreigners are advised to use the CHU (University Hospital) for specialized care. Inclusivity levels are high across all departments.</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">CHU de la Martinique (Pierre Zobda-Quitman)</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">CS 90632, Fort-de-France</p>
                <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +596 596 55 20 00</p>
            </div>
        </div>
    `,
	...
	mexico: {
        ...
        <p>Gender identity laws vary slightly by state but are generally progressive; over 20 states now allow for gender marker changes via a simple administrative process without medical requirements. In 2025, the federal government expanded access to "X" gender markers on passports for non-binary citizens. Voices from the Ground: <a href="https://database.ilga.org/mexico-lgbti" target="_blank">ILGA World Database</a>.</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Article 1 of the Constitution</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The foundational constitutional ban on discrimination, which explicitly includes sexual orientation.</p>
                <a href="https://www.humandignitytrust.org/country-profile/mexico/" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
            </div>
        </div>
    `,
        ...
        <p>Police protection is proactive in major cities, with specific SOGI training protocols implemented in 2025. Visibility in government is significant, with several openly LGBTQ+ individuals serving in the federal legislature. Voices from the Ground: <a href="https://www.outrightinternational.org/" target="_blank">Outright International</a>.</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #32</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Ranking in Spartacus Gay Travel Index 2026, reflecting high legal standing tempered by regional safety issues.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">State-mandated non-discrimination certifications for tourism businesses (IGLTA-Mexico partnership).</p>
            </div>
        </div>
    `,
        ...
        <p>Significant event: Mexico City Pride (June 2026), one of the largest in the world. The 2025 security posture was "Highly Secure," with major police presence to ensure safety from traffic and overcrowding. Voices from the Ground: <a href="https://www.iglta.org/" target="_blank">IGLTA</a> considers Mexico a top global destination for LGBT tourism.</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">High visibility is accepted in urban/tourist zones. Rural areas may require more discretion.</p>
            </div>
        </div>
    `,
        ...
        <p>Emergency medical protocols are inclusive in major tourist cities. Foreigners are advised to use private hospitals for convenience and language access, though public facilities are increasingly trained in SOGI sensitivity. Inclusivity levels are highest in "Clinica Condesa" (CDMX).</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Clínica Especializada Condesa</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">Benjamín Hill 24, Cuauhtémoc, Mexico City</p>
                <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +52 55 5515 8311</p>
            </div>
        </div>
    `,
	...
	montserrat: {
        ...
        <p>Gender identity laws are non-existent; there is no administrative process for changing gender markers on official identity documents. Transgender visibility is extremely low, and the legal framework offers no specific protections or recognition for gender diversity. Voices from the Ground: <a href="https://database.ilga.org/montserrat-lgbti" target="_blank">ILGA World Database</a>.</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Montserrat Constitution Order (2010)</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The territory's constitution which includes a general bill of rights and non-discrimination provisions.</p>
                <a href="https://www.humandignitytrust.org/country-profile/montserrat/" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
            </div>
        </div>
    `,
        ...
        <p>There is no visible LGBTQ+ presence in the 2026 government. Local sentiment is summarized as "acceptance through invisibility" (Voices from the Ground: <a href="https://www.outrightinternational.org/" target="_blank">Outright International</a>).</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #94</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Ranking in Spartacus Gay Travel Index 2026, reflecting safe legal standing but low social visibility.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">No reports of hate crimes in 2024–2025, but social conservatism remains high.</p>
            </div>
        </div>
    `,
        ...
        <p>Significant event: None. There are no public Pride events or LGBT festivals scheduled for 2026. The 2025 security posture for tourists was "Stable." Voices from the Ground: <a href="https://www.iglta.org/" target="_blank">IGLTA</a> notes that Montserrat is best for those seeking nature rather than nightlife.</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">Discretion is advised. There is no overt LGBT infrastructure, so travelers should plan accordingly.</p>
            </div>
        </div>
    `,
        ...
        <p>Emergency medical protocols are standard. Foreigners are treated as any other patient. Inclusivity levels are moderate, based on a "treat everyone equally" approach rather than specific LGBT-inclusive training.</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Glendon Hospital</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">St. John's, Montserrat</p>
                <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +1 664-491-2552</p>
            </div>
        </div>
    `,
	...
	nicaragua: {
        ...
        <p>Gender identity laws are non-existent. There is no administrative or legal process for transgender individuals to update their name or gender marker on official documents. Activists report that the current administration views LGBTQ+ advocacy as "foreign interference." Voices from the Ground: <a href="https://database.ilga.org/nicaragua-lgbti" target="_blank">ILGA World Database</a>.</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Ley No. 641: Código Penal</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The 2008 reform that removed 'Sodomy' as a crime, though no proactive rights have been added since.</p>
                <a href="https://database.ilga.org/nicaragua-lgbti" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
            </div>
        </div>
    `,
        ...
        <p>Police protection is non-existent; authorities are more likely to monitor than protect. No LGBTQ+ individuals hold state office in 2026. Significant events like Pride have been canceled since 2024 due to security risks. Voices from the Ground: <a href="https://www.outrightinternational.org/" target="_blank">Outright International</a>.</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #128</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Spartacus Gay Travel Index 2026 ranking, citing political instability and lack of hate crime laws.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Systematic closure of LGBTQ+ NGOs under "Foreign Agents" laws in 2025.</p>
            </div>
        </div>
    `,
        ...
        <p>There are no public LGBTQ+ events scheduled for 2026. The 2025 security posture was "High Risk." Voices from the Ground: <a href="https://www.iglta.org/" target="_blank">IGLTA</a> advises only essential travel for the community.</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">Expect scrutiny of digital devices. Maintain a total 'low-profile' regarding LGBTQ+ status.</p>
            </div>
        </div>
    `,
        ...
        <p>Emergency protocols are not inclusive. Inclusivity levels in medical institutions are near zero. Foreigners should seek medical evacuation for anything beyond basic needs.</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Regional Advocacy Reference</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">Contact regional NGOs in Costa Rica for assistance.</p>
                <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: Data Not Found</p>
            </div>
        </div>
    `,
	...
	panama: {
        ...
        <p>Gender identity laws allow for name changes, but gender marker updates require surgical intervention, a standard activists are fighting to overturn in 2026. The process is lengthy and lacks a self-determination framework. Voices from the Ground: <a href="https://database.ilga.org/panama-lgbti" target="_blank">ILGA World Database</a>.</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 2023 Supreme Court Ruling</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Decision affirming that the state is not constitutionally mandated to recognize same-sex marriage.</p>
                <a href="https://www.humandignitytrust.org/country-profile/panama/" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
            </div>
        </div>
    `,
        ...
        <p>Police protection is generally professional in tourist areas but inconsistent. No high-level 2026 government officials are openly LGBTQ+. Voices from the Ground: <a href="https://www.outrightinternational.org/" target="_blank">Outright International</a>.</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #76</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Spartacus Gay Travel Index 2026 ranking, noting legal hurdles but moderate social safety.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Active 'World Pride' bid discussions for future years, though domestic progress lags.</p>
            </div>
        </div>
    `,
        ...
        <p>Significant event: WorldPride Panama (June 2026). The 2025 security posture was "Moderate," with organizers working closely with police to manage counter-protesters. Voices from the Ground: <a href="https://www.iglta.org/" target="_blank">IGLTA</a>.</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">Casco Viejo is highly welcoming; rural Bocas del Toro requires more discretion regarding PDA.</p>
            </div>
        </div>
    `,
        ...
        <p>Emergency protocols are standard. Medical institutions are professional but rarely "inclusive" by design. Foreigners should use private facilities like Punta Pacifica for the highest sensitivity.</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Hombres de Blanco / IPDH</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">Panama City, Panama (NGO Health Services)</p>
                <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +507 263-4601</p>
            </div>
        </div>
    `,
	...
	paraguay: {
        ...
        <p>There is no legal mechanism for gender identity recognition. Transgender people cannot update their name or gender marker, leading to high rates of institutional exclusion. Activists describe the 2026 legal landscape as "actively hostile to the existence of trans identities." Voices from the Ground: <a href="https://database.ilga.org/paraguay-lgbti" target="_blank">ILGA World Database</a>.</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Constitución Nacional: Artículo 49</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The constitutional definition of family that excludes same-sex partnerships.</p>
                <a href="https://www.humandignitytrust.org/country-profile/paraguay/" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
            </div>
        </div>
    `,
        ...
        <p>Police protection is minimal; reports of harassment by authorities are common in 2026. No LGBTQ+ individuals hold high government office. Voices from the Ground: <a href="https://www.outrightinternational.org/" target="_blank">Outright International</a>.</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #112</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Spartacus Gay Travel Index 2026 ranking, citing high levels of religious-driven stigma.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Lack of any hate crime or non-discrimination legislation in 2026.</p>
            </div>
        </div>
    `,
        ...
        <p>Significant event: Asunción Pride (September). The 2025 security posture was "Tense," with counter-protesters often outnumbering marchers. Voices from the Ground: <a href="https://www.iglta.org/" target="_blank">IGLTA</a> advises caution and private transport.</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">Public visibility can lead to verbal harassment. Trans travelers should ensure all travel documents match their presentation to avoid detention.</p>
            </div>
        </div>
    `,
        ...
        <p>Emergency protocols are not inclusive. Institutional inclusivity is low. Foreigners should contact their embassy for a list of vetted, sensitive doctors.</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">SOMOSGAY - Centro Comunitario</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">Independencia Nacional 1032, Asunción</p>
                <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +595 21 495 802</p>
            </div>
        </div>
    `,
	...
	peru: {
        ...
        <p>Gender identity laws exist but are judicial; individuals must sue the state to change their gender marker, a process that is costly and lengthy. There is no administrative self-determination law in 2026. Voices from the Ground: <a href="https://database.ilga.org/peru-lgbti" target="_blank">ILGA World Database</a>.</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Decreto Supremo 009-2024-SA</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The decree pathologizing gender diverse identities, currently under international scrutiny.</p>
                <a href="https://www.humandignitytrust.org/country-profile/peru/" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
            </div>
        </div>
    `,
        ...
        <p>Police protection is inconsistent; reports of "moral policing" in rural areas persist in 2026. Very few LGBTQ+ individuals hold government positions. Voices from the Ground: <a href="https://www.outrightinternational.org/" target="_blank">Outright International</a>.</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #88</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Spartacus Gay Travel Index 2026 ranking, citing recent legislative regressions.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Lack of a comprehensive hate crime law explicitly covering gender identity.</p>
            </div>
        </div>
    `,
        ...
        <p>Significant event: Marcha del Orgullo Lima (June 2026). The 2025 security posture was "Alert," with organizers facing bureaucratic hurdles for permits. Voices from the Ground: <a href="https://www.iglta.org/" target="_blank">IGLTA</a> notes Cusco as a growing inclusive destination.</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">Miraflores and Cusco are safe for LGBT visibility; avoid PDA in the northern provinces and jungle regions.</p>
            </div>
        </div>
    `,
        ...
        <p>Emergency protocols are not inclusive. Inclusivity levels are moderate in Lima but low elsewhere. Foreigners should use private clinics like Clínica Delgado.</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Centro de Salud PROMSEX</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">Av. Horacio Urteaga 2031, Jesús María, Lima</p>
                <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +51 1 447 5328</p>
            </div>
        </div>
    `,
	...
	puerto_rico: {
        ...
        <p>Gender identity laws follow a mix of local and federal standards; residents can update their gender marker on birth certificates following a 2018 court ruling. In 2026, the process is administrative and does not require surgery. Voices from the Ground: <a href="https://database.ilga.org/puerto-rico-lgbti" target="_blank">ILGA World Database</a>.</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 U.S. Federal Protections</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Application of U.S. Supreme Court rulings on marriage and non-discrimination across the island.</p>
                <a href="https://www.humandignitytrust.org/country-profile/puerto-rico/" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
            </div>
        </div>
    `,
        ...
        <p>Police protection is proactive, with specific bias-crime training updated in 2025. LGBTQ+ individuals are visible in various municipal levels of government. Voices from the Ground: <a href="https://www.wavesahead.org/" target="_blank">Waves Ahead</a>.</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #24</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Spartacus Gay Travel Index 2026 ranking, aligned with top-tier U.S. states.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Robust local hate crime laws that supplement federal protections.</p>
            </div>
        </div>
    `,
        ...
        <p>Significant event: Puerto Rico Pride (June 2026). The 2025 security posture was "Excellent," with full municipality support. Voices from the Ground: <a href="https://www.iglta.org/" target="_blank">IGLTA</a> notes San Juan as a premier LGBTQ+ Caribbean destination.</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">San Juan is highly visible; rural mountain towns are more conservative but generally safe for travelers.</p>
            </div>
        </div>
    `,
        ...
        <p>Emergency protocols are fully inclusive. Inclusivity levels are high across all medical institutions in San Juan. Foreigners can expect standard U.S. medical care.</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Waves Ahead / SAGE Puerto Rico</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">1252 Ave. Ponce de León, San Juan</p>
                <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +1 787-234-2005</p>
            </div>
        </div>
    `,
	...
	saint_kitts_and_nevis: {
        ...
        <p>There are no current legal processes for gender identity recognition or administrative name-change processes for transgender individuals. Status remains "Data Not Found" for any 2026 legislative drafts regarding gender affirmation. Voices from the Ground: <a href="https://database.ilga.org/saint-kitts-and-nevis-lgbti" target="_blank">ILGA World Database</a>.</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 2022 High Court Ruling (Eastern Caribbean Supreme Court)</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The definitive judicial strike-down of colonial-era laws criminalizing same-sex intimacy.</p>
                <a href="https://www.humandignitytrust.org/country-profile/saint-kitts-and-nevis/" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
            </div>
        </div>
    `,
        ...
        <p>Police protection has improved with 2025 sensitivity training modules, but high-level LGBTQ+ visibility in government remains zero in 2026. Voices from the Ground: <a href="https://www.outrightinternational.org/" target="_blank">Outright International Global Reports</a>.</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #84</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Spartacus Gay Travel Index 2026 ranking, reflecting post-decriminalization improvements.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Absence of state-sanctioned persecution since the 2022 legal pivot.</p>
            </div>
        </div>
    `,
        ...
        <p>A significant event for 2026 is the "SKN Pride Awareness Week" (June 2026), which operates without a parade but with educational workshops. The 2025 security posture for these events was "Monitored but Peaceful." Voices from the Ground: <a href="https://www.iglta.org/" target="_blank">IGLTA Inclusive Guides</a>.</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">Customs are generally professional; public displays of affection are best kept to private or resort environments.</p>
            </div>
        </div>
    `,
        ...
        <p>Emergency protocols are standard; institutions are professionally neutral but not explicitly inclusive. Foreigners should seek private medical advice for gender-specific needs.</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">PANCAP Regional Support</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">Regional Health Network Office</p>
                <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: Data Not Found</p>
            </div>
        </div>
    `,
	...
	saint_lucia: {
        ...
        <p>Gender identity laws do not exist. There is no legal pathway for gender marker correction or administrative name changes. Voices from the Ground: <a href="https://database.ilga.org/saint-lucia-lgbti" target="_blank">ILGA World Database</a>.</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Criminal Code Section 133</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Specifies the crime of "buggery" punishable by up to 10 years imprisonment.</p>
                <a href="https://www.humandignitytrust.org/country-profile/saint-lucia/" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
            </div>
        </div>
    `,
        ...
        <p>Police protection for LGBT individuals is non-existent, and there is zero LGBTQ+ visibility in government. Voices from the Ground: <a href="https://www.outrightinternational.org/" target="_blank">Outright International Advocacy Link</a>.</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #138</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Spartacus Gay Travel Index 2026 ranking, citing active criminalization.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Active use of discriminatory laws in social policing despite rare physical arrests.</p>
            </div>
        </div>
    `,
        ...
        <p>There are no LGBTQ+ events occurring in 2026. The 2025 security posture for any small, private gatherings was "Critical." Voices from the Ground: <a href="https://www.iglta.org/" target="_blank">IGLTA Warning Reports</a>.</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">Public behavior is strictly monitored. Avoid any clothing or symbols that identify LGBTQ+ status.</p>
            </div>
        </div>
    `,
        ...
        <p>Emergency protocols are not inclusive of same-sex partners. Medical institutions maintain a conservative "De Facto" posture that can result in discrimination. </p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Caribbean Vulnerable Communities (CVC)</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">Regional Advocacy & Health Support</p>
                <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: Data Not Found</p>
            </div>
        </div>
    `,
...
<h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Local Advocacy & Legal Support</h4> 
<div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;"> 
<strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">🏛️ Prefecture of Saint Pierre and Miquelon</strong> 
<p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The administrative body ensuring all French anti-discrimination laws are enforced locally.</p> 
...
* **Amber Zones:** None.</p>
<p><strong>The Venue Spectrum:</strong> 
* **Upscale/Protected:** Les P'tits Graviers (Saint Pierre) 
* **The Local Way:** Le Rustique (A local favorite for social mixing)</p>
<div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;"> 
<h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Intel</h4> 
<div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);"> 
<strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Street Awareness Tip</strong> 
...
<h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">On-The-Ground Health Contacts</h4> 
<div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;"> 
<strong style="display: block; font-size: 1.1rem; margin-bottom: 5px; color: #ffffff;">Centre Hospitalier François Dunan</strong> 
...
<h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Local Advocacy & Legal Support</h4> 
<div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;"> 
<strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">🏛️ Safe Haven St. Martin</strong> 
<p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Working across both sides of the island to support LGBTQ+ locals and travelers navigating Caribbean social norms.</p> 
...
* **Amber Zones:** Certain non-tourist residential neighborhoods in Sandy Ground (St. Martin).</p>
<p><strong>The Venue Spectrum:</strong> 
* **Upscale/Protected:** Nikki Beach (St. Barts) 
* **The Local Way:** Roxxy Beach (St. Martin)</p>
<div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;"> 
<h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Intel</h4> 
<div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);"> 
<strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Street Awareness Tip</strong> 
...
<h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">On-The-Ground Health Contacts</h4> 
<div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;"> 
<strong style="display: block; font-size: 1.1rem; margin-bottom: 5px; color: #ffffff;">Hôpital Louis-Constant Fleming</strong> 
...
<p>The "Chic Caribbean" posture in St. Barts and St. Martin balances elite French social liberty with a relaxed island vibe. The 2026 verdict is "Top Tier Inclusion."</p> `,
	...
	saint_vincent_and_the_grenadines: {
        ...
        <p>There are no laws regarding gender identity recognition. Transgender people have no legal avenue to change their gender markers on official documentation as of 2026. Voices from the Ground: <a href="https://database.ilga.org/saint-vincent-and-the-grenadines-lgbti" target="_blank">ILGA World Database</a>.</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Criminal Code Section 146</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Criminalizes consensual same-sex acts with potential imprisonment of up to 10 years.</p>
                <a href="https://www.humandignitytrust.org/country-profile/st-vincent-the-grenadines/" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
            </div>
        </div>
    `,
        ...
        <p>Police protection is often viewed as a threat rather than a resource. There is zero LGBTQ+ visibility in the 2026 government. Voices from the Ground: <a href="https://www.outrightinternational.org/" target="_blank">Outright International</a>.</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #152</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Spartacus Gay Travel Index 2026 ranking, noting legal hostility and social danger.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Ongoing judicial defense of criminalization laws as of early 2026.</p>
            </div>
        </div>
    `,
        ...
        <p>No LGBTQ+ events are scheduled for 2026. The 2025 security posture was "Non-Existent," with no public visibility attempted. Voices from the Ground: <a href="https://www.iglta.org/" target="_blank">IGLTA Regional Travel Intel</a>.</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">Travelers in the outer islands (Grenadines) may find more privacy, but public areas in Kingstown are high-risk for visibility.</p>
            </div>
        </div>
    `,
        ...
        <p>Emergency protocols are binary. medical institutions maintain a "De Facto" conservative stance. Foreigners should seek medical assistance in more inclusive regional hubs if possible.</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Eastern Caribbean Health Outcomes Network</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">Regional Medical Resource Group</p>
                <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: Data Not Found</p>
            </div>
        </div>
    `,
	...
	south_georgia_and_the_south_sandwich_islands: {
        ...
        <p>Gender identity laws follow UK-aligned principles for overseas territories, allowing for gender recognition in theory, though no administrative processes are active due to the lack of permanent residents. Voices from the Ground: <a href="https://www.humandignitytrust.org/" target="_blank">Human Dignity Trust</a>.</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Marriage Ordinance 2014</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The legislative act that established marriage equality in the territory.</p>
                <a href="https://www.gov.gs/" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
            </div>
        </div>
    `,
        ...
        <p>Police protection is managed by territory magistrates and is fully inclusive. No LGBTQ+ individuals hold state office because there are no resident elections. Voices from the Ground: <a href="https://www.outrightinternational.org/" target="_blank">Outright International</a>.</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #1 (By Policy)</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Rated as one of the safest administrative zones for LGBTQ+ travelers globally.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Strict adherence to UK equality standards for all territory operations.</p>
            </div>
        </div>
    `,
        ...
        <p>No LGBTQ+ public events occur due to the absence of a resident population. The 2025 security posture was "Total Safety." Voices from the Ground: <a href="https://www.iglta.org/" target="_blank">IGLTA Polar Guides</a>.</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">Permit-based entry only. Total visibility is safe; the only 'locals' are scientists and government officials.</p>
            </div>
        </div>
    `,
        ...
        <p>Emergency protocols are inclusive of same-sex partners. Medical personnel on expedition ships are the primary care providers for tourists.</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">British Antarctic Survey (Medical Unit)</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">King Edward Point Research Station</p>
                <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: Data Not Found</p>
            </div>
        </div>
    `,
	...
	suriname: {
        ...
        <p>Gender identity laws are restrictive; while a 2022 court ruling allowed one transgender woman to change her gender marker, there is no standardized administrative process for the general population in 2026. Voices from the Ground: <a href="https://database.ilga.org/suriname-lgbti" target="_blank">ILGA World Database</a>.</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Suriname Criminal Code (Decriminalization)</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The historical framework confirming that same-sex intimacy is not a crime since the 19th century.</p>
                <a href="https://www.humandignitytrust.org/country-profile/suriname/" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
            </div>
        </div>
    `,
        ...
        <p>Police protection is professionally neutral, and 2025 saw a minor increase in LGBTQ+ visibility in lower municipal offices. Voices from the Ground: <a href="https://www.outrightinternational.org/" target="_blank">Outright International</a>.</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #68</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Spartacus Gay Travel Index 2026 ranking, reflecting a stable but non-progressive legal environment.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Lack of explicit hate crime legislation as of 2026.</p>
            </div>
        </div>
    `,
        ...
        <p>Significant event: Suriname Pride (October 2026), typically a week of film and art. The 2025 security posture was "Low Risk/Peaceful." Voices from the Ground: <a href="https://www.iglta.org/" target="_blank">IGLTA Suriname Insights</a>.</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">Customs are generally professional; public visibility is safe in the capital but requires discretion in the interior.</p>
            </div>
        </div>
    `,
        ...
        <p>Emergency protocols are binary. Medical institutions in Paramaribo are more inclusive than those in the interior. Foreigners should use private clinics for sensitive care.</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Suriname Men United (SMU)</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">Health & Community Services, Paramaribo</p>
                <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +597 421-414</p>
            </div>
        </div>
    `,
	...
	trinidad_and_tobago: {
        ...
        <p>Gender identity laws do not provide a clear administrative pathway for changing gender markers on official documents. While name changes via deed poll are possible, they do not reflect a change in legal gender status. Voices from the Ground: <a href="https://database.ilga.org/trinidad-and-tobago-lgbti" target="_blank">ILGA World Database - Trinidad and Tobago</a>.</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Jones v. Attorney General (2018)</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The High Court ruling that declared the 'buggery' and 'serious indecency' laws unconstitutional.</p>
                <a href="https://www.humandignitytrust.org/country-profile/trinidad-tobago/" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source: Human Dignity Trust</a>
            </div>
        </div>
    `,
        ...
        <p>Police protection is professionally adequate, but sensitivity training varies. There are no openly LGBTQ+ individuals in the highest levels of the 2026 government. Voices from the Ground: <a href="https://www.outrightinternational.org/" target="_blank">Outright International - Caribbean Regional Report</a>.</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #74</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Spartacus Gay Travel Index 2026 – Improved post-decriminalization but limited by social bias.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Active "Safe Space" certifications for businesses in Port of Spain and Tobago resorts.</p>
            </div>
        </div>
    `,
        ...
        <p>The "Trinidad Pride Arts Festival" (July 2026) is the primary event. The 2025 security posture for Pride was "Moderate Vigilance" with a visible but non-intrusive police presence. Voices from the Ground: <a href="https://www.iglta.org/" target="_blank">IGLTA Guide to Trinidad</a>.</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">Avoid excessive PDA in public squares; stick to "Safe Haven" venues like those in the Woodbrook district.</p>
            </div>
        </div>
    `,
        ...
        <p>Emergency protocols are standard; institutions are professionally inclusive of foreigners, but the inclusion of same-sex partners in medical decision-making can be legally contested if not documented privately.</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">FPATT - Family Planning Association</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">79 Oxford Street, Port of Spain</p>
                <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +1 868-623-5169</p>
            </div>
        </div>
    `,
	...
	united_states_of_america: {
        ...
        <p>Gender identity laws vary wildly. While blue states offer self-identification and gender-neutral X markers, over 20 states have implemented bans on gender-affirming care for minors and restricted name-change processes as of 2026. Voices from the Ground: <a href="https://www.thetrevorproject.org/" target="_blank">The Trevor Project - 2026 Policy Report</a>.</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Respect for Marriage Act (RFMA)</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Federal law mandating the recognition of same-sex and interracial marriages across all states.</p>
                <a href="https://www.congress.gov/" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Federal Registry</a>
            </div>
        </div>
    `,
        ...
        <p>Police protection is generally proactive in coastal cities, but 2025 reports indicate declining trust in community-police relations in the South and Midwest. LGBTQ+ individuals hold thousands of state and local offices in 2026.</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #32</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Spartacus Gay Travel Index 2026 – High for coastal states, significantly lower for the Deep South.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">"Travel Advisories" issued by advocacy groups for specific US states since late 2024.</p>
            </div>
        </div>
    `,
        ...
        <p>Significant Event: WorldPride 2026 / National Coming Out Day marches. The 2025 security posture was "Heightened Awareness" due to protest activity. Voices from the Ground: <a href="https://www.iglta.org/" target="_blank">IGLTA USA Guide</a>.</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">Check the specific laws of the state you are landing in. Coastal states offer high visibility; interior states may require discretion.</p>
            </div>
        </div>
    `,
        ...
        <p>Emergency protocols are generally inclusive, but medical institutional bias remains a reported issue for trans individuals of color. Foreigners should utilize private clinics in major cities.</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Callen-Lorde Community Health Center</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">356 W 18th St, New York, NY</p>
                <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +1 212-271-7200</p>
            </div>
        </div>
    `,
	...
	united_states_virgin_islands: {
        ...
        <p>Gender identity laws follow the federal baseline but lack the progressive self-ID frameworks found in states like California. Changing gender markers on local territory-issued IDs in 2026 requires medical documentation. Voices from the Ground: <a href="https://database.ilga.org/united-states-virgin-islands-lgbti" target="_blank">ILGA World - USVI</a>.</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Territorial Marriage Code (Amended)</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Local adoption of federal marriage standards for same-sex couples.</p>
                <a href="https://www.vi.gov/" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Territorial Portal</a>
            </div>
        </div>
    `,
        ...
        <p>Police protection is adequate, with 2025 sensitivity initiatives for the tourist season. High-level LGBTQ+ visibility in local government is minimal. Voices from the Ground: <a href="https://www.outrightinternational.org/" target="_blank">Outright International - Territory Watch</a>.</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #58</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Spartacus Gay Travel Index 2026 – High for the region, but social bias prevents a higher score.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Safety certifications for USVI "Charter Yacht" operators are a 2026 standard.</p>
            </div>
        </div>
    `,
        ...
        <p>Significant Event: USVI Pride (June 2026). The 2025 security posture was "Peaceful and Celebratory," with no reported incidents. Voices from the Ground: <a href="https://www.iglta.org/" target="_blank">IGLTA - US Virgin Islands Guide</a>.</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">As a US territory, entry requirements follow US federal law. Discretion is recommended when visiting remote residential areas on St. John.</p>
            </div>
        </div>
    `,
        ...
        <p>Emergency protocols are inclusive of same-sex partners under federal mandate. Institutions are professionally friendly to visitors.</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">VI Department of Health</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">1303 Hospital Ground, St. Thomas</p>
                <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +1 340-774-9000</p>
            </div>
        </div>
    `,
	...
	uruguay: {
        ...
        <p>Gender identity laws are based on self-determination. The name and gender marker change process is administrative, rapid, and does not require medical intervention. Voices from the Ground: <a href="https://database.ilga.org/uruguay-lgbti" target="_blank">ILGA World Database - Uruguay</a>.</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Ley Integral para Personas Trans (No. 19.684)</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Comprehensive law ensuring healthcare, employment quotas, and identity rights for trans individuals.</p>
                <a href="https://www.parlamento.gub.uy/" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Legislative Source</a>
            </div>
        </div>
    `,
        ...
        <p>Police protection is highly proactive, and LGBTQ+ individuals are visible at every level of the 2026 government, including parliament and local mayoralties.</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #12</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Spartacus Gay Travel Index 2026 – Consistently the highest-ranking country in South America.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The 1% state employment quota for trans individuals is a global safety benchmark.</p>
            </div>
        </div>
    `,
        ...
        <p>Significant Event: Marcha por la Diversidad (September 2026). The 2025 security posture was "Low Risk/Celebratory," with the event being one of the largest public gatherings in the country. Voices from the Ground: <a href="https://www.iglta.org/" target="_blank">IGLTA - Uruguay Guide</a>.</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">Total visibility is safe. Uruguay is widely considered the safest country in the Americas for trans and non-binary travelers.</p>
            </div>
        </div>
    `,
        ...
        <p>Emergency protocols are fully inclusive of same-sex partners and non-binary identities. Medical institutions operate with a high level of mandatory gender sensitivity.</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Policlínica Trans - IMM</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">Intendencia de Montevideo, Uruguay</p>
                <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +598 1950 3000</p>
            </div>
        </div>
    `,
	...
	venezuela: {
        ...
        <p>Gender identity laws are non-functional; while Article 146 of the Organic Law on Civil Registry theoretically allows for name changes, the 2026 administrative reality is that trans people are routinely denied marker changes. Voices from the Ground: <a href="https://database.ilga.org/venezuela-lgbti" target="_blank">ILGA World Database - Venezuela</a>.</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Organic Law on Civil Registry (Article 146)</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Theoretical provision for name changes that remains stalled in practical application for trans citizens.</p>
                <a href="http://www.cne.gob.ve/" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Registry Site</a>
            </div>
        </div>
    `,
        ...
        <p>Police protection is often non-existent or predatory. There is zero LGBTQ+ visibility in the 2026 state offices, and activists frequently face political persecution.</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #164</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Spartacus Gay Travel Index 2026 – Lowest ranking in South America due to instability and lack of rights.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Frequent arbitrary detentions of LGBTQ+ activists reported throughout 2025.</p>
            </div>
        </div>
    `,
        ...
        <p>There are no public LGBTQ+ events scheduled for 2026. The 2025 security posture for attempted small marches was "Suppressive," with heavy police intervention. Voices from the Ground: <a href="https://www.iglta.org/" target="_blank">IGLTA - Venezuela Warning Intel</a>.</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">Avoid all public displays of affection or clothing with LGBTQ+ symbols. Airport security is highly unpredictable and often hostile.</p>
            </div>
        </div>
    `,
        ...
        <p>Emergency protocols do not recognize same-sex partners. Medical institutions are generally conservative and lack any inclusive training.</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Red Somos</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">NGO for HIV/LGBTQ Rights, Caracas</p>
                <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: Data Not Found</p>
            </div>
        </div>
    `,
