Object.assign(globalData, {
  algeria: {
    ...
    legal: `
            ...
            <p>Gender identity is not legally recognized, and there is no administrative or judicial process for changing name or gender markers on official documents. According to Human Dignity Trust, trans and non-binary individuals are frequently targeted under "public indecency" laws (Article 333), which are used to criminalize gender expression that does not align with biological sex.</p>
            ...
            <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
                ...
                <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                    <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Penal Code Article 338</strong>
                    <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The primary statute criminalizing consensual same-sex relations between adults.</p>
                    <a href="https://database.ilga.org/algeria-lgbti" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">ILGA World Database</a>
                </div>
            </div>
        `,
    ...
    safety: `
            ...
            <p>Police protection is generally not available for LGBTQ+ victims of crime, as coming forward often leads to the victim being investigated under the penal code. There is zero LGBTQ+ visibility in the government or state offices; anyone in these positions remains strictly closeted to maintain their livelihood and safety.</p>
            ...
            <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
                ...
                <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                    ...
                    <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Ranked among the bottom tier in the 2026 Spartacus Gay Travel Index due to criminalization.</p>
                    <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator: Digital Surveillance</strong>
                    <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">State-led monitoring of dating apps and social media for "indecency" violations.</p>
                </div>
            </div>
        `,
    ...
    travel: `
            ...
            <p>Practical advice includes adhering to conservative dress codes and maintaining a "low profile" regarding orientation. Local authorities have the right to inspect digital devices if they suspect "moral crimes." There are no safe haven neighborhoods; the safest approach is to treat the entire country as a "discreet-only" destination.</p>
            ...
            <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
                ...
                <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                    ...
                    <p style="color: #fff; font-size: 0.85rem;">Trans travelers should ensure travel documents match their presentation to avoid detention at Customs. Public PDA is a high-risk legal trigger.</p>
                </div>
            </div>
        `,
    ...
    health: `
            ...
            <p>There are no emergency protocols for LGBTQ+ inclusion in medical institutions. In the event of a medical emergency, it is advised to contact your embassy immediately rather than relying on local social services for advocacy. <a href="https://www.pan-africa-ilga.org/" target="_blank">Voices from the Ground: Pan-Africa ILGA Regional Report</a>.</p>
            ...
            <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
                ...
                <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                    <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Clinique Chahrazed (Private)</strong>
                    <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">Algiers, Algeria (General Private Care)</p>
                    <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: Local Embassies for Vetted Docs</p>
                </div>
            </div>
        `,
  ...
  angola: {
    ...
    legal: `
            ...
            <p>Gender identity laws remain the next frontier for Angolan activists. While there is no streamlined administrative process for gender marker changes as of early 2026, the courts have shown an increasing openness to judicial petitions for name changes. Activists from <strong>Iris Angola</strong> continue to lobby for a dedicated Gender Identity Law similar to those in Southern African neighbors.</p>

            <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
                <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
                <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                    <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 2021 Angolan Penal Code</strong>
                    <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Abolished colonial-era "vices against nature" laws and banned discrimination.</p>
                    <a href="https://www.equaldex.com/region/angola" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Equaldex Legal Timeline</a>
                </div>
            </div>
        `,
    ...
    safety: `
            ...
            <p>There is growing proactivity in police protection, with training programs supported by international NGOs to help officers handle hate-motivated incidents. While there are no openly LGBTQ+ cabinet members yet, the government has consulted with groups like <strong>Arquivos de Identidade Angola (AIA)</strong> on human rights reports in 2025.</p>

            <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
                <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
                <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                    <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #72</strong>
                    <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">One of the highest-ranked Central/Southern African nations in the 2026 Spartacus Index.</p>
                    <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator: Anti-Discrimination Law</strong>
                    <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Full legal protection in employment and housing (Law 10/19).</p>
                </div>
            </div>
        `,
    ...
    travel: `
            ...
            <p>Practical advice: Treat Luanda like any major global city—stay aware of your surroundings, but feel confident in your legal right to exist. Avoid political demonstrations, as police can be heavy-handed regardless of orientation. <a href="https://www.nomadicboys.com" target="_blank">Voices from the Ground: Nomadic Boys Angola Guide</a>.</p>

            <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba-52, 152, 219, 0.1); padding-top: 25px;">
                <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
                <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                    <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                    <p style="color: #fff; font-size: 0.85rem;">No specific entry restrictions for HIV+ travelers. Luanda's "Ilha" is the recommended district for inclusive nightlife.</p>
                </div>
            </div>
        `,
    ...
    health: `
            ...
            <p>Emergency protocols are standard; in Luanda, private medical transport is highly recommended. For community-specific health advocacy, <strong>Iris Angola</strong> provides a directory of "safe" doctors. <a href="https://www.irisangola.org" target="_blank">Voices from the Ground: Iris Angola Health Portal</a>.</p>

            <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
                <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
                <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                    <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Clinica Sagrada Esperança</strong>
                    <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">Avenida Murtala Mohammed, Luanda</p>
                    <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +244 222 330 144</p>
                </div>
            </div>
        `,
  ...
  benin: {
    ...
    legal: `
            ...
            <p>Gender identity laws are non-existent. There is no legal framework for gender reassignment or name changes on official documents. Transgender individuals often face administrative hurdles, though they are not technically criminals under the law. Activists are currently working with the <strong>Beninese Human Rights Commission</strong> to address these gaps.</p>

            <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
                <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
                <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                    <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Benin Penal Code</strong>
                    <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Contains no provisions against same-sex acts, though age of consent is unequal (21 for same-sex, 13 for hetero).</p>
                    <a href="https://database.ilga.org/benin-lgbti" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">ILGA Benin Report</a>
                </div>
            </div>
        `,
    ...
    safety: `
            ...
            <p>Police protection is technically available, but officers are often untrained in LGBTQ+ issues and may exhibit personal bias. Visibility in the highest levels of government is non-existent. However, the government has not followed the path of neighboring Niger or Ghana in pursuing new anti-gay laws in 2026.</p>

            <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
                <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
                <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                    <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #114</strong>
                    <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Mid-tier ranking due to legal status but lack of social protections.</p>
                    <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator: Legal Gap</strong>
                    <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">No laws criminalizing gay sex, but no laws protecting against hate speech.</p>
                </div>
            </div>
        `,
    ...
    travel: `
            ...
            <p>Practical advice: Use international booking sites for accommodation to ensure a higher standard of privacy. Local authorities are generally more interested in security than policing morality, but "indecency" laws can be used if public behavior is deemed provocative. <a href="https://76crimes.com" target="_blank">Voices from the Ground: Erasing 76 Crimes West Africa Report</a>.</p>

            <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(52, 152, 219, 0.1); padding-top: 25px;">
                <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
                <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                    <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                    <p style="color: #fff; font-size: 0.85rem;">Unequal age of consent (21) is a critical legal trap for younger travelers. Discretion is key in rural areas.</p>
                </div>
            </div>
        `,
    ...
    health: `
            ...
            <p>Emergency protocols are standard; Cotonou has the best medical facilities in the country. For community support, <strong>Synergie Bénin</strong> is a key local NGO. <a href="https://www.pan-africa-ilga.org/" target="_blank">Voices from the Ground: Regional Advocacy Report</a>.</p>

            <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
                <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
                <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                    <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Sida Info Benin</strong>
                    <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">Cotonou, Benin (HIV/Sexual Health)</p>
                    <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: Local Search Recommended</p>
                </div>
            </div>
        `,
...
`,
  ...
  botswana: {
    ...
    legal: `
            ...
            <p>Gender identity laws are well-advanced compared to regional peers. Since the 2017 ruling in the Dilokwane case, trans individuals have been able to change their gender markers on official documents. 2025 updates show that the administrative process is becoming more streamlined, with the Department of Civil Registration issuing new guidelines for gender-affirming name changes.</p>

            <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
                <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
                <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                    <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Judgment TC/1225/25</strong>
                    <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Ended bans on same-sex conduct within the police and armed forces, upholding non-discrimination.</p>
                    <a href="https://www.equaldex.com/region/botswana" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Equaldex Botswana Timeline</a>
                </div>
            </div>
        `,
    ...
    safety: `
            ...
            <p>Police protection is proactive, and hate crimes, though rare, are taken seriously by the judicial system. While high-level "out" politicians are few, the judiciary and civil service have become inclusive spaces. In 2025, the government officially recognized June as Pride Month for the first time in several municipal districts.</p>

            <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
                <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
                <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                    <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #51</strong>
                    <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The highest ranked nation in mainland Africa (excluding South Africa) in the 2026 Spartacus Index.</p>
                    <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator: Legal Decriminalization</strong>
                    <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Full constitutional protection upheld by the highest courts (2019/2021/2025).</p>
                </div>
            </div>
        `,
    ...
    travel: `
            ...
            <p>Practical advice: Engage with local organizers at LEGABIBO if you're looking for community events. Botswana's safari industry is highly inclusive, with many lodges being IGLTA members. <a href="https://www.iglta.org" target="_blank">Voices from the Ground: IGLTA Botswana Guide</a>.</p>

            <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(52, 152, 219, 0.1); padding-top: 25px;">
                <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
                <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                    <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                    <p style="color: #fff; font-size: 0.85rem;">Airport security is professional; Trans travelers with updated IDs will face no issues. Safaris are highly inclusive.</p>
                </div>
            </div>
        `,
    ...
    health: `
            ...
            <p>Emergency protocols are top-tier for the region. For specific referrals, the LEGABIBO health desk is the best point of contact. <a href="https://www.legabibo.org" target="_blank">Voices from the Ground: LEGABIBO Health Resources</a>.</p>

            <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
                <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
                <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                    <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Bokamoso Private Hospital</strong>
                    <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">Plot 2133, Gaborone, Botswana</p>
                    <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +267 369 4000</p>
                </div>
            </div>
        `,
  ...
  burkina_faso: {
    ...
    legal: `
            ...
            <p>Gender identity has no legal standing, and the new laws specifically target "promotion of similar practices," which activists fear will be used to persecute trans and non-binary individuals for their gender expression. There is no possibility of name or gender marker changes on official documents in 2026.</p>

            <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
                <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
                <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                    <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 2025 Persons and Family Code</strong>
                    <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The first law in Burkina Faso's history to explicitly criminalize same-sex acts and advocacy.</p>
                    <a href="https://www.hrw.org/news/2025/09/03/burkina-faso-criminalizes-same-sex-conduct" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Human Rights Watch Report</a>
                </div>
            </div>
        `,
    ...
    safety: `
            ...
            <p>Police protection is non-existent for the LGBTQ+ community; in fact, the police are now the primary enforcers of the new criminal code. There is zero visibility in government, and individuals suspected of being gay are being purged from civil service positions as of early 2026.</p>

            <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
                <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
                <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                    <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #185</strong>
                    <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">A drastic drop in the 2026 Spartacus Index following the new criminalization laws.</p>
                    <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator: New Criminal Code</strong>
                    <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">2–5 years imprisonment for consensual acts (passed Sept 2025).</p>
                </div>
            </div>
        `,
    ...
    travel: `
            ...
            <p>Practical advice: If travel is absolutely necessary, sanitize all digital devices and maintain total anonymity regarding orientation. Do not use dating apps. The state has indicated it will monitor "anti-cultural" behavior aggressively throughout 2026. <a href="https://76crimes.com" target="_blank">Voices from the Ground: Erasing 76 Crimes Burkina Faso Update</a>.</p>

            <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(52, 152, 219, 0.1); padding-top: 25px;">
                <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
                <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                    <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                    <p style="color: #fff; font-size: 0.85rem;">High risk of arrest for "promotion." Trans travelers face specific targeting due to recent 2025 legal changes.</p>
                </div>
            </div>
        `,
    ...
    health: `
            ...
            <p>Emergency protocols are non-existent. For any medical issue, immediate consular assistance is required. <a href="https://www.pan-africa-ilga.org/" target="_blank">Voices from the Ground: Pan-Africa ILGA Crisis Report</a>.</p>

            <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
                <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
                <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                    <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Embassy-Vetted Clinics Only</strong>
                    <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">Contact your national embassy for safe medical referrals.</p>
                    <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: Consular Emergency Lines</p>
                </div>
            </div>
        `,
  ...
  burundi: {
    ...
    <p>Gender identity is not legally recognized in Burundi. There are no administrative or judicial procedures available for transgender individuals to change their name or gender marker on official identification. Local advocates from the 'Mouvement pour les Libertés Individuelles' (MOLI) describe the lack of legal gender recognition as a tool for systemic exclusion that forces trans people into high-risk, informal sectors.</p>

    <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
        <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
        <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
            <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Article 567 of the Penal Code</strong>
            <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The statute criminalizing consensual same-sex relations between adults.</p>
            <a href="[https://database.ilga.org/burundi-lgbti](https://database.ilga.org/burundi-lgbti)" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
        </div>
    </div>
`,
    ...
    <p>Police protection is non-existent, as law enforcement is often the primary perpetrator of harassment and arbitrary arrests. There is zero visibility of LGBTQ+ individuals in the government or state offices. <a href="[https://www.pan-africa-ilga.org/](https://www.pan-africa-ilga.org/)" target="_blank">Voices from the Ground: Pan-Africa ILGA Crisis Report</a>.</p>

    <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
        <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
        <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
            <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #182</strong>
            <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Performance in the 2026 Spartacus Gay Travel Index remains at the bottom tier due to state hostility.</p>
            
            <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
            <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">State-sanctioned homophobia and active enforcement of criminal statutes.</p>
        </div>
    </div>
`,
    ...
    <p>PDA is culturally unacceptable for any couple, but for same-sex couples, it constitutes a criminal act. Interaction with local authorities should be avoided whenever possible, as they have the power to inspect digital devices for "immoral" content. <a href="[https://nomadicboys.com/gay-burundi/](https://nomadicboys.com/gay-burundi/)" target="_blank">Voices from the Ground: Nomadic Boys Travel Alert</a>.</p>

    <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
        <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
        <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
            <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
            <p style="color: #fff; font-size: 0.85rem;">Avoid all dating apps as they are monitored. Trans travelers should ensure documents are consistent to avoid detention at Customs.</p>
        </div>
    </div>
`,
    ...
    <p>Emergency protocols do not include inclusivity training. Medical institutions operate under a traditional framework where non-conforming identities are often medicalized or pathologized. <a href="[https://www.alturi.org](https://www.alturi.org)" target="_blank">Voices from the Ground: Alturi Advocacy Insights</a>.</p>

    <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
        <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
        <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
            <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Centre Hospitalo-Universitaire de Kamenge</strong>
            <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">Bujumbura, Burundi (General Medical Only)</p>
            <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +257 22 23 20 11</p>
        </div>
    </div>
`,
...
`,
  ...
  cabo_verde: {
    ...
    <p>Gender identity laws are advanced compared to neighboring states. While a self-identification model is still under discussion in the 2026 legislative session, name and gender changes are possible through judicial and administrative channels. Equaldex identifies Cabo Verde as a "leader in legislative intent" for trans rights in Africa.</p>

    <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
        <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
        <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
            <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Labor Code of Cabo Verde</strong>
            <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Explicitly prohibits discrimination based on sexual orientation (Article 15).</p>
            <a href="[https://database.ilga.org/cabo-verde-lgbti](https://database.ilga.org/cabo-verde-lgbti)" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
        </div>
    </div>
`,
    ...
    <p>Police protection is professional and inclusive. There is increasing visibility of LGBTQ+ individuals in the civil service and cultural sectors. 2026 has seen no reported incidents of state-led harassment, making it a safe haven in a often-restrictive region.</p>

    <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
        <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
        <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
            <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #48</strong>
            <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Ranked consistently high in the 2026 Spartacus Index for African nations.</p>
            
            <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
            <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Strong constitutional protections and active civil society.</p>
        </div>
    </div>
`,
    ...
    <p>Practical advice: Mindelo is the cultural heart of the LGBTQ+ community. Most major resorts are inclusive and IGLTA-vetted. Authorities are friendly toward tourists of all orientations. <a href="[https://www.misterbandb.com/gay-blog/cabo-verde](https://www.misterbandb.com/gay-blog/cabo-verde)" target="_blank">Voices from the Ground: Misterb&b Cabo Verde Guide</a>.</p>

    <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
        <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
        <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
            <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
            <p style="color: #fff; font-size: 0.85rem;">LGBTQ+ travelers are welcomed openly. Mindelo is the recommended hub for social visibility and inclusion.</p>
        </div>
    </div>
`,
    ...
    <p>Emergency protocols are robust and inclusive. Medical institutions follow international human rights standards. <a href="[https://www.alturi.org/cabo-verde](https://www.alturi.org/cabo-verde)" target="_blank">Voices from the Ground: Alturi Health & Advocacy</a>.</p>

    <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
        <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
        <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
            <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Hospital Agostinho Neto</strong>
            <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">Praia, Santiago, Cabo Verde</p>
            <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +238 261 24 62</p>
        </div>
    </div>
`,
...
`,
  ...
  cameroon: {
    ...
    <p>Gender identity is not legally recognized. There is no pathway for name or gender marker changes on official documents. Transgender and non-binary individuals are frequently targeted under Article 347-1 as well as "public indecency" laws. Local activists from 'Alternatives-Cameroun' describe the legal climate as a "constant state of peril" for those who do not conform to binary norms.</p>

    <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
        <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
        <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
            <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Article 347-1 of the Penal Code</strong>
            <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The statute criminalizing same-sex sexual relations.</p>
            <a href="[https://www.humandignitytrust.org/country-profile/cameroon/](https://www.humandignitytrust.org/country-profile/cameroon/)" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
        </div>
    </div>
`,
    ...
    <p>Police protection is absent; authorities are more likely to arrest the victim than the perpetrator in cases of hate crimes. There is zero visibility of LGBTQ+ individuals in government. <a href="[https://www.washingtonblade.com](https://www.washingtonblade.com)" target="_blank">Voices from the Ground: Washington Blade Cameroon Coverage</a>.</p>

    <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
        <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
        <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
            <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #189</strong>
            <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Ranking in the 2026 Spartacus Index remains critical due to active enforcement of criminal laws.</p>
            
            <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
            <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Active state-led persecution and high rates of arbitrary detention.</p>
        </div>
    </div>
`,
    ...
    <p>Practical advice: Avoid all dating apps. Ensure digital devices do not contain evidence of LGBT identity. Interaction with police should be minimized, as any suspicion of "homosexuality" can lead to extortion or arrest. <a href="[https://nomadicboys.com/gay-cameroon/](https://nomadicboys.com/gay-cameroon/)" target="_blank">Voices from the Ground: Nomadic Boys Travel Alert</a>.</p>

    <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
        <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
        <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
            <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
            <p style="color: #fff; font-size: 0.85rem;">High risk of arrest. Trans travelers are specifically targeted at border control.</p>
        </div>
    </div>
`,
    ...
    <p>Emergency protocols do not exist for LGBTQ+ individuals. Medical institutions often collaborate with police in "morality" cases. <a href="[https://www.alturi.org/cameroon](https://www.alturi.org/cameroon)" target="_blank">Voices from the Ground: Alturi Advocacy Insights</a>.</p>

    <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
        <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
        <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
            <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Hôpital Général de Douala</strong>
            <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">Douala, Cameroon (General Private Only)</p>
            <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +237 233 37 01 41</p>
        </div>
    </div>
`,
...
`,
  ...
  central_african_republic: {
    ...
    <p>Gender identity is not legally recognized. There are no processes for name or gender changes on official identity documents. Transgender and non-binary individuals are particularly vulnerable to being targeted under "public indecency" laws or facing extrajudicial violence in the current security climate.</p>

    <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
        <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
        <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
            <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Article 110 of the Penal Code</strong>
            <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The "Public Indecency" statute often used against same-sex couples.</p>
            <a href="[https://database.ilga.org/central-african-republic-lgbti](https://database.ilga.org/central-african-republic-lgbti)" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
        </div>
    </div>
`,
    ...
    <p>Police protection is effectively non-existent. Authorities are more focused on civil war security, and where they do interact with the LGBTQ+ community, they are often perpetrators of extortion. Visibility is zero at all levels of government. <a href="[https://www.pan-africa-ilga.org/](https://www.pan-africa-ilga.org/)" target="_blank">Voices from the Ground: Regional Advocacy Report</a>.</p>

    <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 20px solid rgba(255,255,255,0.1); padding-top: 25px;">
        <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
        <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
            <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #165</strong>
            <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Ranking in the 2026 Spartacus Index is low due to extreme security instability and lack of protections.</p>
            
            <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
            <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Rule of law is limited; "Public Indecency" laws allow for arbitrary enforcement.</p>
        </div>
    </div>
`,
    ...
    <p>Practical advice: Avoid travel outside of Bangui. Use only vetted international security and transport. Do not use dating apps. <a href="[https://www.alturi.org](https://www.alturi.org)" target="_blank">Voices from the Ground: Alturi Global Context</a>.</p>

    <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
        <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
        <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
            <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
            <p style="color: #fff; font-size: 0.85rem;">High risk of extortion at checkpoints. Discretion must be absolute. Travel not advised.</p>
        </div>
    </div>
`,
    ...
    <p>Emergency protocols are dictated by conflict conditions, not inclusivity. <a href="[https://www.pan-africa-ilga.org/](https://www.pan-africa-ilga.org/)" target="_blank">Voices from the Ground: Pan-Africa ILGA Health Report</a>.</p>

    <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
        <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
        <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
            <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Hôpital Communautaire de Bangui</strong>
            <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">Bangui, CAR (General Emergency Only)</p>
            <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: Consular Assistance Advised</p>
        </div>
    </div>
`,
...
`,
  ...
  chad: {
    ...
    <p>Gender identity is not legally recognized in Chad. There are no provisions for name or gender changes on any official documents. Transgender and non-binary individuals are frequently targeted under criminal statutes as well as "public indecency" or "morality" laws, leading to a high rate of harassment and arbitrary detention.</p>

    <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
        <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
        <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
            <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Article 354 bis of the Penal Code</strong>
            <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The statute criminalizing same-sex sexual relations.</p>
            <a href="[https://www.humandignitytrust.org/country-profile/chad/](https://www.humandignitytrust.org/country-profile/chad/)" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
        </div>
    </div>
`,
    ...
    <p>Police protection is non-existent; authorities are more likely to arrest individuals suspected of being LGBTQ+ than protect them. There is zero visibility in government. <a href="[https://www.washingtonblade.com](https://www.washingtonblade.com)" target="_blank">Voices from the Ground: Washington Blade Africa Coverage</a>.</p>

    <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
        <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
        <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
            <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #192</strong>
            <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Consistently ranked at the bottom of the 2026 Spartacus Index due to active criminalization and state-led hostility.</p>
            
            <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
            <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Active enforcement of Article 354 bis and high rates of arbitrary detention.</p>
        </div>
    </div>
`,
    ...
    <p>Practical advice: Avoid all dating apps. Ensure no LGBTQ+ related content is on digital devices. Interaction with police should be strictly avoided. <a href="[https://76crimes.com](https://76crimes.com)" target="_blank">Voices from the Ground: Erasing 76 Crimes Chad Report</a>.</p>

    <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
        <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
        <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
            <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
            <p style="color: #fff; font-size: 0.85rem;">Very high risk of arrest. Trans travelers face severe persecution at border points. Travel not advised.</p>
        </div>
    </div>
`,
    ...
    <p>Emergency protocols do not exist for the community. Medical institutions often work with police in morality cases. <a href="[https://www.pan-africa-ilga.org/](https://www.pan-africa-ilga.org/)" target="_blank">Voices from the Ground: Regional Advocacy Report</a>.</p>

    <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
        <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
        <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
            <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Hôpital de la Renaissance</strong>
            <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">N'Djamena, Chad (General Emergency Only)</p>
            <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: Consular Assistance Advised</p>
        </div>
    </div>
`,
...
`,
  ...
  comoros: {
    ...
    <p>Gender identity is not legally recognized in the Comoros. There are no administrative or judicial procedures for transgender individuals to change their name or gender marker on official documents. According to Human Dignity Trust, individuals who do not conform to traditional gender norms are at risk of being targeted under "public indecency" laws.</p>

    <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
        <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
        <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
            <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Article 318 of the Penal Code</strong>
            <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The statute criminalizing consensual acts "against nature" between individuals of the same sex.</p>
            <a href="[https://database.ilga.org/comoros-lgbti](https://database.ilga.org/comoros-lgbti)" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
        </div>
    </div>
`,
    ...
    <p>Police protection is generally non-existent for LGBTQ+ individuals, as reporting a hate crime could lead to the victim being investigated under Article 318. Visibility in state offices or the highest levels of government is non-existent in 2026. <a href="[https://www.pan-africa-ilga.org/](https://www.pan-africa-ilga.org/)" target="_blank">Voices from the Ground: Pan-Africa ILGA Regional Report</a>.</p>

    <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
        <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
        <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
            <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #178</strong>
            <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Ranking in the 2026 Spartacus Index reflects high risk due to criminalization and lack of protection.</p>
            
            <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
            <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Strict adherence to conservative social codes and active criminal statutes.</p>
        </div>
    </div>
`,
    ...
    <p>Practical advice: Avoid all public displays of affection (PDA) and keep a low profile on social media while in the country. Interactions with local authorities should be kept formal. <a href="[https://nomadicboys.com/lgbt-travel-safety/](https://nomadicboys.com/lgbt-travel-safety/)" target="_blank">Voices from the Ground: Nomadic Boys Travel Safety Advisory</a>.</p>

    <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
        <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
        <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
            <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
            <p style="color: #fff; font-size: 0.85rem;">Avoid all public LGBT signaling. Trans travelers should ensure documents are as consistent as possible to avoid detention.</p>
        </div>
    </div>
`,
    ...
    <p>Emergency protocols do not include LGBTQ-specific protections. Medical institutions operate under the same legal and social constraints as the rest of the country. <a href="[https://www.alturi.org](https://www.alturi.org)" target="_blank">Voices from the Ground: Alturi Global NGO Resource</a>.</p>

    <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
        <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
        <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
            <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Hôpital El-Maarouf</strong>
            <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">Moroni, Grande Comore</p>
            <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +269 773 26 04</p>
        </div>
    </div>
`,
...
`,
  ...
  democratic_republic_of_the_congo: {
    ...
    <p>Gender identity is not legally recognized in the DRC. There is no established legal or administrative mechanism for transgender individuals to change their gender marker on official documents. Local advocates from 'COFEPRADE' describe the situation for trans individuals as one of systemic invisibility and frequent police harassment based on appearance.</p>

    <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
        <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
        <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
            <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Article 176 of the Penal Code</strong>
            <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The "Public Indecency" law often used for arbitrary detention of LGBTQ+ persons.</p>
            <a href="[https://database.ilga.org/democratic-republic-congo-lgbti](https://database.ilga.org/democratic-republic-congo-lgbti)" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
        </div>
    </div>
`,
    ...
    <p>Police protection is virtually non-existent; authorities are frequently the ones initiating harassment or extortion. There is no visibility of LGBTQ+ individuals in the highest levels of government. <a href="[https://www.pan-africa-ilga.org/](https://www.pan-africa-ilga.org/)" target="_blank">Voices from the Ground: ASEAN SOGIE Caucus Regional Context</a>.</p>

    <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
        <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
        <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
            <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #158</strong>
            <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Performance in the 2026 Spartacus Index remains poor due to arbitrary law enforcement and social violence.</p>
            
            <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
            <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">High rates of extortion by law enforcement using "morality" as a pretext.</p>
        </div>
    </div>
`,
    ...
    <p>Practical advice: PDA is extremely dangerous and could lead to arrest under "indecency" laws. Interaction with local authorities should be minimal. <a href="[https://nomadicboys.com/lgbt-travel-safety/](https://nomadicboys.com/lgbt-travel-safety/)" target="_blank">Voices from the Ground: Nomadic Boys Travel Safety Alert</a>.</p>

    <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
        <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
        <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
            <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
            <p style="color: #fff; font-size: 0.85rem;">Avoid all dating apps and public LGBT signaling. Extortion is the primary risk for foreign travelers.</p>
        </div>
    </div>
`,
    ...
    <p>Emergency protocols do not include inclusivity standards. Medical institutions operate within a framework that often mirrors the social stigma of the general population. <a href="[https://www.alturi.org](https://www.alturi.org)" target="_blank">Voices from the Ground: Alturi DRC Advocacy Update</a>.</p>

    <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
        <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
        <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
            <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Centre Médical de Kinshasa (CMK)</strong>
            <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">168 Avenue Wagenia, Kinshasa</p>
            <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +243 898 950 305</p>
        </div>
    </div>
`,
...
`,
  ...
  republic_of_the_congo: {
    ...
    <p>Legal gender recognition is not available in the Republic of the Congo. There are no processes for transgender individuals to change their name or gender marker on identification cards. Local advocates describe the situation as one of "benign neglect," where the lack of criminalization does not translate into active civil rights or legal existence for trans citizens.</p>

    <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
        <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
        <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
            <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Constitution of the Republic of the Congo</strong>
            <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">While it guarantees equality, it lacks explicit protection for LGBTQ+ citizens.</p>
            <a href="[https://database.ilga.org/republic-congo-lgbti](https://database.ilga.org/republic-congo-lgbti)" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
        </div>
    </div>
`,
    ...
    <p>Police protection is theoretically available, but many LGBTQ+ individuals fear that reporting crimes will lead to secondary victimization. There is zero visibility of LGBTQ+ individuals in the highest levels of government as of 2026. <a href="[https://www.pan-africa-ilga.org/](https://www.pan-africa-ilga.org/)" target="_blank">Voices from the Ground: Pan-Africa ILGA Context</a>.</p>

    <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
        <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
        <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
            <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #132</strong>
            <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Performance in the 2026 Spartacus Index is moderate for the region due to the lack of criminalization.</p>
            
            <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
            <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Lack of explicit criminal laws is balanced by a complete lack of protective civil rights.</p>
        </div>
    </div>
`,
    ...
    <p>Practical advice: Discretion is the key to safety. While the law is on your side regarding your right to exist, social norms are not. Authorities are generally neutral but should not be tested with public LGBT signaling. <a href="[https://nomadicboys.com/lgbt-travel-safety/](https://nomadicboys.com/lgbt-travel-safety/)" target="_blank">Voices from the Ground: Nomadic Boys Travel Advice</a>.</p>

    <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
        <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
        <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
            <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
            <p style="color: #fff; font-size: 0.85rem;">Technically legal but socially sensitive. Maintain discretion to avoid unwanted attention.</p>
        </div>
    </div>
`,
    ...
    <p>Emergency protocols are standard and do not include specific inclusivity training. Medical institutions operate under traditional social frameworks. <a href="[https://www.alturi.org](https://www.alturi.org)" target="_blank">Voices from the Ground: Alturi Regional Advocacy</a>.</p>

    <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
        <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
        <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
            <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Hôpital Central de l’Armée (Général Leclerc)</strong>
            <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">Brazzaville, Republic of the Congo</p>
            <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +242 222 81 04 22</p>
        </div>
    </div>
`,
...
`,
  ...
  djibouti: {
    ...
    <p>Gender identity is not legally recognized. There is no administrative or judicial pathway for transgender individuals to change their gender marker on official documents. According to Human Dignity Trust, the lack of legal recognition combined with conservative social values makes transgender individuals particularly vulnerable to state scrutiny.</p>

    <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
        <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
        <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
            <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Djibouti Penal Code</strong>
            <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Lacks explicit sodomy laws but contains "public indecency" statutes.</p>
            <a href="[https://database.ilga.org/djibouti-lgbti](https://database.ilga.org/djibouti-lgbti)" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
        </div>
    </div>
`,
    ...
    <p>Police protection is generally not sought by the community due to fear of secondary harassment or being targeted under "morality" codes. There is no visibility of LGBTQ+ individuals in the government or state offices in 2026. <a href="[https://www.pan-africa-ilga.org/](https://www.pan-africa-ilga.org/)" target="_blank">Voices from the Ground: Pan-Africa ILGA Regional Overview</a>.</p>

    <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
        <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
        <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
            <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #145</strong>
            <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Ranking in the 2026 Spartacus Index reflects the lack of criminalization but high social risk.</p>
            
            <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
            <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Strong religious influence and broad "public morality" legal interpretations.</p>
        </div>
    </div>
`,
    ...
    <p>Practical advice: Maintain total discretion. Avoid all dating apps while in the country as they can be monitored. <a href="[https://nomadicboys.com/lgbt-travel-safety/](https://nomadicboys.com/lgbt-travel-safety/)" target="_blank">Voices from the Ground: Nomadic Boys Global Safety Tips</a>.</p>

    <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
        <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
        <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
            <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
            <p style="color: #fff; font-size: 0.85rem;">Avoid all public LGBT signaling. Trans travelers should ensure documents are consistent with their presentation.</p>
        </div>
    </div>
`,
    ...
    <p>Emergency protocols do not include inclusivity standards. Medical care is delivered within a framework of traditional social values. <a href="[https://www.alturi.org](https://www.alturi.org)" target="_blank">Voices from the Ground: Alturi Advocacy Link</a>.</p>

    <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
        <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
        <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
            <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Hôpital de Peltier</strong>
            <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">Djibouti City, Djibouti</p>
            <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +253 21 35 27 12</p>
        </div>
    </div>
`,
...
`,
  ...
  egypt: {
    ...
    <p>Gender identity is not legally recognized, and the process for transitioning is restricted to medical "intersex" cases under strict state medical committee oversight. For the vast majority of transgender individuals, there is no pathway to change legal documents. Local activists describe the state's approach as a "war of attrition" against gender non-conforming bodies.</p>

    <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
        <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
        <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
            <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Law No. 10 of 1961 (Anti-Prostitution Law)</strong>
            <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The "Debauchery" statute used for the mass arrest of LGBTQ+ people.</p>
            <a href="[https://database.ilga.org/egypt-lgbti](https://database.ilga.org/egypt-lgbti)" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
        </div>
    </div>
`,
    ...
    <p>Police protection is a threat rather than a resource. Law enforcement officers frequently use dating apps to lure LGBTQ+ individuals into arrests. Visibility of LGBTQ+ individuals in the government is non-existent. <a href="[https://www.washingtonblade.com](https://www.washingtonblade.com)" target="_blank">Voices from the Ground: Washington Blade Middle East & Africa Report</a>.</p>

    <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
        <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
        <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
            <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #185</strong>
            <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Ranked at the bottom of the 2026 Spartacus Index due to systematic state-led entrapment and arrest.</p>
            
            <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
            <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">High frequency of digital entrapment and state-sanctioned torture/forced examinations.</p>
        </div>
    </div>
`,
    ...
    <p>Practical advice: Delete all dating apps before arriving in Egypt. Avoid any rainbow signaling. If stopped by police, maintain a formal, non-confrontational demeanor. <a href="[https://nomadicboys.com/gay-egypt-travel-safety/](https://nomadicboys.com/gay-egypt-travel-safety/)" target="_blank">Voices from the Ground: Nomadic Boys Egypt Safety Guide</a>.</p>

    <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
        <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
        <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
            <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
            <p style="color: #fff; font-size: 0.85rem;">Digital surveillance is constant. Avoid all public LGBT signaling. Trans travelers are at extreme risk of detention.</p>
        </div>
    </div>
`,
    ...
    <p>Emergency protocols do not exist for the community. Medical staff may collaborate with police. <a href="[https://www.alturi.org](https://www.alturi.org)" target="_blank">Voices from the Ground: Alturi Egypt Resource Link</a>.</p>

    <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
        <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
        <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
            <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">As-Salam International Hospital</strong>
            <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">Corniche El Nile, Maadi, Cairo</p>
            <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +20 2 2524 0250</p>
        </div>
    </div>
`,
...
`,
  ...
  equatorial_guinea: {
    ...
    legal: `
            ...
            <p>Legal gender recognition is unavailable. There are no administrative or judicial processes for transgender individuals to update their name or gender marker on official identification. Local advocates describe a landscape of "legal invisibility" where trans individuals are often subjected to arbitrary "public scandal" charges. <br>Voices from the Ground: <a href="https://www.pan-africa-ilga.org/" target="_blank">Pan-Africa ILGA Regional Report</a></p>

            <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
                <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
                <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                    <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Fundamental Law of Equatorial Guinea</strong>
                    <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The constitution guarantees general equality but lacks specific LGBTQ+ protections or recognition.</p>
                    <a href="https://database.ilga.org/equatorial-guinea-lgbti" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
                </div>
            </div>
        `,
    ...
    safety: `
            ...
            <p>Police protection for the community is non-existent. Authorities are more likely to enforce "public morality" than to protect LGBTQ+ victims of crime. There is no visibility of LGBTQ+ individuals in high-level government or state offices. <br>Voices from the Ground: <a href="https://www.humandignitytrust.org/country-profile/equatorial-guinea/" target="_blank">Human Dignity Trust Safety Brief</a></p>

            <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
                <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
                <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                    <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #152</strong>
                    <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Performance in the 2026 Spartacus Index remains low due to lack of civil rights and high social stigma.</p>
                    
                    <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                    <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">"Public Scandal" statutes are frequently used to justify arbitrary arrests of gender non-conforming individuals.</p>
                </div>
            </div>
        `,
    ...
    travel: `
            ...
            <p>Practical advice: Avoid any PDA and maintain a very conservative dress code. Interactions with local authorities should be kept to a minimum, as any suspicion of "immorality" can lead to deportation. <br>Voices from the Ground: <a href="https://nomadicboys.com/lgbt-travel-safety/" target="_blank">Nomadic Boys Travel Security Note</a></p>

            <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
                <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
                <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                    <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                    <p style="color: #fff; font-size: 0.85rem;">Strict binary gender expectations. Trans travelers should ensure all IDs match their current presentation to avoid detention.</p>
                </div>
            </div>
        `,
    ...
    health: `
            ...
            <p>Emergency protocols do not include inclusivity standards. Medical institutions are highly conservative. <br>Voices from the Ground: <a href="https://www.alturi.org" target="_blank">Alturi Advocacy and Health Map</a></p>

            <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
                <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
                <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                    <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Centro Médico La Paz</strong>
                    <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">Malabo, Equatorial Guinea</p>
                    <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +240 333 091 144</p>
                </div>
            </div>
        `,
  ...
  eritrea: {
    ...
    legal: `
            ...
            <p>Legal gender identity recognition is non-existent. There is no mechanism to change name or gender markers, and gender non-conformity is often treated as a security threat or a violation of "public order." Local advocates, largely operating in exile, describe the situation as a total erasure of LGBT existence. <br>Voices from the Ground: <a href="https://www.humandignitytrust.org/country-profile/eritrea/" target="_blank">Human Dignity Trust Legal Summary</a></p>

            <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
                <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
                <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                    <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Eritrean Penal Code Article 411</strong>
                    <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Criminalizes "unnatural offenses" with potential prison terms of up to 7 years.</p>
                    <a href="https://database.ilga.org/eritrea-lgbti" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
                </div>
            </div>
        `,
    ...
    safety: `
            ...
            <p>Police and the military are active agents of persecution. There is zero visibility of LGBTQ+ individuals in the government. Being outed in Eritrea can lead to disappearances, indefinite detention, or torture in the country's extensive prison system. <br>Voices from the Ground: <a href="https://www.pan-africa-ilga.org/" target="_blank">Pan-Africa ILGA Security Update</a></p>

            <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
                <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
                <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                    <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #198</strong>
                    <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Ranked at the extreme bottom of the 2026 Spartacus Index due to criminalization and lack of human rights.</p>
                    
                    <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                    <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">State surveillance of digital communication is used to identify and arrest LGBTQ+ individuals.</p>
                </div>
            </div>
        `,
    ...
    travel: `
            ...
            <p>Practical advice: Avoid travel to Eritrea. If travel is mandatory, maintain total invisibility. Do not bring any LGBTQ+ literature or materials. Digital devices may be searched upon entry or exit. <br>Voices from the Ground: <a href="https://nomadicboys.com/lgbt-travel-safety/" target="_blank">Nomadic Boys Warning</a></p>

            <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
                <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
                <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                    <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                    <p style="color: #fff; font-size: 0.85rem;">High risk of imprisonment. Total absence of LGBTQ+ infrastructure or support.</p>
                </div>
            </div>
        `,
    ...
    health: `
            ...
            <p>Emergency protocols are primitive and not inclusive. Inclusivity levels are zero. <br>Voices from the Ground: <a href="https://www.alturi.org" target="_blank">Alturi Eritrea Advocacy Link</a></p>

            <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
                <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
                <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                    <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Sembel Hospital</strong>
                    <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">Asmara, Eritrea</p>
                    <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +291 1 150 175</p>
                </div>
            </div>
        `,
  ...
  eswatini: {
    ...
    legal: `
            ...
            <p>Gender identity is not legally recognized in Eswatini. There are no administrative pathways for transgender individuals to change their legal name or gender on documents. Local activists describe the situation as "persistent legal limbo," where the state refuses to recognize the existence of trans and non-binary citizens. <br>Voices from the Ground: <a href="https://www.rockofhopeswaziland.org.sz/" target="_blank">The Rock of Hope Eswatini</a></p>

            <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
                <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
                <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                    <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Eswatini Common Law (Sodomy)</strong>
                    <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Male-to-male intimacy remains a common law offense, though rarely prosecuted in the capital.</p>
                    <a href="https://database.ilga.org/eswatini-lgbti" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
                </div>
            </div>
        `,
    ...
    safety: `
            ...
            <p>Police protection is inconsistent; while the police generally do not hunt LGBTQ+ people, they also do not proactively protect them from social violence. There is zero visibility of LGBTQ+ individuals in the highest levels of government. <br>Voices from the Ground: <a href="https://www.pan-africa-ilga.org/" target="_blank">Pan-Africa ILGA Eswatini Update</a></p>

            <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
                <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
                <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                    <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #148</strong>
                    <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Ranking in the 2026 Spartacus Index is hampered by the sodomy law and lack of family recognition.</p>
                    
                    <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                    <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Freedom of assembly for LGBTQ+ groups is occasionally restricted by the state.</p>
                </div>
            </div>
        `,
    ...
    travel: `
            ...
            <p>Practical advice: PDA is culturally inappropriate for all couples in Eswatini, but for same-sex couples, it can lead to police intervention. Discretion is the best safety tool. <br>Voices from the Ground: <a href="https://nomadicboys.com/lgbt-travel-safety/" target="_blank">Nomadic Boys Travel Advice</a></p>

            <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
                <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
                <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                    <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                    <p style="color: #fff; font-size: 0.85rem;">Technically criminalized (males). Maintain absolute discretion in public and on social apps.</p>
                </div>
            </div>
        `,
    ...
    health: `
            ...
            <p>Emergency protocols do not explicitly include inclusivity. Inclusivity levels are generally low. <br>Voices from the Ground: <a href="https://www.alturi.org" target="_blank">Alturi Eswatini Health Resources</a></p>

            <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
                <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
                <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                    <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">The Rock of Hope Wellness Center</strong>
                    <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">Mbabane, Eswatini (Confidential Location)</p>
                    <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +268 7602 4683</p>
                </div>
            </div>
        `,
  ...
  ethiopia: {
    ...
    legal: `
            ...
            <p>Gender identity is not legally recognized in Ethiopia. There is no legal framework for transgender individuals to change their gender markers or names. According to Human Dignity Trust, gender non-conformity is often targeted under "public morality" and "indecency" laws, leading to arbitrary arrests. <br>Voices from the Ground: <a href="https://www.humandignitytrust.org/country-profile/ethiopia/" target="_blank">Human Dignity Trust Legal Summary</a></p>

            <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
                <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
                <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                    <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Ethiopian Penal Code Article 629</strong>
                    <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Criminalizes "homosexual and other indecent acts" with severe prison sentences.</p>
                    <a href="https://database.ilga.org/ethiopia-lgbti" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
                </div>
            </div>
        `,
    ...
    safety: `
            ...
            <p>Police protection is a threat; reporting a crime as an LGBTQ+ person often leads to the victim being arrested for "debauchery." There is zero visibility of LGBTQ+ individuals in the government. <br>Voices from the Ground: <a href="https://www.pan-africa-ilga.org/" target="_blank">Pan-Africa ILGA Regional Safety Alert</a></p>

            <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
                <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
                <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                    <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #192</strong>
                    <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Ranked among the most dangerous countries globally in the 2026 Spartacus Index.</p>
                    
                    <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                    <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Extreme social hostility and frequent state-led anti-LGBTQ+ rhetoric.</p>
                </div>
            </div>
        `,
    ...
    travel: `
            ...
            <p>Practical advice: Delete all LGBTQ+ related apps and content from your phone before arrival. Avoid all PDA. Do not discuss LGBTQ+ topics with locals, as this can be reported to the authorities. <br>Voices from the Ground: <a href="https://nomadicboys.com/lgbt-travel-safety/" target="_blank">Nomadic Boys Warning</a></p>

            <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
                <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
                <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                    <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                    <p style="color: #fff; font-size: 0.85rem;">High risk of arrest and deportation. Zero tolerance for LGBT visibility or signaling.</p>
                </div>
            </div>
        `,
    ...
    health: `
            ...
            <p>Emergency protocols are not inclusive. Inclusivity levels are zero. <br>Voices from the Ground: <a href="https://www.alturi.org" target="_blank">Alturi Ethiopia Advocacy Map</a></p>

            <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
                <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
                <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                    <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Hayat Hospital</strong>
                    <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">Bole, Addis Ababa, Ethiopia</p>
                    <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +251 11 661 0485</p>
                </div>
            </div>
        `,
  ...
  gabon: {
    ...
    legal: `
            ...
            <p>Gender identity is not legally recognized in Gabon. There are no laws or administrative procedures for transgender individuals to change their gender marker on official identification. Local advocates describe the situation as one of "passive existence," where the community is not prosecuted but lacks any legal status or recognition. <br>Voices from the Ground: <a href="https://www.pan-africa-ilga.org/" target="_blank">Pan-Africa ILGA Gabon Update</a></p>

            <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
                <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
                <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                    <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Law on the Decriminalization of Homosexuality (2020)</strong>
                    <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The landmark legislation that removed same-sex activity from the penal code.</p>
                    <a href="https://database.ilga.org/gabon-lgbti" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
                </div>
            </div>
        `,
    ...
    safety: `
            ...
            <p>Police protection is technically available, but LGBTQ+ individuals often avoid reporting crimes due to fear of harassment. There is zero visibility of LGBTQ+ individuals in high-level government positions. <br>Voices from the Ground: <a href="https://www.humandignitytrust.org/country-profile/gabon/" target="_blank">Human Dignity Trust Gabon Context</a></p>

            <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
                <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
                <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                    <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #128</strong>
                    <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Improved ranking in the 2026 Spartacus Index due to its decriminalized status.</p>
                    
                    <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                    <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Decriminalized status provides a safety baseline not found in most neighboring countries.</p>
                </div>
            </div>
        `,
    ...
    travel: `
            ...
            <p>Practical advice: Maintain discretion regarding your identity in public. PDA is not recommended. While the law is on your side, social attitudes are not. <br>Voices from the Ground: <a href="https://nomadicboys.com/lgbt-travel-safety/" target="_blank">Nomadic Boys Travel Tips</a></p>

            <div class="travel-resource-grid" style="margin-top: 40px; border-top: 20px solid rgba(255,255,255,0.1); padding-top: 25px;">
                <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
                <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                    <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                    <p style="color: #fff; font-size: 0.85rem;">Legal status is a positive sign, but maintain social discretion to avoid conflict with conservative locals.</p>
                </div>
            </div>
        `,
    ...
    health: `
            ...
            <p>Emergency protocols are standard and not inclusive. Inclusivity levels are moderate but improving in private facilities. <br>Voices from the Ground: <a href="https://www.alturi.org" target="_blank">Alturi Advocacy Gabon Link</a></p>

            <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
                <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
                <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                    <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Hôpital d'Instruction des Armées Omar Bongo Ondimba</strong>
                    <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">Libreville, Gabon</p>
                    <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +241 01 79 00 00</p>
                </div>
            </div>
        `,
  ...
  gambia: {
    ...
    legal: `
            ...
            <p>Gender identity recognition is not available. There are no legal mechanisms for transgender individuals to change their name or gender marker. Local advocates describe the situation as a "frozen state of fear," where the lack of active prosecutions does not equate to legal safety. <br>Voices from the Ground: <a href="https://www.humandignitytrust.org/country-profile/the-gambia/" target="_blank">Human Dignity Trust Legal Analysis</a></p>

            <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
                <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
                <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                    <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Criminal Code (Amendment) Act 2014</strong>
                    <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Introduced the charge of "aggravated homosexuality" with sentences up to life imprisonment.</p>
                    <a href="https://database.ilga.org/the-gambia-lgbti" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
                </div>
            </div>
        `,
    ...
    safety: `
            ...
            <p>Police protection is unreliable for LGBTQ+ individuals. Authorities are more likely to investigate the victim's "morality" than the crime committed against them. There is no LGBTQ+ visibility in any government or state office. <br>Voices from the Ground: <a href="https://www.pan-africa-ilga.org/" target="_blank">Pan-Africa ILGA Regional Report</a></p>

            <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
                <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
                <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                    <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #178</strong>
                    <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Performance in 2026 indices remains poor due to the retention of colonial-era and 2014 penal codes.</p>

                    <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                    <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Strong religious opposition to any form of LGBTQ+ advocacy or visibility.</p>
                </div>
            </div>
        `,
    ...
    travel: `
            ...
            <p>Practical advice: Maintain a conservative dress code and avoid all PDA. Do not use dating apps, as they are monitored for extortion. <br>Voices from the Ground: <a href="https://nomadicboys.com/lgbt-travel-safety/" target="_blank">Nomadic Boys Travel Security</a></p>

            <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
                <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
                <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                    <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                    <p style="color: #fff; font-size: 0.85rem;">Strict enforcement of "public decency." Avoid any LGBTQ+ apparel or symbols.</p>
                </div>
            </div>
        `,
    ...
    health: `
            ...
            <p>Emergency protocols are standard and lack any inclusivity training. Medical privacy for LGBTQ+ individuals is not guaranteed. <br>Voices from the Ground: <a href="https://www.alturi.org" target="_blank">Alturi Health Map: Gambia</a></p>

            <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
                <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
                <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                    <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Medical Research Council (MRC)</strong>
                    <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">Atlantic Boulevard, Fajara, The Gambia</p>
                    <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +220 449 5442</p>
                </div>
            </div>
        `,
  ...
  ghana: {
    ...
    legal: `
            ...
            <p>Gender identity is not recognized, and the new legislation specifically targets gender-affirming care and trans visibility. Local advocates describe the bill as a "state-sanctioned erasure" of LGBT life. <br>Voices from the Ground: <a href="https://www.rightifyghana.org/" target="_blank">Rightify Ghana</a></p>

            <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
                <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
                <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                    <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Human Sexual Rights and Family Values Act</strong>
                    <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Comprehensive legislation criminalizing LGBTQ+ identity, advocacy, and funding.</p>
                    <a href="https://database.ilga.org/ghana-lgbti" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
                </div>
            </div>
        `,
    ...
    safety: `
            ...
            <p>Police proactivity is focused on enforcement of the new morality laws rather than protection. Visibility in government is zero, and any suspected LGBTQ+ official faces immediate removal and prosecution. <br>Voices from the Ground: <a href="https://www.pan-africa-ilga.org/" target="_blank">Pan-Africa ILGA Ghana Update</a></p>

            <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
                <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
                <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                    <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #185</strong>
                    <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Ranking has dropped severely in the 2026 Spartacus Index following the passage of the Anti-LGBTQ+ Bill.</p>

                    <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                    <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Criminalization of "promotion" or "funding" of LGBTQ+ activities.</p>
                </div>
            </div>
        `,
    ...
    travel: `
            ...
            <p>Practical advice: Scrub all social media and dating apps before entry. Avoid any political discussion regarding human rights. Do not stay in non-vetted accommodations. <br>Voices from the Ground: <a href="https://nomadicboys.com/lgbt-travel-safety/" target="_blank">Nomadic Boys Warning: Ghana</a></p>

            <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
                <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
                <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                    <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                    <p style="color: #fff; font-size: 0.85rem;">Legislation explicitly targets "foreigners" promoting LGBTQ+ values. High risk of detention.</p>
                </div>
            </div>
        `,
    ...
    health: `
            ...
            <p>Emergency protocols are not inclusive and may lead to police involvement if identity is discovered. <br>Voices from the Ground: <a href="https://www.alturi.org" target="_blank">Alturi Ghana Advocacy Map</a></p>

            <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
                <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
                <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                    <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Nyaho Medical Centre</strong>
                    <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">35 Kofi Annan St, Airport Residential Area, Accra</p>
                    <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +233 302 737 300</p>
                </div>
            </div>
        `,
  ...
  guinea: {
    ...
    legal: `
            ...
            <p>There is no legal path for gender identity recognition. Transgender individuals cannot change their name or gender on official documents. According to Human Dignity Trust, the law targets "indecent acts," which are often interpreted to include any non-conforming gender presentation. <br>Voices from the Ground: <a href="https://www.humandignitytrust.org/country-profile/guinea/" target="_blank">Human Dignity Trust Guinea Profile</a></p>

            <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
                <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
                <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                    <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Guinea Penal Code Article 325</strong>
                    <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Criminalizes "indecent acts or acts against nature committed with an individual of the same sex."</p>
                    <a href="https://database.ilga.org/guinea-lgbti" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
                </div>
            </div>
        `,
    ...
    safety: `
            ...
            <p>Police protection is absent. Authorities are more likely to prosecute LGBTQ+ individuals than to protect them from mob violence. Government visibility is zero. <br>Voices from the Ground: <a href="https://www.pan-africa-ilga.org/" target="_blank">Pan-Africa ILGA Regional Context</a></p>

            <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
                <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
                <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                    <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #164</strong>
                    <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Ranked consistently low in the 2026 Spartacus Index due to criminalization and social hostility.</p>

                    <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                    <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">"Against Nature" statutes are used to justify arbitrary arrests in Conakry.</p>
                </div>
            </div>
        `,
    ...
    travel: `
            ...
            <p>Practical advice: Maintain a conservative appearance. Do not disclose orientation to guides or hotel staff. <br>Voices from the Ground: <a href="https://nomadicboys.com/lgbt-travel-safety/" target="_blank">Nomadic Boys Safety Brief</a></p>

            <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
                <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
                <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                    <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                    <p style="color: #fff; font-size: 0.85rem;">Public behavior is strictly monitored. Zero tolerance for LGBTQ+ signaling.</p>
                </div>
            </div>
        `,
    ...
    health: `
            ...
            <p>Medical institutions are not inclusive. Emergency protocols do not account for LGBTQ+ needs. <br>Voices from the Ground: <a href="https://www.alturi.org" target="_blank">Alturi Guinea Advocacy</a></p>

            <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
                <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
                <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                    <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Hôpital National Donka</strong>
                    <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">Conakry, Guinea</p>
                    <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +224 622 35 40 40</p>
                </div>
            </div>
        `,
  ...
  guinea_bissau: {
    ...
    legal: `
            ...
            <p>Legal gender identity recognition is non-existent. There is no administrative process for transgender individuals to change their name or gender. Local advocates describe a "legal vacuum" where the community is not hunted by the state but has no formal rights. <br>Voices from the Ground: <a href="https://www.pan-africa-ilga.org/" target="_blank">Pan-Africa ILGA Regional Update</a></p>

            <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
                <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
                <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                    <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Guinea-Bissau Penal Code (1993)</strong>
                    <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Successfully removed colonial-era sodomy laws, establishing legal adult consent.</p>
                    <a href="https://database.ilga.org/guinea-bissau-lgbti" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
                </div>
            </div>
        `,
    ...
    safety: `
            ...
            <p>Police protection is technically available, but the police are often untrained on LGBTQ+ issues. Visibility in government is non-existent. <br>Voices from the Ground: <a href="https://www.humandignitytrust.org/country-profile/guinea-bissau/" target="_blank">Human Dignity Trust Bissau Context</a></p>

            <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
                <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
                <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                    <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #132</strong>
                    <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Ranking in the 2026 Spartacus Index is moderate due to legal status but limited civil protections.</p>

                    <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                    <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Legal status provides a buffer against the extreme persecution seen in neighboring Guinea.</p>
                </div>
            </div>
        `,
    ...
    travel: `
            ...
            <p>Practical advice: Discretion is key. Public displays of affection are not culturally common and should be avoided. <br>Voices from the Ground: <a href="https://nomadicboys.com/lgbt-travel-safety/" target="_blank">Nomadic Boys Travel Notes</a></p>

            <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
                <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
                <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                    <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                    <p style="color: #fff; font-size: 0.85rem;">Legal status is a benefit, but visibility is still culturally discouraged.</p>
                </div>
            </div>
        `,
    ...
    health: `
            ...
            <p>Medical institutions are not inclusive. Emergency protocols are basic. <br>Voices from the Ground: <a href="https://www.alturi.org" target="_blank">Alturi Guinea-Bissau Link</a></p>

            <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
                <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
                <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                    <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Hôpital National Simão Mendes</strong>
                    <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">Bissau, Guinea-Bissau</p>
                    <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +245 95 580 47 47</p>
                </div>
            </div>
        `,
  ...
  ivory_coast: {
    ...
    legal: `
            ...
            <p>Legal gender identity recognition is currently unavailable. There is no administrative pathway for transgender individuals to change their legal name or gender on identification. Local activists in Abidjan describe the state as "indifferent," providing neither persecution nor protection. <br>Voices from the Ground: <a href="https://www.pan-africa-ilga.org/" target="_blank">Pan-Africa ILGA Ivory Coast Context</a></p>

            <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
                <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
                <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                    <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Ivorian Penal Code (General Provisions)</strong>
                    <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Unlike neighboring Ghana, the Ivorian code contains no specific prohibition against adult same-sex intimacy.</p>
                    <a href="https://database.ilga.org/cote-divoire-lgbti" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
                </div>
            </div>
        `,
    ...
    safety: `
            ...
            <p>Police protection is generally professional but lacks LGBTQ-specific training. There is zero visibility of out LGBTQ+ individuals in the highest levels of government. <br>Voices from the Ground: <a href="https://www.humandignitytrust.org/country-profile/cote-divoire/" target="_blank">Human Dignity Trust Ivory Coast Update</a></p>

            <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
                <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
                <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                    <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #110</strong>
                    <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Ranking in the 2026 Spartacus Index is higher than its neighbors due to decriminalized status and Abidjan's nightlife.</p>

                    <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                    <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Abidjan acts as a regional safe haven for LGBTQ+ West Africans.</p>
                </div>
            </div>
        `,
    ...
    travel: `
            ...
            <p>Practical advice: Discretion is still advised. Public displays of affection are not recommended. Abidjan’s nightlife is active, but use vetted apps and transport. <br>Voices from the Ground: <a href="https://nomadicboys.com/lgbt-travel-safety/" target="_blank">Nomadic Boys: Abidjan Guide</a></p>

            <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
                <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
                <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                    <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                    <p style="color: #fff; font-size: 0.85rem;">Technically legal, but public behavior should remain conservative to avoid social conflict.</p>
                </div>
            </div>
        `,
    ...
    health: `
            ...
            <p>Emergency protocols are standard. Private clinics in Abidjan offer a higher level of inclusivity. <br>Voices from the Ground: <a href="https://www.alturi.org" target="_blank">Alturi Ivory Coast Advocacy Map</a></p>

            <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
                <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
                <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                    <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Clinique Médicale Farah</strong>
                    <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">Marcory Résidentiel, Abidjan, Côte d'Ivoire</p>
                    <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +225 27 21 21 00 00</p>
                </div>
            </div>
        `,
  ...
  kenya: {
    ...
    legal: `
        ...
        <p>Gender identity laws remain restrictive; there is no specific administrative process for gender marker changes. However, following the 2024 recognition of intersex persons, some trans individuals have navigated judicial pathways for name changes, though these are not guaranteed. <br>Voices from the Ground: <a href="https://galck.org/" target="_blank">GALCK+ (Gay and Lesbian Coalition of Kenya)</a> describes 2026 as a year of "heightened legislative surveillance" against LGBT visibility.</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Kenya Penal Code (Sections 162, 163, 165)</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The primary statutes used to criminalize "carnal knowledge against the order of nature."</p>
                <a href="https://database.ilga.org/kenya-lgbti" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
            </div>
        </div>
    `,
    ...
    safety: `
        ...
        <p>Police protection is highly inconsistent; while some urban units have received "sensitivity briefings" via international NGOs, many LGBTQ+ individuals report extortion and "moral policing" by authorities. There is no open visibility of LGBTQ+ individuals in the cabinet or high-ranking state offices. <br>Voices from the Ground: <a href="https://www.panafrica-ilga.org/" target="_blank">Pan-Africa ILGA Regional Report 2026</a>.</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #168</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Performance in the Spartacus Gay Travel Index 2026 reflects high risks due to active criminalization and social hostility.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Rise in "Family Values" legislation in 2025 targeting LGBTQ+ content and advocacy.</p>
            </div>
        </div>
    `,
    ...
    travel: `
        ...
        <p>Practical advice: Maintain a conservative dress code and avoid any LGBTQ+ symbols (rainbows) in public. If questioned by authorities, emphasize that you are a tourist and avoid discussing local politics. <br>Voices from the Ground: <a href="https://nomadicboys.com/gay-guide-kenya/" target="_blank">Nomadic Boys Travel Intel</a>.</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 20px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">Customs officials may scrutinize gender-nonconforming travelers; ensure your travel documents are consistent and maintain a low profile at JKIA Airport.</p>
            </div>
        </div>
    `,
    ...
    health: `
        ...
        <p>Emergency protocols do not include LGBTQ+ sensitivity training. In medical emergencies, identity disclosure is risky. <br>Voices from the Ground: <a href="https://www.q-initiative.org/" target="_blank">Q-Initiative (Eldoret)</a> provides specialized health referrals for the community.</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">The Aga Khan University Hospital</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">3rd Parklands Avenue, Nairobi, Kenya</p>
                <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +254 (0) 20 366 2000</p>
            </div>
        </div>
    `,
  ...
  lesotho: {
    ...
    legal: `
        ...
        <p>Gender identity recognition is technically possible through the National Identity Card Act, allowing for name changes, but gender marker changes remain difficult and are handled on an ad-hoc basis. <br>Voices from the Ground: <a href="https://www.matrixlesotho.org/" target="_blank">Matrix Support Group</a> describes the legal environment as "tolerated but not protected."</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Penal Code Act of 2010</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The act that formally decriminalized sodomy in the Kingdom of Lesotho.</p>
                <a href="https://database.ilga.org/lesotho-lgbti" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
            </div>
        </div>
    `,
    ...
    safety: `
        ...
        <p>Police protection is theoretically available, and Matrix Lesotho has conducted some training with local law enforcement. However, LGBT individuals often avoid reporting crimes due to fear of stigma. Visibility in state offices is non-existent in 2026. <br>Voices from the Ground: <a href="https://alturi.org/country/lesotho/" target="_blank">Alturi: Lesotho Local NGOs</a>.</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #124</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Ranking in the 2026 Spartacus Index reflects its status as a "decriminalized but unprotected" zone.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Absence of specific anti-propaganda laws found in neighboring jurisdictions.</p>
            </div>
        </div>
    `,
    ...
    travel: `
        ...
        <p>Practical advice: Respect traditional Basotho culture and avoid PDA. The high-altitude lodges are generally safe environments. <br>Voices from the Ground: <a href="https://iglta.org/" target="_blank">IGLTA Southern Africa Guides</a>.</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">Border officials are generally professional; maintain a standard traveler profile and avoid political LGBT activism.</p>
            </div>
        </div>
    `,
    ...
    health: `
        ...
        <p>Emergency protocols are standard but lack inclusive training. <br>Voices from the Ground: <a href="https://www.matrixlesotho.org/" target="_blank">Matrix Health Referrals</a>.</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Willies Hospital</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">Main North 1, Maseru, Lesotho</p>
                <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +266 2231 6451</p>
            </div>
        </div>
    `,
  ...
  liberia: {
    ...
    legal: `
        ...
        <p>Gender identity is not legally recognized. There are no provisions for changing names or gender markers on state ID. <br>Voices from the Ground: <a href="https://www.lipelib.org/" target="_blank">LIPE (Liberia Initiative for Promotion of Rights)</a> describes the legal status as "statutory silencing."</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Liberia Penal Law Section 14.74</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The statute criminalizing "voluntary sodomy" between consenting adults.</p>
                <a href="https://database.ilga.org/liberia-lgbti" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
            </div>
        </div>
    `,
    ...
    safety: `
        ...
        <p>Police protection is generally denied or results in the detention of the LGBTQ+ person for "sodomy" if they attempt to report a crime. There is no visibility in the current administration. <br>Voices from the Ground: <a href="https://www.panafrica-ilga.org/" target="_blank">Pan-Africa ILGA West Africa Monitoring</a>.</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #172</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Ranked as one of the least safe countries in the 2026 Spartacus Index due to legal and social hostility.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">High frequency of "moral panics" reported in local media during 2025.</p>
            </div>
        </div>
    `,
    ...
    travel: `
        ...
        <p>Practical advice: Ensure all digital devices are sanitized of LGBT content before entry. Avoid discussing LGBTQ+ issues with anyone, including local "fixers." <br>Voices from the Ground: <a href="https://nomadicboys.com/" target="_blank">Nomadic Boys: Africa Safety Notes</a>.</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">Customs may check for "obscene materials"; ensure no LGBTQ+ literature or symbols are in your luggage.</p>
            </div>
        </div>
    `,
    ...
    health: `
        ...
        <p>Emergency protocols are standard; do not disclose orientation in an emergency setting. <br>Voices from the Ground: <a href="https://www.lipelib.org/" target="_blank">LIPE Health Support</a>.</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Elwa Hospital</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">Robertsfield Highway, Monrovia, Liberia</p>
                <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +231 88 651 1435</p>
            </div>
        </div>
    `,
  ...
  libya: {
    ...
    legal: `
        ...
        <p>Gender identity is not recognized, and any form of gender-nonconforming behavior is treated as a criminal offense or "moral deviance." <br>Voices from the Ground: <a href="https://www.panafrica-ilga.org/" target="_blank">Pan-Africa ILGA</a> notes that local activists operate entirely from exile as of 2026.</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Libyan Penal Code (Articles 407 & 408)</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Laws criminalizing "illicit sexual intercourse" which are applied to same-sex acts.</p>
                <a href="https://database.ilga.org/libya-lgbti" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
            </div>
        </div>
    `,
    ...
    safety: `
        ...
        <p>Police and militia protection are non-existent; they are the primary perpetrators of violence against the community. There is zero visibility in any governing body. <br>Voices from the Ground: <a href="https://www.humandignitytrust.org/" target="_blank">Human Dignity Trust Libya Profile</a>.</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #198</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Ranking reflects a complete lack of safety for both citizens and visitors.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Application of militia-enforced morality codes across major cities.</p>
            </div>
        </div>
    `,
    ...
    travel: `
        ...
        <p>Practical advice: Avoid travel entirely. If already in the country, maintain total digital and social invisibility. <br>Voices from the Ground: <a href="https://iglta.org/" target="_blank">IGLTA Crisis Advisories</a>.</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">Militia-controlled ports of entry are extremely dangerous; personal devices are subject to search for any LGBT-related content.</p>
            </div>
        </div>
    `,
    ...
    health: `
        ...
        <p>Emergency protocols are non-existent. <br>Voices from the Ground: <a href="https://alturi.org/" target="_blank">Alturi Middle East/North Africa Advocacy</a>.</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Data Not Found</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">No safe medical facility exists for LGBTQ+ individuals in Libya.</p>
            </div>
        </div>
    `,
  ...
  madagascar: {
    ...
    legal: `
        ...
        <p>Gender identity is not legally recognized. There is no administrative process for changing gender markers on official documents. <br>Voices from the Ground: <a href="https://alturi.org/country/madagascar/" target="_blank">Alturi: Madagascar</a> describes the situation as "socially invisible yet legally neutral."</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Malagasy Penal Code (Decriminalized Status)</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Same-sex sexual acts are not listed as offenses under the current penal code.</p>
                <a href="https://database.ilga.org/madagascar-lgbti" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
            </div>
        </div>
    `,
    ...
    safety: `
        ...
        <p>Police protection is technically available for all citizens, but LGBT individuals often face mockery or indifference from authorities. There is no visibility in government. <br>Voices from the Ground: <a href="https://www.panafrica-ilga.org/" target="_blank">Pan-Africa ILGA Regional Analysis</a>.</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #118</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Spartacus Gay Travel Index 2026 ranking is relatively high for Africa due to the lack of criminal laws.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Absence of state-sponsored anti-LGBTQ+ campaigns compared to neighboring nations.</p>
            </div>
        </div>
    `,
    ...
    travel: `
        ...
        <p>Practical advice: Maintain a conservative appearance in rural areas. Most hotels are welcoming to foreign couples as long as discretion is maintained. <br>Voices from the Ground: <a href="https://iglta.org/" target="_blank">IGLTA Africa Travel Advisories</a>.</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">Customs officials are generally not hostile to LGBT travelers; avoid political activism during your stay.</p>
            </div>
        </div>
    `,
    ...
    health: `
        ...
        <p>Emergency protocols are basic and not inclusive. <br>Voices from the Ground: <a href="https://www.panafrica-ilga.org/" target="_blank">Pan-Africa ILGA Health Referrals</a>.</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Hôpital Privé de Madagascar</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">Route d'Ivato, Antananarivo, Madagascar</p>
                <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +261 20 22 432 11</p>
            </div>
        </div>
    `,
  ...
  malawi: {
    ...
    legal: `
        ...
        <p>Gender identity laws are non-existent in 2026. There is no administrative or judicial process for changing gender markers on official identification, and trans individuals are frequently prosecuted under "unnatural offenses" or "rogue and vagabond" laws. <br>Voices from the Ground: <a href="https://www.cedepmalawi.org/" target="_blank">CEDEP (Centre for the Development of People)</a> describes the 2026 legal climate as "one of judicial stagnation and increasing legislative hostility."</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Malawi Penal Code (Sections 153 & 156)</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The primary statutes used to criminalize "carnal knowledge against the order of nature" and "indecent practices between males."</p>
                <a href="https://database.ilga.org/malawi-lgbti" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
            </div>
        </div>
    `,
    ...
    safety: `
        ...
        <p>Police protection for LGBTQ+ individuals is highly unreliable. While the Malawi Police Service has engaged in human rights dialogues with NGOs in early 2026, frontline officers frequently use the Penal Code to justify harassment or arbitrary detention. <br>Voices from the Ground: <a href="https://www.panafrica-ilga.org/" target="_blank">Pan-Africa ILGA 2026 Safety Report</a>.</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #154</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Performance in the Spartacus Gay Travel Index 2026 reflects high risks due to active criminalization and lack of protective laws.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Recent 2025 increase in "anti-vices" rhetoric from regional traditional leaders.</p>
            </div>
        </div>
    `,
    ...
    travel: `
        ...
        <p>Practical advice: Avoid PDA and any clothing or accessories with rainbow motifs. Digital safety is paramount; keep social media profiles private while in the country. <br>Voices from the Ground: <a href="https://nomadicboys.com/gay-malawi/" target="_blank">Nomadic Boys: Malawi Perspective</a>.</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">Customs officials may search phones for "obscene content" which often includes LGBT-themed dating apps.</p>
            </div>
        </div>
    `,
    ...
    health: `
        ...
        <p>Emergency protocols do not include inclusivity training; it is advised to seek medical help at private clinics in Lilongwe or Blantyre if possible. <br>Voices from the Ground: <a href="https://www.nyasatimes.com/" target="_blank">The Washington Blade: Malawi Healthcare Updates</a>.</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Partners in Hope Medical Center</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">Area 47/4, Lilongwe, Malawi</p>
                <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +265 1 727 344</p>
            </div>
        </div>
    `,
  ...
  mali: {
    ...
    legal: `
        ...
        <p>There are no legal provisions for the recognition of gender identity. Trans individuals face significant danger under the expanded "indecency" interpretations. <br>Voices from the Ground: <a href="https://www.panafrica-ilga.org/" target="_blank">Pan-Africa ILGA West Africa Report 2026</a>.</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Mali Code of Persons and the Family</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The statute defining marriage and family life in a way that excludes LGBTQ+ identities.</p>
                <a href="https://database.ilga.org/mali-lgbti" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
            </div>
        </div>
    `,
    ...
    safety: `
        ...
        <p>Police protection is absent. In most cases, authorities are the primary source of harassment. There is zero visibility of LGBTQ+ individuals in the government or military leadership. <br>Voices from the Ground: <a href="https://alturi.org/" target="_blank">Alturi: West Africa Advocacy Link</a>.</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #182</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Ranking in the 2026 Spartacus Index reflects the high risk of violence and lack of state protection.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Active extrajudicial punishment reported in non-state controlled territories in 2025.</p>
            </div>
        </div>
    `,
    ...
    travel: `
        ...
        <p>Practical advice: If travel is unavoidable, use a completely sanitized "burner" phone and maintain total invisibility. Avoid all PDA. <br>Voices from the Ground: <a href="https://iglta.org/" target="_blank">IGLTA West Africa Safety Advisories</a>.</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">Checkpoint guards may target individuals for "non-traditional" appearances to solicit bribes or initiate arrests.</p>
            </div>
        </div>
    `,
    ...
    health: `
        ...
        <p>Emergency protocols do not exist for LGBTQ+ individuals; medical staff are often socially compelled to report "abnormalities" to authorities. <br>Voices from the Ground: <a href="https://www.outrightinternational.org/" target="_blank">Outright International: Mali Brief</a>.</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Clinique Pasteur (Bamako)</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">Hamdallaye ACI 2000, Bamako, Mali</p>
                <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +223 20 29 10 10</p>
            </div>
        </div>
    `,
  ...
  mauritania: {
    ...
    legal: `
        ...
        <p>Gender identity recognition is non-existent. Any form of gender-nonconforming dress or behavior is punishable under "indecency" laws. <br>Voices from the Ground: <a href="https://www.humandignitytrust.org/" target="_blank">Human Dignity Trust Mauritania Update 2026</a> describes the legal framework as "architecturally designed for erasure."</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Mauritania Penal Code (Article 308)</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The statute prescribing the death penalty (by stoning) for consensual same-sex acts between Muslim males.</p>
                <a href="https://database.ilga.org/mauritania-lgbti" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
            </div>
        </div>
    `,
    ...
    safety: `
        ...
        <p>Police protection does not exist for the community; rather, the police are the primary instrument of the state's moral enforcement. <br>Voices from the Ground: <a href="https://www.panafrica-ilga.org/" target="_blank">Pan-Africa ILGA: Sahara Region Report</a>.</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #195</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Ranked near the bottom of the Spartacus Index 2026 due to the death penalty and total lack of safety.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Active state-sanctioned raids on private residences suspected of hosting LGBT gatherings.</p>
            </div>
        </div>
    `,
    ...
    travel: `
        ...
        <p>Practical advice: Avoid travel. If mandatory, ensure all digital devices are "factory reset" and carry zero LGBTQ+ associated items. <br>Voices from the Ground: <a href="https://iglta.org/" target="_blank">IGLTA Islamic Republic Safety Brief</a>.</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">"Moral integrity" checks at borders are standard for foreigners in 2026.</p>
            </div>
        </div>
    `,
    ...
    health: `
        ...
        <p>Emergency protocols are non-existent for the community. <br>Voices from the Ground: <a href="https://alturi.org/" target="_blank">Alturi: Mauritania Crisis Link</a>.</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Data Not Found</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">No safe medical facilities for LGBTQ+ individuals can be verified in Mauritania.</p>
            </div>
        </div>
    `,
  ...
  mauritius: {
    ...
    legal: `
        ...
        <p>Gender identity laws are evolving; while there is no "self-determination" law yet, the 2025 Supreme Court guidance allows for gender marker changes on birth certificates following a simplified medical certification. <br>Voices from the Ground: <a href="https://www.collectifarcenciel.org/" target="_blank">Collectif Arc-en-Ciel</a> describes 2026 as "the era of consolidation" for LGBT rights in the Indian Ocean.</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Mauritius High Court Ruling (2023/2024)</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The judgment that decriminalized consensual same-sex acts by striking down Section 250.</p>
                <a href="https://database.ilga.org/mauritius-lgbti" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
            </div>
        </div>
    `,
    ...
    safety: `
        ...
        <p>Police protection is proactive, with specific diversity training implemented in 2025. There is increasing visibility of LGBTQ+ individuals in professional sectors and some mid-level government advisory roles. <br>Voices from the Ground: <a href="https://www.youngLGBTalliance.com/" target="_blank">Young LGBT Alliance (YQA) Mauritius</a>.</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #48</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Performance in the Spartacus Gay Travel Index 2026 has jumped significantly following decriminalization.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Active government participation in IGLTA inclusive tourism summits in 2025.</p>
            </div>
        </div>
    `,
    ...
    travel: `
        ...
        <p>Practical advice: PDA is generally acceptable in resort areas and Port Louis. Engagement with the local LGBT community at events like the Pride parade is highly encouraged. <br>Voices from the Ground: <a href="https://nomadicboys.com/gay-guide-mauritius/" target="_blank">Nomadic Boys: Mauritius Guide 2026</a>.</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">Customs and airport staff at Sir Seewoosagur Ramgoolam Airport are trained to be respectful of diverse travelers.</p>
            </div>
        </div>
    `,
    ...
    health: `
        ...
        <p>Emergency protocols are inclusive; medical institutions in Port Louis have clear anti-discrimination policies. <br>Voices from the Ground: <a href="https://www.youngLGBTalliance.com/" target="_blank">YQA Health Advocacy</a>.</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Wellkin Hospital</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">Moka, Mauritius</p>
                <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +230 605 1000</p>
            </div>
        </div>
    `,
...
<div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;"> 
<strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">🏛️ ADHEOS (Mayotte Branch)</strong> 
<p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Providing legal support and asylum assistance for LGBTQ+ individuals facing local persecution in the Comoros region.</p> 
...
* **Amber Zones:** Rural villages and religious centers where traditional norms are strictly enforced.</p>
<p><strong>The Venue Spectrum:</strong> 
* **Upscale/Protected:** Le Caribou (Mamoudzou) 
* **The Local Way:** 5/5 (Social Club - Private Vibe)</p>
<div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;"> 
...
<a href="https://www.chmayotte.fr/" target="_blank" style="text-decoration: none; display: block; margin-bottom: 15px;"> 
<div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;"> 
<strong style="display: block; font-size: 1.1rem; margin-bottom: 5px; color: #ffffff;">Centre Hospitalier de Mayotte (CHM)</strong> 
...
<p>The "Administrative Shield" posture in Mayotte means you are legally protected by France but socially navigating a traditional island culture. The 2026 verdict is "Secure but Silent."</p> `,
  ...
  morocco: {
    ...
    legal: `
        ...
        <p>Gender identity is not recognized. Any form of gender-nonconforming behavior is frequently prosecuted under "public indecency" laws. <br>Voices from the Ground: <a href="https://akaliyat.org/" target="_blank">Akaliyat (Minorities)</a> describes the situation as "a constant state of digital and physical evasion."</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Moroccan Penal Code (Article 489)</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The statute criminalizing "lewd or unnatural acts with an individual of the same sex."</p>
                <a href="https://database.ilga.org/morocco-lgbti" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
            </div>
        </div>
    `,
    ...
    safety: `
        ...
        <p>Police protection is generally non-existent for the community; authorities often use reports of violence against LGBT people as an opportunity to arrest the victim for Article 489 violations. There is no visibility in any state institution. <br>Voices from the Ground: <a href="https://alturi.org/country/morocco/" target="_blank">Alturi: Morocco Advocacy Network</a>.</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #162</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Ranking in the 2026 Spartacus Index reflects the disconnect between tourism visibility and local legal peril.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">High frequency of "digital morality raids" reported by local activists in 2025.</p>
            </div>
        </div>
    `,
    ...
    travel: `
        ...
        <p>Practical advice: Use a VPN for all LGBT-related browsing. Avoid all PDA. If staying in a Riads, ensure you book as two separate travelers if you are concerned about local staff reporting you. <br>Voices from the Ground: <a href="https://nomadicboys.com/gay-guide-morocco/" target="_blank">Nomadic Boys: Morocco Intel</a>.</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">Customs officials may scrutinize gender-nonconforming individuals; ensure your digital footprint is sanitized.</p>
            </div>
        </div>
    `,
    ...
    health: `
        ...
        <p>Emergency protocols do not include LGBT inclusivity. <br>Voices from the Ground: <a href="https://www.ascs.ma/" target="_blank">Association Sud Contre le Sida (ALCS)</a>.</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Hôpital Privé de Marrakech</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">Douar Bourry, Marrakesh, Morocco</p>
                <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +212 524 369 500</p>
            </div>
        </div>
    `,
  ...
  mozambique: {
    ...
    legal: `
        ...
        <p>Gender identity laws are non-existent, and there is no administrative process for legal gender recognition. Trans individuals often navigate a legal vacuum, where "moral" interpretations of existing laws can lead to administrative hurdles. <br>Voices from the Ground: <a href="https://www.lambdamoz.org/" target="_blank">LAMBDA Mozambique</a> highlights that while the law is silent, the absence of protection allows for "de facto" discrimination.</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Mozambique Penal Code (2015)</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The revised code that officially removed "security measures against practitioners of unnatural acts."</p>
                <a href="https://database.ilga.org/mozambique-lgbti" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
            </div>
        </div>
    `,
    ...
    safety: `
        ...
        <p>Police protection is theoretically available, but visibility remains low in government or state offices. Reports from 2025 suggest that while police do not actively hunt LGBTQ+ individuals, they often fail to intervene in cases of community-based harassment. <br>Voices from the Ground: <a href="https://www.panafrica-ilga.org/" target="_blank">Pan-Africa ILGA Regional Report 2026</a>.</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #98</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Ranked moderately in the 2026 Spartacus Index, benefiting from decriminalization but held back by social stigma.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Absence of specific "Hate Crime" legislation despite rising advocacy efforts in 2025.</p>
            </div>
        </div>
    `,
    ...
    travel: `
        ...
        <p>Practical advice: Avoid PDA in public squares or religious sites. The use of LGBT-focused dating apps is generally safe but should be handled with standard digital caution. <br>Voices from the Ground: <a href="https://nomadicboys.com/gay-maputo/" target="_blank">Nomadic Boys: Mozambique Travel Guide</a>.</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">Customs at Maputo International Airport are generally professional, but gender-nonconforming travelers may face extra scrutiny.</p>
            </div>
        </div>
    `,
    ...
    health: `
        ...
        <p>Emergency protocols are general and do not feature LGBTQ-specific inclusive mandates. <br>Voices from the Ground: <a href="https://www.outrightinternational.org/" target="_blank">Outright International: Mozambique Health Brief</a>.</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">LAMBDA Healthcare Center</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">Rua da Resistência, Maputo, Mozambique</p>
                <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +258 21 415 155</p>
            </div>
        </div>
    `,
  ...
  namibia: {
    ...
    legal: `
        ...
        <p>Gender identity laws are currently in a state of transition; while a formal "Gender Recognition Act" is pending, courts have increasingly allowed for gender marker updates on the basis of psychological evaluation as of late 2025. <br>Voices from the Ground: <a href="https://www.outright.com.na/" target="_blank">Out-Right Namibia</a> describes 2026 as "the year our dignity was finally codified."</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Dausab v Minister of Justice (2024)</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The definitive ruling that decriminalized same-sex conduct across the Republic of Namibia.</p>
                <a href="https://database.ilga.org/namibia-lgbti" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
            </div>
        </div>
    `,
    ...
    safety: `
        ...
        <p>Police protection is now mandated under updated human rights protocols following the 2024 decriminalization. Visibility is rising, with several openly LGBTQ+ individuals holding prominent positions in legal advocacy and public health. <br>Voices from the Ground: <a href="https://www.panafrica-ilga.org/" target="_blank">Pan-Africa ILGA: Namibia Status Report</a>.</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #62</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">One of the highest-ranked African nations in the 2026 Spartacus Index due to rapid legal progress.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">State-sponsored diversity training for judicial and security officers implemented in late 2025.</p>
            </div>
        </div>
    `,
    ...
    travel: `
        ...
        <p>Practical advice: Moderate PDA is generally accepted in urban centers and high-end tourism hubs. The atmosphere is one of growing curiosity and acceptance. <br>Voices from the Ground: <a href="https://nomadicboys.com/gay-guide-namibia/" target="_blank">Nomadic Boys: Namibia Guide 2026</a>.</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">Hosea Kutako International Airport is ranked as one of the most LGBT-friendly entry points in Southern Africa in 2026.</p>
            </div>
        </div>
    `,
    ...
    health: `
        ...
        <p>Emergency protocols are increasingly inclusive, with medical institutions receiving sensitivity training on "Dignified Care." <br>Voices from the Ground: <a href="https://www.outright.com.na/" target="_blank">Out-Right Namibia Health Advocacy</a>.</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Medi-Clinic Windhoek</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">Heliodoor Street, Windhoek, Namibia</p>
                <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +264 61 433 1000</p>
            </div>
        </div>
    `,
  ...
  niger: {
    ...
    legal: `
        ...
        <p>Gender identity laws are non-existent. There is no legal mechanism to change gender markers, and trans individuals are frequently harassed under "disguise for criminal intent" or "indecency" laws. <br>Voices from the Ground: <a href="https://www.panafrica-ilga.org/" target="_blank">Pan-Africa ILGA: Sahel Crisis Brief</a> describes the situation as "extreme legal precarity."</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Niger Penal Code (Moral Statutes)</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The legal framework used to prosecute "attacks on the moral integrity of the youth."</p>
                <a href="https://database.ilga.org/niger-lgbti" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
            </div>
        </div>
    `,
    ...
    safety: `
        ...
        <p>Police protection is absent; authorities are more likely to participate in the harassment or detention of LGBT individuals than protect them. There is zero visibility in government offices. <br>Voices from the Ground: <a href="https://alturi.org/" target="_blank">Alturi: Niger Crisis Alert</a>.</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #178</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Ranked very low in the Spartacus Index 2026 due to political instability and rising moral policing.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">2025 reports of state-sanctioned raids on suspected "immoral gatherings" in Niamey.</p>
            </div>
        </div>
    `,
    ...
    travel: `
        ...
        <p>Practical advice: Avoid travel. If travel is mandatory, sanitize all digital devices and maintain total invisibility. <br>Voices from the Ground: <a href="https://iglta.org/" target="_blank">IGLTA Sahel Region Advisory 2026</a>.</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">Customs at Diori Hamani International Airport are increasingly performing "moral checks" on personal electronics.</p>
            </div>
        </div>
    `,
    ...
    health: `
        ...
        <p>Emergency protocols are non-inclusive, and medical staff are socially pressured to report "abnormalities" to authorities. <br>Voices from the Ground: <a href="https://www.outrightinternational.org/" target="_blank">Outright International: Niger Health Profile</a>.</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Clinique Gamkalley (Niamey)</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">Avenue de la Santé, Niamey, Niger</p>
                <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +227 20 73 30 30</p>
            </div>
        </div>
    `,
  ...
  nigeria: {
    ...
    legal: `
        ...
        <p>Gender identity is not recognized, and gender-affirming expression is criminalized under the SSMPA as a form of "homosexual act." <br>Voices from the Ground: <a href="https://www.initiative4equality.org/" target="_blank">The Initiative for Equal Rights (TIERS)</a> reports that 2026 has seen a sharp increase in arbitrary arrests under "public morality" pretexts.</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Same-Sex Marriage (Prohibition) Act (2014)</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The sweeping legislation that criminalizes all aspects of LGBTQ+ life and advocacy in Nigeria.</p>
                <a href="https://database.ilga.org/nigeria-lgbti" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
            </div>
        </div>
    `,
    ...
    safety: `
        ...
        <p>Police protection is non-existent; the Nigeria Police Force is the primary enforcer of the SSMPA and often uses it to justify extortion and torture. <br>Voices from the Ground: <a href="https://www.LGBTyouthnetwork.org/" target="_blank">LGBT Youth Network Nigeria</a>.</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #188</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Consistently ranked among the most dangerous countries in the Spartacus Index 2026.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Active use of Sharia courts in northern states to issue death warrants for LGBTQ+ individuals in 2025.</p>
            </div>
        </div>
    `,
    ...
    travel: `
        ...
        <p>Practical advice: If travel is unavoidable, practice total invisibility and sanitize all digital footprints. Carry zero items that could be interpreted as LGBTQ+ supporting. <br>Voices from the Ground: <a href="https://nomadicboys.com/gay-nigeria/" target="_blank">Nomadic Boys: Nigeria Safety Brief</a>.</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">Customs officials are legally empowered to arrest foreigners suspected of "promoting" homosexuality.</p>
            </div>
        </div>
    `,
    ...
    health: `
        ...
        <p>Emergency protocols are non-existent for the community; disclosure in a hospital is equivalent to a criminal confession. <br>Voices from the Ground: <a href="https://www.ascs.ma/" target="_blank">Outright International: Nigeria Healthcare Warning</a>.</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Data Not Found</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">No safe medical facilities for LGBTQ+ individuals can be verified in Nigeria.</p>
            </div>
        </div>
    `,
  ...
  réunion_island: {
    ...
    legal: `
        ...
        <p>Hate speech and hate crimes are strictly prosecuted under French Penal Code mandates, which apply directly to the island. <br>Voices from the Ground: <a href="https://www.reunion.gouv.fr/" target="_blank">Prefecture of Réunion</a> reinforces that republican values of equality are paramount.</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 French Civil Code (Marriage Equality)</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The law guaranteeing marriage and adoption rights for all couples regardless of gender.</p>
                <a href="https://database.ilga.org/france-lgbti" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
            </div>
        </div>
    `,
    ...
    safety: `
        ...
        <p>Police protection is proactive and mandated by French national policy. Visibility is high, with LGBTQ+ individuals active in local government and the thriving tourism sector. <br>Voices from the Ground: <a href="https://www.reunion-safari.com/" target="_blank">Reunion Safari (Local Voice)</a>.</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #12</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">As part of France, it shares one of the top spots in the 2026 Spartacus Index for the region.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Full integration into the French national "Plan for Equality" 2023-2026.</p>
            </div>
        </div>
    `,
    ...
    travel: `
        ...
        <p>Practical advice: PDA is generally accepted. The island is culturally diverse, and while the "metropole" (mainland France) influence is strong, respecting local Creole culture remains important for all travelers. <br>Voices from the Ground: <a href="https://nomadicboys.com/gay-reunion/" target="_blank">Nomadic Boys: Réunion Guide 2026</a>.</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">Roland Garros Airport follows standard EU-inclusive security protocols for all travelers.</p>
            </div>
        </div>
    `,
    ...
    health: `
        ...
        <p>Emergency protocols are fully inclusive and prioritize the patient's dignity and privacy. <br>Voices from the Ground: <a href="https://www.reunion.ars.sante.fr/" target="_blank">ARS Réunion (Regional Health Agency)</a>.</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">CHU de la Réunion (Saint-Denis)</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">Allée des Topazes, Saint-Denis, Réunion</p>
                <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +262 262 90 50 50</p>
            </div>
        </div>
    `,
  ...
  rwanda: {
    ...
    legal: `
        ...
        <p>Gender identity laws are non-existent in 2026. There is no administrative or judicial process to change legal gender markers on state-issued IDs. <br>Voices from the Ground: <a href="https://humanrightsfirst.org/" target="_blank">Human Rights First: Rwanda Brief</a> notes that local activists describe the legal silence as a "double-edged sword" that prevents mass arrests but allows for systemic social exclusion.</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Constitution of the Republic of Rwanda</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Article 25 continues to restrict the definition of marriage, serving as the primary barrier to equality.</p>
                <a href="https://database.ilga.org/rwanda-lgbti" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
            </div>
        </div>
    `,
    ...
    safety: `
        ...
        <p>Police protection is theoretically available for all citizens, but LGBTQ+ individuals often report a fear of secondary victimization when reporting crimes. Visibility in government remains non-existent in 2026. <br>Voices from the Ground: <a href="https://www.panafrica-ilga.org/" target="_blank">Pan-Africa ILGA Regional Report</a>.</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #124</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Performance in the 2026 Spartacus Gay Travel Index reflects the absence of criminalization tempered by severe social stigma.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">No state-mandated certifications for LGBTQ+ safety, but no active "anti-gay" task forces exist.</p>
            </div>
        </div>
    `,
    ...
    travel: `
        ...
        <p>Practical advice: Nyamirambo in Kigali is a vibrant, diverse neighborhood where "vibe" is more important than identity, making it a relatively relaxed safe haven for meeting local creatives. <br>Voices from the Ground: <a href="https://nomadicboys.com/gay-rwanda/" target="_blank">Nomadic Boys: Kigali Travel Intel</a>.</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">Customs officers may scrutinize materials or digital content perceived as "promoting" non-traditional values.</p>
            </div>
        </div>
    `,
    ...
    health: `
        ...
        <p>Emergency protocols do not include inclusivity training. Medical institutions remain heteronormative in their intake processes. <br>Voices from the Ground: <a href="https://www.outrightinternational.org/" target="_blank">Outright International: Rwanda Health Report</a>.</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">King Faisal Hospital (Private)</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">KG 544 St, Kigali, Rwanda</p>
                <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +250 788 309 003</p>
            </div>
        </div>
    `,
...
<h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Local Advocacy & Legal Support</h4> 
<div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;"> 
<strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">🏛️ Saint Helena Government Equality Office</strong> 
<p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Overseeing the 2026 Equality Action Plan to ensure island-wide inclusivity.</p> 
...
* **Amber Zones:** None identified; the entire territory is essentially a Green Zone.</p>
<p><strong>The Venue Spectrum:</strong> 
* **Upscale/Protected:** Mantis St Helena (Jamestown) 
* **The Local Way:** Anne's Place (Casual, community hub)</p>
<div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;"> 
<h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Intel</h4> 
<div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);"> 
<strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Street Awareness Tip</strong> 
...
<h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">On-The-Ground Health Contacts</h4> 
<div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;"> 
<strong style="display: block; font-size: 1.1rem; margin-bottom: 5px; color: #ffffff;">St Mary’s Hospital</strong> 
...
<p>The "Isolated Sanctuary" posture in Saint Helena reflects a tiny, polite community that has fully embraced legal equality. The 2026 verdict is "Quietly Perfect."</p> `,
  ...
  sao_tome_and_principe: {
    ...
    legal: `
        ...
        <p>Gender identity recognition is non-existent. There is no legal framework for trans individuals to update their name or gender on documents in 2026. <br>Voices from the Ground: <a href="https://www.panafrica-ilga.org/" target="_blank">Pan-Africa ILGA</a> notes that the island's small population leads to a "don't ask, don't tell" administrative culture.</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Penal Code of 2012</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The landmark code that formally removed all criminal sanctions for same-sex acts.</p>
                <a href="https://database.ilga.org/sao-tome-and-principe-lgbti" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
            </div>
        </div>
    `,
    ...
    safety: `
        ...
        <p>Police protection is adequate for general safety, though LGBT-specific sensitivity training has not been implemented by 2026. Visibility in government is zero. <br>Voices from the Ground: <a href="https://humandignitytrust.org/" target="_blank">Human Dignity Trust: Lusophone Africa Report</a>.</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #92</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Ranked moderately in the 2026 Spartacus Index due to its decriminalized status and low violent crime rate.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Absence of active hate-crime legislation remains the primary safety concern for 2026.</p>
            </div>
        </div>
    `,
    ...
    travel: `
        ...
        <p>Practical advice: Use the island's natural "relaxed" vibe to your advantage. Discretion is expected of everyone, regardless of orientation. <br>Voices from the Ground: <a href="https://iglta.org/" target="_blank">IGLTA: Emerging African Destinations</a>.</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">Customs are generally laid back; no specific warnings for 2026 travelers.</p>
            </div>
        </div>
    `,
    ...
    health: `
        ...
        <p>Emergency protocols are standard and not tailored for inclusivity. <br>Voices from the Ground: <a href="https://www.who.int/" target="_blank">WHO Regional Health Reports 2025</a>.</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 20px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Hospital Dr. Ayres de Menezes</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">Avenida Marginal 12 de Julho, São Tomé</p>
                <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +239 222 1222</p>
            </div>
        </div>
    `,
  ...
  senegal: {
    ...
    legal: `
        ...
        <p>Gender identity laws do not exist. Attempting to change gender markers is seen as a violation of public order, and trans individuals are frequently targeted for "indecent attire." <br>Voices from the Ground: <a href="https://www.panafrica-ilga.org/" target="_blank">Pan-Africa ILGA: Senegal Alert</a> notes that activists describe the new political climate as "hostile and suffocating."</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Article 419 of the Penal Code</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The primary legal instrument used to prosecute consensual same-sex relations in Senegal.</p>
                <a href="https://database.ilga.org/senegal-lgbti" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
            </div>
        </div>
    `,
    ...
    safety: `
        ...
        <p>Police protection for the community is virtually non-existent; authorities often lead the arrests rather than providing safety. No LGBT visibility exists in state offices. <br>Voices from the Ground: <a href="https://www.washingtonblade.com/" target="_blank">Washington Blade: Senegal Human Rights Update</a>.</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #168</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Ranked near the bottom of the 2026 Spartacus Index due to criminalization and high social danger.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Active "morality policing" in urban centers like Dakar and Touba is a major 2026 risk.</p>
            </div>
        </div>
    `,
    ...
    travel: `
        ...
        <p>Practical advice: Do not use dating apps. Do not engage in PDA. If you are a LGBT traveler, Senegal is not a recommended destination in 2026. <br>Voices from the Ground: <a href="https://nomadicboys.com/gay-senegal/" target="_blank">Nomadic Boys: Senegal Safety Brief</a>.</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">Digital surveillance at customs is common; clear all LGBT-related apps before arrival.</p>
            </div>
        </div>
    `,
    ...
    health: `
        ...
        <p>Emergency protocols are non-inclusive. <br>Voices from the Ground: <a href="https://www.outrightinternational.org/" target="_blank">Outright International: Senegal Health Crisis</a>.</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Data Not Found</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">No safe public facilities can be verified for the community in 2026.</p>
            </div>
        </div>
    `,
  ...
  seychelles: {
    ...
    legal: `
        ...
        <p>Gender identity laws are evolving; as of late 2025, administrative procedures for name changes are accessible, though legal gender marker changes still require a judicial petition. <br>Voices from the Ground: <a href="https://www.lgbtisey.org/" target="_blank">LGBTI Sey</a> describes the legal atmosphere as "the most promising in the region."</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Seychelles Penal Code (Amendment) 2016</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The act that officially removed "unnatural offenses" from the criminal records.</p>
                <a href="https://database.ilga.org/seychelles-lgbti" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
            </div>
        </div>
    `,
    ...
    safety: `
        ...
        <p>Police protection is reliable and inclusive. In late 2025, the Seychelles police force completed a second round of human rights sensitivity training specifically focused on the community. <br>Voices from the Ground: <a href="https://www.panafrica-ilga.org/" target="_blank">Pan-Africa ILGA: Seychelles Success Story</a>.</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #48</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Ranked as the safest country in Africa in the 2026 Spartacus Index.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The presence of an active, state-supported NGO (LGBTI Sey) is a 2026 gold standard.</p>
            </div>
        </div>
    `,
    ...
    travel: `
        ...
        <p>Practical advice: PDA is accepted in tourist areas but should be kept moderate in traditional villages. The islands are a top choice for LGBT honeymoons in 2026. <br>Voices from the Ground: <a href="https://nomadicboys.com/gay-seychelles/" target="_blank">Nomadic Boys: Seychelles Guide</a>.</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">Customs at Seychelles International are professional and LGBT-neutral.</p>
            </div>
        </div>
    `,
    ...
    health: `
        ...
        <p>Emergency protocols are fully inclusive. <br>Voices from the Ground: <a href="https://www.outrightinternational.org/" target="_blank">Outright International: Seychelles Inclusivity Map</a>.</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Seychelles Hospital (Victoria)</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">Mont Fleuri, Mahé, Seychelles</p>
                <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +248 438 8000</p>
            </div>
        </div>
    `,
  ...
  sierra_leone: {
    ...
    legal: `
        ...
        <p>Gender identity laws are non-existent. There is no legal path for gender recognition in 2026. <br>Voices from the Ground: <a href="https://www.panafrica-ilga.org/" target="_blank">Pan-Africa ILGA</a> notes that activists are focusing on a "health-first" strategy to bypass moral debates.</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Larceny Act of 1861 (Section 61)</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The colonial-era law that remains the primary legal barrier to equality in 2026.</p>
                <a href="https://database.ilga.org/sierra-leone-lgbti" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
            </div>
        </div>
    `,
    ...
    safety: `
        ...
        <p>Police protection is unreliable; while they may not actively arrest, they are also unlikely to intervene in cases of harassment. Visibility in government is non-existent. <br>Voices from the Ground: <a href="https://humandignitytrust.org/" target="_blank">Human Dignity Trust: West Africa Status</a>.</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #138</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Performance in the 2026 Spartacus Index is hampered by the lack of formal decriminalization.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The use of the Larceny Act as a tool for extortion by corrupt actors is a 2026 risk.</p>
            </div>
        </div>
    `,
    ...
    travel: `
        ...
        <p>Practical advice: Sanitize digital devices. Avoid discussing your orientation with locals unless you have a high degree of trust. <br>Voices from the Ground: <a href="https://nomadicboys.com/gay-sierra-leone/" target="_blank">Nomadic Boys: Freetown Travel Intel</a>.</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">Customs at Lungi International are unpredictable regarding gender-diverse travelers in 2026.</p>
            </div>
        </div>
    `,
    ...
    health: `
        ...
        <p>Emergency protocols are not inclusive. <br>Voices from the Ground: <a href="https://www.outrightinternational.org/" target="_blank">Outright International: Sierra Leone Health Profile</a>.</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Choithram Memorial Hospital</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">Hill Station, Freetown, Sierra Leone</p>
                <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +232 76 601 000</p>
            </div>
        </div>
    `,
  ...
  somalia: {
    ...
    legal: `
        ...
        <p>Gender identity laws are non-existent. There are no administrative or medical processes for legal name or gender changes. Transgender individuals are frequently targeted under "public indecency" or Sharia-based "impersonation" laws, which carry severe corporal punishments. In 2025, reports indicated a rise in arbitrary detentions for those perceived to be non-conforming in their gender expression.</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Somali Penal Code (Article 409)</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Criminalizes "intercourse with a person of the same sex" as a crime against modesty.</p>
                <a href="https://database.ilga.org/somalia-lgbti" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
            </div>
        </div>
    `,
    ...
    safety: `
        ...
        <p>Police and security forces are more likely to be perpetrators of violence than protectors. There is zero visibility of LGBTQ+ individuals in government; any such disclosure would result in immediate loss of office, imprisonment, or worse. <br>Voices from the Ground: <a href="https://www.outrightinternational.org/" target="_blank">Outright International: Horn of Africa Reports</a>.</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #198</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Consistently ranked in the bottom tier of the Spartacus Gay Travel Index 2026 due to the death penalty threat.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Active enforcement of Sharia-based "Morality Codes" by both state and non-state actors.</p>
            </div>
        </div>
    `,
    ...
    travel: `
        ...
        <p>Cis-gay travelers must strictly follow conservative dress codes and avoid any form of PDA. Trans/Non-Binary travelers face a near-impossible situation regarding airport security and local ID laws; mismatching gender markers or "non-conforming" attire are frequently treated as criminal offenses in 2026. <br>Voices from the Ground: <a href="https://iglta.org/" target="_blank">IGLTA Safety Advisories</a>.</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">Strict digital privacy is required; delete all social media or dating apps prior to entry.</p>
            </div>
        </div>
    `,
    ...
    health: `
        ...
        <p>There are no emergency protocols for LGBTQ+ inclusion. Medical institutions operate under strict traditional and religious guidelines. <br>Voices from the Ground: <a href="https://www.who.int/" target="_blank">WHO Regional Health Reports 2025</a>.</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Data Not Found</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">No verified safe medical facilities for LGBTQ+ persons exist within the country.</p>
            </div>
        </div>
    `,
  ...
  somaliland: {
    ...
    legal: `
        ...
        <p>Gender identity is not recognized under Somaliland law. There is no legal mechanism for gender marker changes. Local activists, communicating through the <a href="https://www.panafrica-ilga.org/" target="_blank">Pan-Africa ILGA</a> networks, note that the state’s desire for order has led to increased surveillance of gender-non-conforming behavior in urban centers like Hargeisa.</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Somaliland Constitution (Article 2)</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Affirms Sharia as the basis for all laws, which local courts interpret to criminalize LGBT acts.</p>
                <a href="https://www.humandignitytrust.org/country-profile/somalia/" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
            </div>
        </div>
    `,
    ...
    safety: `
        ...
        <p>Police protection is not an option for the community; contact with authorities regarding orientation often leads to arrest. There is no LGBTQ+ visibility in government or public life. <br>Voices from the Ground: <a href="https://www.alturi.org/" target="_blank">Alturi: Somaliland Activist Spotlights</a>.</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #190</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Ranked significantly low in the 2026 Spartacus Index due to extreme social stigma and legal hostility.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Local "Moral Committees" often monitor social behavior in residential districts.</p>
            </div>
        </div>
    `,
    ...
    travel: `
        ...
        <p>Cis-gay travelers are advised to present as "friends." Trans/Non-Binary travelers face severe risk at the border and airport; 2026 regulations have tightened around "biometric consistency," making it difficult for those with mismatching IDs. <br>Voices from the Ground: <a href="https://www.nomadicboys.com/" target="_blank">Nomadic Boys: Middle East & Horn of Africa Alerts</a>.</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">Expect scrutiny of personal electronics; encrypted folders for sensitive content are recommended.</p>
            </div>
        </div>
    `,
    ...
    health: `
        ...
        <p>No emergency protocols for LGBT individuals exist. <br>Voices from the Ground: <a href="https://www.outrightinternational.org/" target="_blank">Outright International: Somaliland Health Access Report</a>.</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Hargeisa Group Hospital (General Only)</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">Main Hospital St, Hargeisa</p>
                <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +252 2 523115</p>
            </div>
        </div>
    `,
  ...
  south_africa: {
    ...
    legal: `
        ...
        <p>Gender identity laws are among the most progressive in the region. Under Act No. 49 of 2003, individuals can change their legal gender marker without requiring reassignment surgery. In 2026, a new "Self-ID" framework is being piloted in major metros to further simplify the name-change process. <br>Voices from the Ground: <a href="https://www.triangle.org.za/" target="_blank">Triangle Project</a> notes that while the law is perfect, "implementation in rural areas remains the final frontier."</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Constitution of South Africa (Section 9)</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The Equality Clause that explicitly forbids discrimination on the grounds of sexual orientation.</p>
                <a href="https://database.ilga.org/south-africa-lgbti" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
            </div>
        </div>
    `,
    ...
    safety: `
        ...
        <p>Police protection is proactive in cities, and there is significant visibility of LGBTQ+ individuals in the highest levels of government, including parliament and the judiciary. <br>Voices from the Ground: <a href="https://www.genderdynamix.org.za/" target="_blank">Gender DynamiX: 2026 Safety Report</a>.</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #32</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">A top performer in the Spartacus Index 2026, though points are deducted for localized violence rates.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The 2024 Hate Crimes Act is now fully operational, providing enhanced sentencing for targeted attacks.</p>
            </div>
        </div>
    `,
    ...
    travel: `
        ...
        <p>Cis-gay travelers face no specific issues with PDA in urban districts. Trans/Non-Binary travelers benefit from modern airport security protocols; OR Tambo International has gender-neutral screening options as of 2026. <br>Voices from the Ground: <a href="https://iglta.org/" target="_blank">IGLTA South Africa Guide</a>.</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">Customs are LGBT-friendly. Avoid open PDA in conservative rural townships to prevent unwanted attention.</p>
            </div>
        </div>
    `,
    ...
    health: `
        ...
        <p>Emergency protocols are inclusive, and major medical institutions like Groote Schuur have specialized SOGI units. <br>Voices from the Ground: <a href="https://www.outrightinternational.org/" target="_blank">Outright International: Healthcare Equity in SA</a>.</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Health4Men / Anova Health Institute</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">120 End St, Doornfontein, Johannesburg</p>
                <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: +27 11 581 5000</p>
            </div>
        </div>
    `,
  ...
  south_sudan: {
    ...
    legal: `
        ...
        <p>Gender identity is not recognized, and there is no legal process for changing gender markers. Transgender individuals are at high risk of arrest under "public order" or "impersonation" statutes. <br>Voices from the Ground: <a href="https://www.panafrica-ilga.org/" target="_blank">Pan-Africa ILGA</a> notes that local advocates describe the situation as "frozen in conflict," with LGBT rights completely ignored by the state.</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 South Sudan Penal Code (Section 248)</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Defines and punishes "carnal intercourse against the order of nature."</p>
                <a href="https://database.ilga.org/south-sudan-lgbti" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
            </div>
        </div>
    `,
    ...
    safety: `
        ...
        <p>Police protection is not available for the community. Visibility in government is zero. <br>Voices from the Ground: <a href="https://www.outrightinternational.org/" target="_blank">Outright International: Conflict Zones Report</a>.</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #185</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Ranked near the bottom of the 2026 Spartacus Index due to criminalization and general instability.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Arbitrary enforcement of colonial-era laws during periods of social unrest.</p>
            </div>
        </div>
    `,
    ...
    travel: `
        ...
        <p>Practical advice: Avoid any mention of LGBTQ+ topics. Ensure your digital footprint is clean of any dating apps or LGBT content. <br>Voices from the Ground: <a href="https://iglta.org/" target="_blank">IGLTA: Risk Assessment</a>.</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">High risk of harassment by border authorities. Maintain a strictly heteronormative profile.</p>
            </div>
        </div>
    `,
    ...
    health: `
        ...
        <p>No emergency protocols exist for inclusive care. <br>Voices from the Ground: <a href="https://www.who.int/" target="_blank">WHO: South Sudan Health Profile</a>.</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Data Not Found</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">No verified LGBTQ-inclusive medical facilities are available.</p>
            </div>
        </div>
    `,
  ...
  sudan: {
    ...
    legal: `
        ...
        <p>Gender identity is not legally recognized. There is no process for name or gender changes. Transgender individuals are frequently targeted for "scandalous behavior" or "indecent dress." <br>Voices from the Ground: <a href="https://www.panafrica-ilga.org/" target="_blank">Pan-Africa ILGA</a> notes that the war has made LGBT activists "doubly invisible" as they flee both conflict and persecution.</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Sudan Penal Code (Article 148)</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Maintains criminal penalties for same-sex consensual acts, despite the 2020 amendments.</p>
                <a href="https://database.ilga.org/sudan-lgbti" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
            </div>
        </div>
    `,
    ...
    safety: `
        ...
        <p>Police and paramilitary groups are a primary source of danger. Visibility in government is non-existent, and any known LGBT individual in a public role would face immediate threat of death. <br>Voices from the Ground: <a href="https://www.outrightinternational.org/" target="_blank">Outright International: Sudan War Impact</a>.</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #195</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Ranked at the bottom of the 2026 Spartacus Index due to legal penalties and active conflict.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The resurgence of "Public Order" policing in areas under conservative control.</p>
            </div>
        </div>
    `,
    ...
    travel: `
        ...
        <p>Practical advice: Do not enter the country. If already there, delete all digital traces of LGBT life and avoid any discussion of the topic. <br>Voices from the Ground: <a href="https://iglta.org/" target="_blank">IGLTA Safety Bulletin</a>.</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">Checkpoints and border control may search phones for "deviant" content.</p>
            </div>
        </div>
    `,
    ...
    health: `
        ...
        <p>No emergency protocols exist for inclusion. <br>Voices from the Ground: <a href="https://www.who.int/" target="_blank">WHO: Sudan Humanitarian Health Crisis</a>.</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Data Not Found</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">No verified safe medical services exist for the community.</p>
            </div>
        </div>
    `,
  ...
  tanzania: {
    ...
    legal: `
        ...
        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Penal Code of Tanzania (Section 154)</strong>
  ...
  togo: {
    ...
    legal: `
        ...
        <p>There is no legal framework for gender identity recognition or gender marker changes. Transgender individuals often face harassment under "vagrancy" or "public decency" charges. 
        Voices from the Ground: <a href="https://www.panafrica-ilga.org/" target="_blank">Pan-Africa ILGA</a> reports that local activists describe the law as a "constant shadow over daily life."</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Togo Penal Code (Article 392)</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The statute that criminalizes "acts against nature" between individuals of the same sex.</p>
                <a href="https://database.ilga.org/togo-lgbti" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
            </div>
        </div>
    `,
    ...
    safety: `
        ...
        <p>Police protection is non-existent; reporting crimes often results in the outing and subsequent arrest of the LGBTQ+ victim. Visibility in the state apparatus is entirely absent. 
        Voices from the Ground: <a href="https://www.outrightinternational.org/" target="_blank">Outright International</a> activists describe the environment as one of "perpetual survival mode."</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #165</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Togo remains in the lower quartile of the Spartacus Gay Travel Index 2026 due to active criminalization.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Consistent use of "Indecency Laws" to target LGBT-coded social gatherings.</p>
            </div>
        </div>
    `,
    ...
    travel: `
        ...
        <p>Cis-gay travelers should present as friends. Trans/Non-Binary travelers face extreme scrutiny at Lomé–Tokoin Airport; 2026 ID laws in Togo are binary-only, and any appearance/ID mismatch can lead to prolonged detention. 
        Voices from the Ground: <a href="https://iglta.org/" target="_blank">IGLTA</a> advises travelers to "scrub digital devices of dating apps before arrival."</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">Expect zero institutional protection. Avoid all LGBTQ+ political or social discussions with locals.</p>
            </div>
        </div>
    `,
    ...
    health: `
        ...
        <p>There are no emergency protocols for inclusive care. Medical institutions are required to uphold "public morality," which often clashes with LGBTQ+ health needs. 
        Voices from the Ground: <a href="https://www.alturi.org/" target="_blank">Alturi</a> highlights that "health is often sacrificed for safety here."</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Data Not Found</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">No verified LGBTQ-inclusive facilities are officially recognized to protect staff and patients.</p>
            </div>
        </div>
    `,
  ...
  tunisia: {
    ...
    legal: `
        ...
        <p>Gender identity recognition is non-existent; name and gender changes are generally not permitted. Transgender Tunisians face frequent harassment under "public decency" laws. 
        Voices from the Ground: <a href="https://www.damj.org/" target="_blank">Damj Association</a> advocates describe Article 230 as a "tool of state intimidation" that hinders all forms of advocacy.</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Tunisia Penal Code (Article 230)</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The statute criminalizing "sodomy" between men or women.</p>
                <a href="https://database.ilga.org/tunisia-lgbti" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
            </div>
        </div>
    `,
    ...
    safety: `
        ...
        <p>Police protection is rarely extended to the LGBTQ+ community. Visibility in government is non-existent. 
        Voices from the Ground: <a href="https://www.outrightinternational.org/" target="_blank">Outright International</a> reports suggest that activists are increasingly moving their operations online for safety.</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #138</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Tunisia’s ranking in the 2026 Spartacus Index has slipped due to increased political crackdowns on civil society.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Frequent raids on private gatherings perceived as "immoral."</p>
            </div>
        </div>
    `,
    ...
    travel: `
        ...
        <p>Cis-gay travelers should present as friends and avoid dating apps, which are monitored by local authorities. Trans/Non-Binary travelers face difficulty at customs; 2026 entry protocols are rigid regarding gender markers. 
        Voices from the Ground: <a href="https://iglta.org/" target="_blank">IGLTA</a> advises using only reputable, international hotel chains for better privacy.</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">Tunisian authorities may monitor social media activity of visitors. Avoid posting LGBT-related content while in-country.</p>
            </div>
        </div>
    `,
    ...
    health: `
        ...
        <p>Emergency protocols do not include SOGIE sensitivity. 
        Voices from the Ground: <a href="https://www.alturi.org/" target="_blank">Alturi</a> highlights that NGO clinics are the only safe spaces for medical consultation.</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Association Mawjoudin (We Exist)</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">Tunis, Tunisia (Contact via encrypted web portal for safety)</p>
                <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: via mawjoudin.org</p>
            </div>
        </div>
    `,
  ...
  uganda: {
    ...
    legal: `
        ...
        <p>Gender identity is not recognized, and any attempt at gender expression that deviates from biological sex is treated as a criminal offense. 
        Voices from the Ground: <a href="https://www.smug.org.ug/" target="_blank">SMUG (Sexual Minorities Uganda)</a> activists describe the law as a "state-sponsored hunt" that has forced hundreds into exile in 2025 and 2026.</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Anti-Homosexuality Act (2023)</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The primary legislation mandating life imprisonment and the death penalty for LGBTQ+ acts.</p>
                <a href="https://database.ilga.org/uganda-lgbti" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
            </div>
        </div>
    `,
    ...
    safety: `
        ...
        <p>Police protection is an antagonist; police are the primary enforcers of the AHA. There is zero visibility in government. 
        Voices from the Ground: <a href="https://www.outrightinternational.org/" target="_blank">Outright International</a> reports that "the risk of being reported is now a constant of daily life."</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #203</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Uganda is ranked at the very bottom of the 2026 Spartacus Index due to the death penalty.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The "Duty to Report" clause makes it a crime for any person not to report known LGBTQ+ individuals.</p>
            </div>
        </div>
    `,
    ...
    travel: `
        ...
        <p>Cis-gay travelers must hide all aspects of their identity. Trans/Non-Binary travelers face certain arrest if their appearance does not match their birth sex; 2026 security protocols at Entebbe Airport are aggressively gendered. 
        Voices from the Ground: <a href="https://iglta.org/" target="_blank">IGLTA</a> advises travelers to "avoid the country entirely until the AHA is repealed."</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">Expect zero institutional protection. Your government may be unable to assist if you are arrested under the AHA.</p>
            </div>
        </div>
    `,
    ...
    health: `
        ...
        <p>There are no inclusive emergency protocols. Medical staff may be legally required to report you. 
        Voices from the Ground: <a href="https://www.alturi.org/" target="_blank">Alturi</a> reports that the community is suffering from a "health catastrophe" due to fear of the law.</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Data Not Found</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">No verified LGBTQ-inclusive facilities are currently operational to protect both staff and patients.</p>
            </div>
        </div>
    `,
  ...
  western_sahara: {
    ...
    legal: `
        ...
        <p>Gender identity is not recognized, and there is no process for name or gender changes. Transgender individuals are at high risk of arrest under "public decency" or "impersonation" charges. 
        Voices from the Ground: <a href="https://www.panafrica-ilga.org/" target="_blank">Pan-Africa ILGA</a> reports that local activists describe the situation as a "legal vacuum" where rights do not exist.</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Moroccan Penal Code (Article 489) - Applied</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The statute criminalizing same-sex acts, applied in the majority of the territory.</p>
                <a href="https://database.ilga.org/morocco-lgbti" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
            </div>
        </div>
    `,
    ...
    safety: `
        ...
        <p>Police protection is not available; the Moroccan Gendarmerie and local security forces are enforcers of "public morality." There is no visibility in any governing body. 
        Voices from the Ground: <a href="https://www.outrightinternational.org/" target="_blank">Outright International</a> reports describe the community as "suffocated by the double burden of occupation and homophobia."</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #188</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Western Sahara ranks near the bottom of the 2026 Spartacus Index due to its legal and political instability.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">High frequency of "Morality Patrols" in urban centers like Laayoune.</p>
            </div>
        </div>
    `,
    ...
    travel: `
        ...
        <p>Cis-gay travelers should present as friends and avoid all PDA. Trans/Non-Binary travelers face extreme risk at checkpoints; 2026 security checks are rigid, and ID mismatches are treated as suspicious. 
        Voices from the Ground: <a href="https://iglta.org/" target="_blank">IGLTA</a> advises travelers to "avoid any LGBTQ+ advocacy or discussion while in the territory."</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">Expect heavy surveillance. Do not travel with any LGBTQ+ materials or symbols.</p>
            </div>
        </div>
    `,
    ...
    health: `
        ...
        <p>There are no emergency protocols for inclusive care. 
        Voices from the Ground: <a href="https://www.alturi.org/" target="_blank">Alturi</a> highlights the lack of any local NGO support for LGBT health.</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Data Not Found</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">No verified LGBTQ-inclusive facilities are available in the territory.</p>
            </div>
        </div>
    `,
  ...
  zambia: {
    ...
    legal: `
        ...
        <p>Gender identity is not legally recognized, and there are no provisions for changing gender markers on official documents. Transgender individuals are frequently targeted under "public indecency" laws or Section 156 regarding "attempts" to commit unnatural offenses. 
        Voices from the Ground: <a href="https://www.panafrica-ilga.org/" target="_blank">Pan-Africa ILGA</a> advocates describe the environment as one where legal reform is currently stagnant due to a lack of political will and intense pressure from religious institutions.</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Zambian Penal Code Chapter 87 (Section 155)</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Primary statute used to criminalize consensual same-sex acts with sentences up to life imprisonment.</p>
                <a href="https://database.ilga.org/zambia-lgbti" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
            </div>
        </div>
    `,
    ...
    safety: `
        ...
        <p>Police protection is virtually non-existent; reporting a crime often results in the victim being investigated for "unnatural offenses." There is no LGBT visibility in the government or state offices, and activists who are vocal risk significant state and vigilante pushback. 
        Voices from the Ground: <a href="https://www.outrightinternational.org/" target="_blank">Outright International</a> local partners report that "the threat of mob justice remains a more immediate danger than the police for many in high-density areas."</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 20px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #178</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Performance in the Spartacus Gay Travel Index 2026 remains in the bottom tier due to state criminalization.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Active enforcement of "Sodomy Laws" and lack of any hate-crime protections for the community.</p>
            </div>
        </div>
    `,
    ...
    travel: `
        ...
        <p>Trans/Non-Binary travelers face significant risks at airport security; 2026 biometric checks are binary-only, and any discrepancy between gender markers and appearance can lead to detention or secondary questioning. Overt PDA is extremely dangerous. 
        Safe Haven: No specific district, but "Rhodes Park" in Lusaka is considered more liberal for private meetings. 
        Voices from the Ground: <a href="https://iglta.org/" target="_blank">IGLTA</a> notes that "discretion is not just a suggestion; it is a necessity for travel to Zambia."</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">Avoid LGBTQ+ themed apparel and ensure dating apps are hidden. Customs may scrutinize luggage for "obscene materials."</p>
            </div>
        </div>
    `,
    ...
    health: `
        ...
        <p>Emergency protocols are not inclusive. There is a high risk of medical staff reporting individuals if they suspect "illegal acts" have occurred. 
        Voices from the Ground: <a href="https://www.alturi.org/" target="_blank">Alturi</a> partners highlight that "community-led health networks are the only safe points of access for many."</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">Data Not Found</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">Verified LGBTQ-inclusive contacts are not listed publicly to protect the safety of the facilities.</p>
            </div>
        </div>
    `,
  ...
  zimbabwe: {
    ...
    legal: `
        ...
        <p>There is no legal mechanism for gender identity recognition. Transgender individuals are frequently arrested under "public indecency" or "fraud" laws if their appearance does not match their state ID. 
        Voices from the Ground: <a href="https://www.gaysandlesbiansofzimbabwe.org/" target="_blank">GALZ (Gays and Lesbians of Zimbabwe)</a> describe the law as "a lingering weapon that keeps the community in a state of fear."</p>

        <div class="legal-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #f1c40f; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Primary Legal Documentation</h4>
            <div class="legal-card" style="background: rgba(241, 196, 15, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #f1c40f;">
                <strong style="display: block; font-size: 1.1rem; color: #f1c40f; margin-bottom: 5px;">📜 Criminal Law Act (Section 73)</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">The statute defining and criminalizing "sodomy" between consenting males.</p>
                <a href="https://database.ilga.org/zimbabwe-lgbti" target="_blank" style="display: inline-block; margin-top: 10px; color: #fff; text-decoration: underline; font-size: 0.85rem;">Official Source</a>
            </div>
        </div>
    `,
    ...
    safety: `
        ...
        <p>Police protection is rarely offered; many LGBTQ+ individuals report being extorted by law enforcement. There is zero visibility in government. 
        Voices from the Ground: <a href="https://www.outrightinternational.org/" target="_blank">Outright International</a> partners state that "activism is a high-stakes game of survival in the current political climate."</p>

        <div class="safety-metrics-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #e74c3c; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Safety Metrics & Warning Indicators</h4>
            <div class="metrics-card" style="background: rgba(231, 76, 60, 0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #e74c3c;">
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-bottom: 5px;">📊 Global Ranking: #182</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Zimbabwe sits in the lower tier of the Spartacus Gay Travel Index 2026 due to legal barriers and social stigma.</p>
                
                <strong style="display: block; font-size: 1.1rem; color: #e74c3c; margin-top: 15px; margin-bottom: 5px;">🛡️ Key Indicator</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.8;">Lack of "Incitement to Hatred" laws protecting the community from political vitriol.</p>
            </div>
        </div>
    `,
    ...
    travel: `
        ...
        <p>Cis-gay travelers should present as friends. Trans/Non-Binary travelers face extreme scrutiny at Robert Gabriel Mugabe International Airport; 2026 ID laws do not recognize non-binary identities, and airport security is often intrusive. 
        Safe Haven: "Milton Park" in Harare is known for a slightly more liberal expatriate and artsy vibe. 
        Voices from the Ground: <a href="https://iglta.org/" target="_blank">IGLTA</a> notes that "privacy is the traveler's best protection in Zimbabwe."</p>

        <div class="travel-resource-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #3498db; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Traveler Safety</h4>
            <div class="safety-card" style="background: rgba(52, 152, 219, 0.1); padding: 20px; border-radius: 8px; border: 1px solid rgba(52, 152, 219, 0.3);">
                <strong style="display: block; font-size: 1.1rem; color: #3498db;">🛂 Entry & Visibility</strong>
                <p style="color: #fff; font-size: 0.85rem;">Scrub digital footprints if necessary. Do not discuss LGBTQ+ rights with unknown locals as it could be perceived as "political interference."</p>
            </div>
        </div>
    `,
    ...
    health: `
        ...
        <p>There are no emergency protocols for inclusive care. Medical institutions generally lack SOGIE (Sexual Orientation, Gender Identity and Expression) training. 
        Voices from the Ground: <a href="https://www.alturi.org/" target="_blank">Alturi</a> reports that "discreet medical networks are a lifeline for the community here."</p>

        <div class="medical-address-grid" style="margin-top: 40px; border-top: 2px solid rgba(255,255,255,0.1); padding-top: 25px;">
            <h4 style="color: #00ff88; margin-bottom: 20px; text-transform: uppercase; font-size: 0.9rem; letter-spacing: 1px;">Medical Contacts</h4>
            <div class="address-block" style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px; border-left: 4px solid #00ff88;">
                <strong style="display: block; font-size: 1.1rem; margin-bottom: 5px;">GALZ (Gays and Lesbians of Zimbabwe)</strong>
                <p style="margin: 0; font-size: 0.95rem; opacity: 0.9;">Harare (Address kept confidential; contact via secure web portal)</p>
                <p style="margin: 5px 0 0 0; font-weight: bold; color: #fff;">📞 Contact: via galz.org.zw</p>
            </div>
        </div>
    `,
